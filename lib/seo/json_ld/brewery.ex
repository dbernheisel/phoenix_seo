...
defmodule SEO.JSONLD.Brewery do
  @moduledoc """
  Brewery.

  Helper for building a Schema.org [Brewery](https://schema.org/Brewery) JSON-LD structure.
  """
  ...
  `"Brewery"` respectively, plus any camelCased field keys

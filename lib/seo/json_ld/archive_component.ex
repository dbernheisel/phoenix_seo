...
defmodule SEO.JSONLD.ArchiveComponent do
  @moduledoc """
  An intangible type to be applied to any archive content, carrying with it a set of properties required to describe archival items and collections.

  Helper for building a Schema.org [ArchiveComponent](https://schema.org/ArchiveComponent) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:holding_archive) => SEO.JSONLD.ArchiveOrganization.t() | map(),
            optional(:item_location) =>
              String.t() | SEO.JSONLD.PostalAddress.t() | map() | SEO.JSONLD.Place.t(),
          ...
          | [
              holding_archive: SEO.JSONLD.ArchiveOrganization.t() | map(),
              item_location:
                String.t() | SEO.JSONLD.PostalAddress.t() | map() | SEO.JSONLD.Place.t(),
  ...
  `"ArchiveComponent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ArchiveComponent JSON-LD map.

  ## Fields

  - `:holding_archive` - `SEO.JSONLD.ArchiveOrganization` that holds, keeps or maintains the `SEO.JSONLD.ArchiveComponent`.
  - `:item_location` - Current location of the item.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ArchiveComponent")
  end
end

...
defmodule SEO.JSONLD.PostOffice do
  @moduledoc """
  A post office.

  Helper for building a Schema.org [PostOffice](https://schema.org/PostOffice) JSON-LD structure.
  """
  ...
  `"PostOffice"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PostOffice JSON-LD map.

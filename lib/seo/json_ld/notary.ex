...
defmodule SEO.JSONLD.Notary do
  @moduledoc """
  A notary.

  Helper for building a Schema.org [Notary](https://schema.org/Notary) JSON-LD structure.
  """
  ...
  `"Notary"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.House do
  ...
  Helper for building a Schema.org [House](https://schema.org/House) JSON-LD structure.
  """
  ...
  `"House"` respectively, plus any camelCased field keys

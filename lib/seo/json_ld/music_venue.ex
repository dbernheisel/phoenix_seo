...
defmodule SEO.JSONLD.MusicVenue do
  @moduledoc """
  A music venue.

  Helper for building a Schema.org [MusicVenue](https://schema.org/MusicVenue) JSON-LD structure.
  """
  ...
  `"MusicVenue"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MusicVenue JSON-LD map.

...
defmodule SEO.JSONLD.InvestmentOrDeposit do
  @moduledoc """
  A type of financial product that typically requires the client to transfer funds to a financial service in return for potential beneficial financial return.

  Helper for building a Schema.org [InvestmentOrDeposit](https://schema.org/InvestmentOrDeposit) JSON-LD structure.
  """
  ...
  `"InvestmentOrDeposit"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a InvestmentOrDeposit JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "InvestmentOrDeposit")
  end
end

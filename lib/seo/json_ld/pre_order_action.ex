...
defmodule SEO.JSONLD.PreOrderAction do
  @moduledoc """
  An agent orders a (not yet released) object/product/service to be delivered/sent.

  Helper for building a Schema.org [PreOrderAction](https://schema.org/PreOrderAction) JSON-LD structure.
  ...
  `"PreOrderAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PreOrderAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PreOrderAction")
  end
end

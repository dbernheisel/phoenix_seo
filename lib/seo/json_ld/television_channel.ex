...
defmodule SEO.JSONLD.TelevisionChannel do
  @moduledoc """
  A unique instance of a television BroadcastService on a CableOrSatelliteService lineup.

  Helper for building a Schema.org [TelevisionChannel](https://schema.org/TelevisionChannel) JSON-LD structure.
  """
  ...
  `"TelevisionChannel"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TelevisionChannel JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "TelevisionChannel")
  end
end

...
defmodule SEO.JSONLD.Pond do
  @moduledoc """
  A pond.

  Helper for building a Schema.org [Pond](https://schema.org/Pond) JSON-LD structure.
  """
  ...
  `"Pond"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.ReadAction do
  @moduledoc """
  The act of consuming written content.

  Helper for building a Schema.org [ReadAction](https://schema.org/ReadAction) JSON-LD structure.
  ...
  `"ReadAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ReadAction JSON-LD map.

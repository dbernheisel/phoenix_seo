...
defmodule SEO.JSONLD.DaySpa do
  @moduledoc """
  A day spa.

  Helper for building a Schema.org [DaySpa](https://schema.org/DaySpa) JSON-LD structure.
  """
  ...
  `"DaySpa"` respectively, plus any camelCased field keys

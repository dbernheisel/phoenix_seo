...
defmodule SEO.JSONLD.MusicRelease do
  @moduledoc """
  A MusicRelease is a specific release of a music album.

  Helper for building a Schema.org [MusicRelease](https://schema.org/MusicRelease) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:catalog_number) => String.t(),
            optional(:credited_to) => SEO.JSONLD.Organization.t() | map() | SEO.JSONLD.Person.t(),
            optional(:duration) =>
              Duration.t() | String.t() | SEO.JSONLD.QuantitativeValue.t() | map(),
            optional(:music_release_format) =>
              :cassette_format
              | :cd_format
              ...
              | :laser_disc_format
              | :vinyl_format,
            optional(:record_label) => SEO.JSONLD.Organization.t() | map(),
            optional(:release_of) => SEO.JSONLD.MusicAlbum.t() | map(),
          ...
          | [
              ...
              credited_to: SEO.JSONLD.Organization.t() | map() | SEO.JSONLD.Person.t(),
              ...
              music_release_format:
                ...
                | :laser_disc_format
                | :vinyl_format,
              record_label: SEO.JSONLD.Organization.t() | map(),
              release_of: SEO.JSONLD.MusicAlbum.t() | map(),
              num_tracks: integer(),
  ...
  `"MusicRelease"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MusicRelease JSON-LD map.

  ## Fields

  - `:catalog_number` - The catalog number for the release.
  - `:credited_to` - The group the release is credited to if different than the byArtist. For example, Red and Blue is credited to "Stefani Germanotta Band", but by Lady Gaga.
  ...
  - `:music_release_format` - Format of this release (the type of recording media used, i.e. compact disc, digital media, LP, etc.). One of: `:cassette_format`, `:cd_format`, `:digital_audio_tape_format`, `:digital_format`, `:dvd_format`, `:laser_disc_format`, `:vinyl_format`.
  - `:record_label` - The label that issued the release.
  - `:release_of` - The album this is a release of.

...
defmodule SEO.JSONLD.IndividualProduct do
  @moduledoc """
  A single, identifiable product instance (e.g. a laptop with a particular serial number).

  Helper for building a Schema.org [IndividualProduct](https://schema.org/IndividualProduct) JSON-LD structure.
  """
  ...
  `"IndividualProduct"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a IndividualProduct JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "IndividualProduct")
  end
end

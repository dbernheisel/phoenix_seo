...
defmodule SEO.JSONLD.MovieClip do
  @moduledoc """
  A short segment/part of a movie.

  Helper for building a Schema.org [MovieClip](https://schema.org/MovieClip) JSON-LD structure.
  """
  ...
  `"MovieClip"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.ParkingFacility do
  @moduledoc """
  A parking lot or other parking facility.

  Helper for building a Schema.org [ParkingFacility](https://schema.org/ParkingFacility) JSON-LD structure.
  """
  ...
  `"ParkingFacility"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ParkingFacility JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ParkingFacility")
  end
end

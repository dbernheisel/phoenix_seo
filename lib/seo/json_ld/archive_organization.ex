...
defmodule SEO.JSONLD.ArchiveOrganization do
  @moduledoc """
  An organization with archival holdings. An organization which keeps and preserves archival material and typically makes it accessible to the public.

  Helper for building a Schema.org [ArchiveOrganization](https://schema.org/ArchiveOrganization) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:archive_held) => SEO.JSONLD.ArchiveComponent.t() | map(),
          ...
          | [
              archive_held: SEO.JSONLD.ArchiveComponent.t() | map(),
  ...
  `"ArchiveOrganization"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ArchiveOrganization JSON-LD map.

  ## Fields

  - `:archive_held` - Collection, [fonds](https://en.wikipedia.org/wiki/Fonds), or item held, kept or maintained by an `SEO.JSONLD.ArchiveOrganization`.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ArchiveOrganization")
  end
end

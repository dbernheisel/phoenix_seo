...
defmodule SEO.JSONLD.PostalCodeRangeSpecification do
  @moduledoc """
  Indicates a range of postal codes, usually defined as the set of valid codes between `postalCodeBegin` and `postalCodeEnd`, inclusively.

  Helper for building a Schema.org [PostalCodeRangeSpecification](https://schema.org/PostalCodeRangeSpecification) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:postal_code_begin) => String.t(),
            optional(:postal_code_end) => String.t(),
          ...
          | [
              postal_code_begin: String.t(),
              postal_code_end: String.t(),
  ...
  `"PostalCodeRangeSpecification"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PostalCodeRangeSpecification JSON-LD map.

  ## Fields

  - `:postal_code_begin` - First postal code in a range (included).
  - `:postal_code_end` - Last postal code in the range (included). Needs to be after `postalCodeBegin`.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PostalCodeRangeSpecification")
  end
end

...
defmodule SEO.JSONLD.HardwareStore do
  @moduledoc """
  A hardware store.

  Helper for building a Schema.org [HardwareStore](https://schema.org/HardwareStore) JSON-LD structure.
  """
  ...
  `"HardwareStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a HardwareStore JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "HardwareStore")
  end
end

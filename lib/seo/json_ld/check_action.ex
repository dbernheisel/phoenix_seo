...
defmodule SEO.JSONLD.CheckAction do
  @moduledoc """
  An agent inspects, determines, investigates, inquires, or examines an object's accuracy, quality, condition, or state.

  Helper for building a Schema.org [CheckAction](https://schema.org/CheckAction) JSON-LD structure.
  ...
  `"CheckAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CheckAction JSON-LD map.

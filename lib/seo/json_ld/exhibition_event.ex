...
defmodule SEO.JSONLD.ExhibitionEvent do
  @moduledoc """
  Event type: Exhibition event, e.g. at a museum, library, archive, tradeshow, ...

  Helper for building a Schema.org [ExhibitionEvent](https://schema.org/ExhibitionEvent) JSON-LD structure.
  """
  ...
  `"ExhibitionEvent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ExhibitionEvent JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ExhibitionEvent")
  end
end

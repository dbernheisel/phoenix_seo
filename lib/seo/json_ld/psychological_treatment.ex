...
defmodule SEO.JSONLD.PsychologicalTreatment do
  @moduledoc """
  A process of care relying upon counseling, dialogue and communication aimed at improving a mental health condition without use of drugs.

  Helper for building a Schema.org [PsychologicalTreatment](https://schema.org/PsychologicalTreatment) JSON-LD structure.
  """
  ...
  `"PsychologicalTreatment"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PsychologicalTreatment JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PsychologicalTreatment")
  end
end

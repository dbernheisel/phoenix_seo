...
defmodule SEO.JSONLD.AudioObject do
  @moduledoc """
  An audio file.

  Helper for building a Schema.org [AudioObject](https://schema.org/AudioObject) JSON-LD structure.
  """
  ...
  `"AudioObject"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AudioObject JSON-LD map.

...
defmodule SEO.JSONLD.Canal do
  @moduledoc """
  A canal, like the Panama Canal.

  Helper for building a Schema.org [Canal](https://schema.org/Canal) JSON-LD structure.
  """
  ...
  `"Canal"` respectively, plus any camelCased field keys

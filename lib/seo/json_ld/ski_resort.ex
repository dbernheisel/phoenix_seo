...
defmodule SEO.JSONLD.SkiResort do
  @moduledoc """
  A ski resort.

  Helper for building a Schema.org [SkiResort](https://schema.org/SkiResort) JSON-LD structure.
  """
  ...
  `"SkiResort"` respectively, plus any camelCased field keys

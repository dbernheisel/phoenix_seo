...
defmodule SEO.JSONLD.InformAction do
  @moduledoc """
  The act of notifying someone of information pertinent to them, with no expectation of a response.

  Helper for building a Schema.org [InformAction](https://schema.org/InformAction) JSON-LD structure.
  ...
  `"InformAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a InformAction JSON-LD map.

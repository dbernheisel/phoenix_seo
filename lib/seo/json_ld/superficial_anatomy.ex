...
defmodule SEO.JSONLD.SuperficialAnatomy do
  @moduledoc """
  ...
  Helper for building a Schema.org [SuperficialAnatomy](https://schema.org/SuperficialAnatomy) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:associated_pathophysiology) => String.t(),
            optional(:related_anatomy) =>
            ...
            optional(:significance) => String.t(),
  ...
  `"SuperficialAnatomy"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SuperficialAnatomy JSON-LD map.
  ...
  - `:related_anatomy` - Anatomical systems or structures that relate to the superficial anatomy.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SuperficialAnatomy")
  end
end

...
defmodule SEO.JSONLD.PhotographAction do
  @moduledoc """
  The act of capturing still images of objects using a camera.

  Helper for building a Schema.org [PhotographAction](https://schema.org/PhotographAction) JSON-LD structure.
  ...
  `"PhotographAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PhotographAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PhotographAction")
  end
end

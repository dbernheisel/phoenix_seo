...
defmodule SEO.JSONLD.RadioEpisode do
  @moduledoc """
  A radio episode which can be part of a series or season.

  Helper for building a Schema.org [RadioEpisode](https://schema.org/RadioEpisode) JSON-LD structure.
  """
  ...
  `"RadioEpisode"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a RadioEpisode JSON-LD map.

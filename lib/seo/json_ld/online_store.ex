...
defmodule SEO.JSONLD.OnlineStore do
  @moduledoc """
  An eCommerce site.

  Helper for building a Schema.org [OnlineStore](https://schema.org/OnlineStore) JSON-LD structure.
  """
  ...
  `"OnlineStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a OnlineStore JSON-LD map.

  ## Fields

  - `:is_store_on` - The eCommerce marketplace this online store is on.

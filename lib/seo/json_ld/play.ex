...
defmodule SEO.JSONLD.Play do
  @moduledoc """
  A play is a form of literature, usually consisting of dialogue between characters, intended for theatrical performance rather than just reading. Note: A performance of a Play would be a `SEO.JSONLD.TheaterEvent` or `SEO.JSONLD.BroadcastEvent` - the *Play* being the `workPerformed`.

  Helper for building a Schema.org [Play](https://schema.org/Play) JSON-LD structure.
  """
  ...
  `"Play"` respectively, plus any camelCased field keys

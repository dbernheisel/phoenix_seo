...
defmodule SEO.JSONLD.UserPageVisits do
  @moduledoc """
  ...
  Helper for building a Schema.org [UserPageVisits](https://schema.org/UserPageVisits) JSON-LD structure.
  """
  ...
  `"UserPageVisits"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a UserPageVisits JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "UserPageVisits")
  end
end

...
defmodule SEO.JSONLD.HealthClub do
  @moduledoc """
  A health club.

  Helper for building a Schema.org [HealthClub](https://schema.org/HealthClub) JSON-LD structure.
  """
  ...
  `"HealthClub"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a HealthClub JSON-LD map.

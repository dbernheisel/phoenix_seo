...
defmodule SEO.JSONLD.LandmarksOrHistoricalBuildings do
  @moduledoc """
  An historical landmark or building.

  Helper for building a Schema.org [LandmarksOrHistoricalBuildings](https://schema.org/LandmarksOrHistoricalBuildings) JSON-LD structure.
  """
  ...
  `"LandmarksOrHistoricalBuildings"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a LandmarksOrHistoricalBuildings JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "LandmarksOrHistoricalBuildings")
  end
end

...
defmodule SEO.JSONLD.MedicalTest do
  @moduledoc """
  Any medical test, typically performed for diagnostic purposes.

  Helper for building a Schema.org [MedicalTest](https://schema.org/MedicalTest) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:affected_by) => SEO.JSONLD.Drug.t() | map(),
            optional(:normal_range) =>
              :abdomen
              ...
              | :x_ray
              | String.t(),
            optional(:sign_detected) => SEO.JSONLD.MedicalSign.t() | map(),
            optional(:used_to_diagnose) => SEO.JSONLD.MedicalCondition.t() | map(),
            optional(:uses_device) => SEO.JSONLD.MedicalDevice.t() | map(),
          ...
          | [
              affected_by: SEO.JSONLD.Drug.t() | map(),
              normal_range:
                :abdomen
                | :active_not_recruiting
                | :anesthesia
                ...
                | :x_ray
                | String.t(),
              sign_detected: SEO.JSONLD.MedicalSign.t() | map(),
              used_to_diagnose: SEO.JSONLD.MedicalCondition.t() | map(),
              uses_device: SEO.JSONLD.MedicalDevice.t() | map(),
  ...
  `"MedicalTest"` respectively, plus any camelCased field keys

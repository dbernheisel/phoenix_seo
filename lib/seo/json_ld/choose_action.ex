...
defmodule SEO.JSONLD.ChooseAction do
  @moduledoc """
  The act of expressing a preference from a set of options or a large or unbounded set of choices/options.

  Helper for building a Schema.org [ChooseAction](https://schema.org/ChooseAction) JSON-LD structure.
  ...
  `"ChooseAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ChooseAction JSON-LD map.

  ## Fields

  - `:action_option` - A sub property of object. The options subject to this action.

...
defmodule SEO.JSONLD.DryCleaningOrLaundry do
  @moduledoc """
  A dry-cleaning business.

  Helper for building a Schema.org [DryCleaningOrLaundry](https://schema.org/DryCleaningOrLaundry) JSON-LD structure.
  """
  ...
  `"DryCleaningOrLaundry"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DryCleaningOrLaundry JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "DryCleaningOrLaundry")
  end
end

...
defmodule SEO.JSONLD.Crematorium do
  @moduledoc """
  A crematorium.

  Helper for building a Schema.org [Crematorium](https://schema.org/Crematorium) JSON-LD structure.
  """
  ...
  `"Crematorium"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Crematorium JSON-LD map.

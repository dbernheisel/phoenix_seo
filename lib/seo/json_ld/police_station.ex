...
defmodule SEO.JSONLD.PoliceStation do
  @moduledoc """
  A police station.

  Helper for building a Schema.org [PoliceStation](https://schema.org/PoliceStation) JSON-LD structure.
  """
  ...
  `"PoliceStation"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PoliceStation JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PoliceStation")
  end
end

...
defmodule SEO.JSONLD.AcceptAction do
  @moduledoc """
  The act of committing to/adopting an object.

  Related actions:

  * `SEO.JSONLD.RejectAction`: The antonym of AcceptAction.

  Helper for building a Schema.org [AcceptAction](https://schema.org/AcceptAction) JSON-LD structure.
  ...
  `"AcceptAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AcceptAction JSON-LD map.

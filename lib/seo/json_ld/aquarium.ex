...
defmodule SEO.JSONLD.Aquarium do
  @moduledoc """
  Aquarium.

  Helper for building a Schema.org [Aquarium](https://schema.org/Aquarium) JSON-LD structure.
  """
  ...
  `"Aquarium"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.BowlingAlley do
  @moduledoc """
  A bowling alley.

  Helper for building a Schema.org [BowlingAlley](https://schema.org/BowlingAlley) JSON-LD structure.
  """
  ...
  `"BowlingAlley"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a BowlingAlley JSON-LD map.

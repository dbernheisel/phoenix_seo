...
defmodule SEO.JSONLD.EndorseAction do
  @moduledoc """
  An agent approves/certifies/likes/supports/sanctions an object.

  Helper for building a Schema.org [EndorseAction](https://schema.org/EndorseAction) JSON-LD structure.
  ...
  @type attrs ::
          %{
            optional(:endorsee) => SEO.JSONLD.Organization.t() | map() | SEO.JSONLD.Person.t(),
          ...
          | [
              endorsee: SEO.JSONLD.Organization.t() | map() | SEO.JSONLD.Person.t(),
  ...
  `"EndorseAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a EndorseAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "EndorseAction")
  end
end

...
defmodule SEO.JSONLD.Taxi do
  @moduledoc """
  A taxi.

  Helper for building a Schema.org [Taxi](https://schema.org/Taxi) JSON-LD structure.
  """
  ...
  `"Taxi"` respectively, plus any camelCased field keys

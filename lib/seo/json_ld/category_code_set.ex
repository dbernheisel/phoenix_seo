...
defmodule SEO.JSONLD.CategoryCodeSet do
  @moduledoc """
  A set of Category Code values.

  Helper for building a Schema.org [CategoryCodeSet](https://schema.org/CategoryCodeSet) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:has_category_code) => SEO.JSONLD.CategoryCode.t() | map(),
          ...
          | [
              has_category_code: SEO.JSONLD.CategoryCode.t() | map(),
  ...
  `"CategoryCodeSet"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CategoryCodeSet JSON-LD map.

  ## Fields

  - `:has_category_code` - A Category code contained in this code set.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "CategoryCodeSet")
  end
end

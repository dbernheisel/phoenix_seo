...
defmodule SEO.JSONLD.MedicalRiskCalculator do
  @moduledoc """
  A complex mathematical calculation requiring an online calculator, used to assess prognosis. Note: use the url property of Thing to record any URLs for online calculators.

  Helper for building a Schema.org [MedicalRiskCalculator](https://schema.org/MedicalRiskCalculator) JSON-LD structure.
  """
  ...
  `"MedicalRiskCalculator"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalRiskCalculator JSON-LD map.
  ...
  - `SEO.JSONLD.MedicalRiskEstimator`
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalRiskCalculator")
  end
end

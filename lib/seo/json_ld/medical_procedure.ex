...
defmodule SEO.JSONLD.MedicalProcedure do
  @moduledoc """
  A process of care used in either a diagnostic, therapeutic, preventive or palliative capacity that relies on invasive (surgical), non-invasive, or other techniques.

  Helper for building a Schema.org [MedicalProcedure](https://schema.org/MedicalProcedure) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            optional(:procedure_type) => :noninvasive_procedure | :percutaneous_procedure,
            optional(:status) =>
              :event_cancelled
              | :event_moved_online
              | :event_postponed
  ...
  `"MedicalProcedure"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalProcedure JSON-LD map.
  ...
  - `:how_performed` - How the procedure is performed.
  - `:preparation` - Typical preparation that a patient must undergo before having the procedure performed.
  - `:procedure_type` - The type of procedure, for example Surgical, Noninvasive, or Percutaneous. One of: `:noninvasive_procedure`, `:percutaneous_procedure`.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalProcedure")
  end
end

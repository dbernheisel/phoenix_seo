...
defmodule SEO.JSONLD.WebAPI do
  @moduledoc """
  An application programming interface accessible over Web/Internet technologies.

  Helper for building a Schema.org [WebAPI](https://schema.org/WebAPI) JSON-LD structure.
  """
  ...
  @type attrs ::
          ...
          | [
              documentation: URI.t() | String.t() | SEO.JSONLD.CreativeWork.t() | map(),
  ...
  `"WebAPI"` respectively, plus any camelCased field keys

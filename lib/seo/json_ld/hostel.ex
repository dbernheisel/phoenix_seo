...
defmodule SEO.JSONLD.Hostel do
  @moduledoc """
  A hostel - cheap accommodation, often in shared dormitories.

  See also the dedicated document on the use of schema.org for marking up hotels and other forms of accommodations.

  Helper for building a Schema.org [Hostel](https://schema.org/Hostel) JSON-LD structure.
  """
  ...
  `"Hostel"` respectively, plus any camelCased field keys

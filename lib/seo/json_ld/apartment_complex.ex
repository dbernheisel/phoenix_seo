...
defmodule SEO.JSONLD.ApartmentComplex do
  @moduledoc """
  Residence type: Apartment complex.

  Helper for building a Schema.org [ApartmentComplex](https://schema.org/ApartmentComplex) JSON-LD structure.
  """
  ...
  `"ApartmentComplex"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ApartmentComplex JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ApartmentComplex")
  end
end

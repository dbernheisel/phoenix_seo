...
defmodule SEO.JSONLD.OrganizeAction do
  @moduledoc """
  The act of manipulating/administering/supervising/controlling one or more objects.

  Helper for building a Schema.org [OrganizeAction](https://schema.org/OrganizeAction) JSON-LD structure.
  ...
  `"OrganizeAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a OrganizeAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "OrganizeAction")
  end
end

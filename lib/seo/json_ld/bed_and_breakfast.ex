...
defmodule SEO.JSONLD.BedAndBreakfast do
  @moduledoc """
  Bed and breakfast.

  See also the dedicated document on the use of schema.org for marking up hotels and other forms of accommodations.

  Helper for building a Schema.org [BedAndBreakfast](https://schema.org/BedAndBreakfast) JSON-LD structure.
  """
  ...
  `"BedAndBreakfast"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a BedAndBreakfast JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "BedAndBreakfast")
  end
end

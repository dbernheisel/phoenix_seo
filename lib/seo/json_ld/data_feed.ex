...
defmodule SEO.JSONLD.DataFeed do
  @moduledoc """
  A single feed providing structured information about one or more entities or topics.

  Helper for building a Schema.org [DataFeed](https://schema.org/DataFeed) JSON-LD structure.
  """
  ...
  `"DataFeed"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DataFeed JSON-LD map.

  ## Fields

  - `:data_feed_element` - An item within a data feed. Data feeds may have many elements.

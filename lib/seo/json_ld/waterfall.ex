...
defmodule SEO.JSONLD.Waterfall do
  @moduledoc """
  A waterfall, like Niagara.

  Helper for building a Schema.org [Waterfall](https://schema.org/Waterfall) JSON-LD structure.
  """
  ...
  `"Waterfall"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.Photograph do
  @moduledoc """
  A photograph.

  Helper for building a Schema.org [Photograph](https://schema.org/Photograph) JSON-LD structure.
  """
  ...
  `"Photograph"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Photograph JSON-LD map.

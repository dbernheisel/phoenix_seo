...
defmodule SEO.JSONLD.SiteNavigationElement do
  @moduledoc """
  A navigation element of the page.

  Helper for building a Schema.org [SiteNavigationElement](https://schema.org/SiteNavigationElement) JSON-LD structure.
  """
  ...
  `"SiteNavigationElement"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SiteNavigationElement JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SiteNavigationElement")
  end
end

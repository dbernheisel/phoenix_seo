...
defmodule SEO.JSONLD.TireShop do
  @moduledoc """
  A tire shop.

  Helper for building a Schema.org [TireShop](https://schema.org/TireShop) JSON-LD structure.
  """
  ...
  `"TireShop"` respectively, plus any camelCased field keys

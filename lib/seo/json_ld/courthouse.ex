...
defmodule SEO.JSONLD.Courthouse do
  @moduledoc """
  A courthouse.

  Helper for building a Schema.org [Courthouse](https://schema.org/Courthouse) JSON-LD structure.
  """
  ...
  `"Courthouse"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Courthouse JSON-LD map.

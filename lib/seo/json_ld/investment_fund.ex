...
defmodule SEO.JSONLD.InvestmentFund do
  @moduledoc """
  A company or fund that gathers capital from a number of investors to create a pool of money that is then re-invested into stocks, bonds and other assets.

  Helper for building a Schema.org [InvestmentFund](https://schema.org/InvestmentFund) JSON-LD structure.
  """
  ...
  `"InvestmentFund"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a InvestmentFund JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "InvestmentFund")
  end
end

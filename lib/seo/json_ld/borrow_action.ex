...
defmodule SEO.JSONLD.BorrowAction do
  @moduledoc """
  The act of obtaining an object under an agreement to return it at a later date. Reciprocal of LendAction.

  Related actions:

  * `SEO.JSONLD.LendAction`: Reciprocal of BorrowAction.

  Helper for building a Schema.org [BorrowAction](https://schema.org/BorrowAction) JSON-LD structure.
  ...
  @type attrs ::
          %{
            optional(:lender) => SEO.JSONLD.Person.t() | map() | SEO.JSONLD.Organization.t(),
          ...
          | [
              lender: SEO.JSONLD.Person.t() | map() | SEO.JSONLD.Organization.t(),
  ...
  `"BorrowAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a BorrowAction JSON-LD map.

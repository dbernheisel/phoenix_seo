...
defmodule SEO.JSONLD.PetStore do
  @moduledoc """
  A pet store.

  Helper for building a Schema.org [PetStore](https://schema.org/PetStore) JSON-LD structure.
  """
  ...
  `"PetStore"` respectively, plus any camelCased field keys

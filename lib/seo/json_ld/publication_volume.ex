...
defmodule SEO.JSONLD.PublicationVolume do
  @moduledoc """
  A part of a successively published publication such as a periodical or multi-volume work, often numbered. It may represent a time span, such as a year.

  See also [blog post](https://blog-schema.org/2014/09/02/schema-org-support-for-bibliographic-relationships-and-periodicals/).

  Helper for building a Schema.org [PublicationVolume](https://schema.org/PublicationVolume) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            optional(:volume_number) => integer() | String.t(),
          ...
          | [
              ...
              pagination: String.t(),
              volume_number: integer() | String.t(),
  ...
  `"PublicationVolume"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PublicationVolume JSON-LD map.
  ...
  - `:volume_number` - Identifies the volume of publication or multi-part work; for example, "iii" or "2".
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PublicationVolume")
  end
end

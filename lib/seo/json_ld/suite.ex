...
defmodule SEO.JSONLD.Suite do
  ...
  Helper for building a Schema.org [Suite](https://schema.org/Suite) JSON-LD structure.
  """
  ...
  `"Suite"` respectively, plus any camelCased field keys

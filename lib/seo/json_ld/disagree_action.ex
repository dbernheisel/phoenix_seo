...
defmodule SEO.JSONLD.DisagreeAction do
  @moduledoc """
  The act of expressing a difference of opinion with the object. An agent disagrees to/about an object (a proposition, topic or theme) with participants.

  Helper for building a Schema.org [DisagreeAction](https://schema.org/DisagreeAction) JSON-LD structure.
  ...
  `"DisagreeAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DisagreeAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "DisagreeAction")
  end
end

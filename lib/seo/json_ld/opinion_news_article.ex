...
defmodule SEO.JSONLD.OpinionNewsArticle do
  @moduledoc """
  An `SEO.JSONLD.OpinionNewsArticle` is a `SEO.JSONLD.NewsArticle` that primarily expresses opinions rather than journalistic reporting of news and events. For example, a `SEO.JSONLD.NewsArticle` consisting of a column or `SEO.JSONLD.Blog`/`SEO.JSONLD.BlogPosting` entry in the Opinions section of a news publication.

  Helper for building a Schema.org [OpinionNewsArticle](https://schema.org/OpinionNewsArticle) JSON-LD structure.
  """
  ...
  `"OpinionNewsArticle"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a OpinionNewsArticle JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "OpinionNewsArticle")
  end
end

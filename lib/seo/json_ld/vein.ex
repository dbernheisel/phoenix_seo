...
defmodule SEO.JSONLD.Vein do
  @moduledoc """
  A type of blood vessel that specifically carries blood to the heart.

  Helper for building a Schema.org [Vein](https://schema.org/Vein) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:drains_to) => SEO.JSONLD.Vessel.t() | map(),
            optional(:region_drained) =>
              SEO.JSONLD.AnatomicalSystem.t() | map() | SEO.JSONLD.AnatomicalStructure.t(),
            optional(:tributary) => SEO.JSONLD.AnatomicalStructure.t() | map(),
          ...
          | [
              drains_to: SEO.JSONLD.Vessel.t() | map(),
              region_drained:
                SEO.JSONLD.AnatomicalSystem.t() | map() | SEO.JSONLD.AnatomicalStructure.t(),
              tributary: SEO.JSONLD.AnatomicalStructure.t() | map(),
  ...
  `"Vein"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Vein JSON-LD map.

  ## Fields

  - `:drains_to` - The vasculature that the vein drains into.

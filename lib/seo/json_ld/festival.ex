...
defmodule SEO.JSONLD.Festival do
  @moduledoc """
  Event type: Festival.

  Helper for building a Schema.org [Festival](https://schema.org/Festival) JSON-LD structure.
  """
  ...
  `"Festival"` respectively, plus any camelCased field keys

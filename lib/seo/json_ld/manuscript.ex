...
defmodule SEO.JSONLD.Manuscript do
  @moduledoc """
  A book, document, or piece of music written by hand rather than typed or printed.

  Helper for building a Schema.org [Manuscript](https://schema.org/Manuscript) JSON-LD structure.
  """
  ...
  `"Manuscript"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Manuscript JSON-LD map.

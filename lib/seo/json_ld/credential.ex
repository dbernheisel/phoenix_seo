...
defmodule SEO.JSONLD.Credential do
  @moduledoc """
  A credential is a certificate that is used to verify the identity of a person or entity.

  Helper for building a Schema.org [Credential](https://schema.org/Credential) JSON-LD structure.
  """
  ...
  `"Credential"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Credential JSON-LD map.

  ## Fields

  - `:credential_category` - The category or type of credential being described, for example "degree”, “certificate”, “badge”, or more specific term.
  - `:recognized_by` - An organization that acknowledges the validity, value or utility of a credential. Note: recognition may include a process of quality assurance or accreditation.
  - `:valid_for` - The duration of validity of a permit or similar thing.

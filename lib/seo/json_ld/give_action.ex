...
defmodule SEO.JSONLD.GiveAction do
  @moduledoc """
  The act of transferring ownership of an object to a destination. Reciprocal of TakeAction.

  Related actions:

  * `SEO.JSONLD.TakeAction`: Reciprocal of GiveAction.
  * `SEO.JSONLD.SendAction`: Unlike SendAction, GiveAction implies that ownership is being transferred (e.g. I may send my laptop to you, but that doesn't mean I'm giving it to you).

  Helper for building a Schema.org [GiveAction](https://schema.org/GiveAction) JSON-LD structure.
  ...
  `"GiveAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a GiveAction JSON-LD map.

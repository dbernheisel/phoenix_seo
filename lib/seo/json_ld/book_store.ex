...
defmodule SEO.JSONLD.BookStore do
  @moduledoc """
  A bookstore.

  Helper for building a Schema.org [BookStore](https://schema.org/BookStore) JSON-LD structure.
  """
  ...
  `"BookStore"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.Diet do
  @moduledoc """
  A strategy of regulating the intake of food to achieve or maintain a specific health-related goal.

  Helper for building a Schema.org [Diet](https://schema.org/Diet) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:diet_features) => String.t(),
            optional(:endorsers) => SEO.JSONLD.Organization.t() | map() | SEO.JSONLD.Person.t(),
            optional(:expert_considerations) => String.t(),
            optional(:physiological_benefits) => String.t(),
            optional(:risks) => String.t(),
          ...
          | [
              diet_features: String.t(),
              endorsers: SEO.JSONLD.Organization.t() | map() | SEO.JSONLD.Person.t(),
              expert_considerations: String.t(),
              physiological_benefits: String.t(),
              risks: String.t(),
  ...
  `"Diet"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Diet JSON-LD map.

  ## Fields

  - `:diet_features` - Nutritional information specific to the dietary plan. May include dietary recommendations on what foods to avoid, what foods to consume, and specific alterations/deviations from the USDA or other regulatory body's approved dietary guidelines.
  - `:endorsers` - People or organizations that endorse the plan.
  - `:expert_considerations` - Medical expert advice related to the plan.
  - `:physiological_benefits` - Specific physiologic benefits associated to the plan.

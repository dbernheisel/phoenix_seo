...
defmodule SEO.JSONLD.GasStation do
  @moduledoc """
  A gas station.

  Helper for building a Schema.org [GasStation](https://schema.org/GasStation) JSON-LD structure.
  """
  ...
  `"GasStation"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a GasStation JSON-LD map.

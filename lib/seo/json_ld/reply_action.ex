...
defmodule SEO.JSONLD.ReplyAction do
  @moduledoc """
  The act of responding to a question/message asked/sent by the object. Related to `SEO.JSONLD.AskAction`.

  Related actions:

  * `SEO.JSONLD.AskAction`: Appears generally as an origin of a ReplyAction.

  Helper for building a Schema.org [ReplyAction](https://schema.org/ReplyAction) JSON-LD structure.
  ...
  `"ReplyAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ReplyAction JSON-LD map.

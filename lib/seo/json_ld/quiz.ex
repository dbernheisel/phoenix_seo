...
defmodule SEO.JSONLD.Quiz do
  @moduledoc """
  Quiz: A test of knowledge, skills and abilities.

  ![Quiz rich-result example](./assets/education-qa-example.png)

  Helper for building a Schema.org [Quiz](https://schema.org/Quiz) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            required(:has_part) => SEO.JSONLD.CreativeWork.t() | map(),
  ...
  `"Quiz"` respectively, plus any camelCased field keys

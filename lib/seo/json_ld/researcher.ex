...
defmodule SEO.JSONLD.Researcher do
  @moduledoc """
  Researchers.

  Helper for building a Schema.org [Researcher](https://schema.org/Researcher) JSON-LD structure.
  """
  ...
  `"Researcher"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Researcher JSON-LD map.

...
defmodule SEO.JSONLD.HighSchool do
  @moduledoc """
  A high school.

  Helper for building a Schema.org [HighSchool](https://schema.org/HighSchool) JSON-LD structure.
  """
  ...
  `"HighSchool"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a HighSchool JSON-LD map.

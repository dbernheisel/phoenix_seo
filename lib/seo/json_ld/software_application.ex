...
defmodule SEO.JSONLD.SoftwareApplication do
  @moduledoc """
  A software application.

  ![SoftwareApplication rich-result example](./assets/software-apps-example.png)
  ...
  Helper for building a Schema.org [SoftwareApplication](https://schema.org/SoftwareApplication) JSON-LD structure.
  """

  @type attrs ::
          %{
            required(:application_category) => String.t() | URI.t(),
            optional(:application_sub_category) => String.t() | URI.t(),
            optional(:application_suite) => String.t(),
            optional(:available_on_device) => String.t(),
            optional(:countries_not_supported) => String.t(),
            optional(:countries_supported) => String.t(),
            optional(:device) => String.t(),
            optional(:download_url) => URI.t() | String.t(),
            optional(:feature_list) => String.t() | URI.t(),
            optional(:file_size) => String.t(),
            optional(:install_url) => URI.t() | String.t(),
            optional(:memory_requirements) => String.t() | URI.t(),
            required(:operating_system) => SEO.JSONLD.OperatingSystem.t() | map() | String.t(),
            optional(:permissions) => String.t(),
            optional(:processor_requirements) => String.t(),
            optional(:release_notes) => String.t() | URI.t(),
            optional(:requirements) => String.t() | URI.t(),
            optional(:runtime_platform) => SEO.JSONLD.RuntimePlatform.t() | map() | String.t(),
            optional(:screenshot) => URI.t() | String.t() | SEO.JSONLD.ImageObject.t() | map(),
            optional(:software_add_on) => SEO.JSONLD.SoftwareApplication.t() | map(),
            optional(:software_help) => SEO.JSONLD.CreativeWork.t() | map(),
            optional(:software_requirements) =>
              SEO.JSONLD.SoftwareApplication.t() | map() | String.t() | URI.t(),
            optional(:software_version) => String.t(),
            optional(:storage_requirements) => String.t() | URI.t(),
            optional(:supporting_data) => SEO.JSONLD.DataFeed.t() | map(),
          ...
          | [
              application_category: String.t() | URI.t(),
              application_sub_category: String.t() | URI.t(),
              application_suite: String.t(),
              available_on_device: String.t(),
              countries_not_supported: String.t(),
              countries_supported: String.t(),
              device: String.t(),
              download_url: URI.t() | String.t(),
              feature_list: String.t() | URI.t(),
              file_size: String.t(),
              install_url: URI.t() | String.t(),
              memory_requirements: String.t() | URI.t(),
              operating_system: SEO.JSONLD.OperatingSystem.t() | map() | String.t(),
              permissions: String.t(),
              processor_requirements: String.t(),
              release_notes: String.t() | URI.t(),
              requirements: String.t() | URI.t(),
              runtime_platform: SEO.JSONLD.RuntimePlatform.t() | map() | String.t(),
              screenshot: URI.t() | String.t() | SEO.JSONLD.ImageObject.t() | map(),
              software_add_on: SEO.JSONLD.SoftwareApplication.t() | map(),
              software_help: SEO.JSONLD.CreativeWork.t() | map(),
              software_requirements:
                SEO.JSONLD.SoftwareApplication.t() | map() | String.t() | URI.t(),
              software_version: String.t(),
              storage_requirements: String.t() | URI.t(),
              supporting_data: SEO.JSONLD.DataFeed.t() | map(),
  ...
  `"SoftwareApplication"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SoftwareApplication JSON-LD map.

  ## Fields

  - `:application_category` - Type of software application, e.g. 'Game, Multimedia'.
  - `:application_sub_category` - Subcategory of the application, e.g. 'Arcade Game'.
  - `:application_suite` - The name of the application suite to which the application belongs (e.g. Excel belongs to Office).
  - `:available_on_device` - Device required to run the application. Used in cases where a specific make/model is required to run the application.
  - `:countries_not_supported` - Countries for which the application is not supported. You can also provide the two-letter ISO 3166-1 alpha-2 country code.
  - `:countries_supported` - Countries for which the application is supported. You can also provide the two-letter ISO 3166-1 alpha-2 country code.
  ...
  - `:download_url` - If the file can be downloaded, URL to download the binary.
  - `:feature_list` - Features or modules provided by this application (and possibly required by other applications).
  - `:file_size` - Size of the application / package (e.g. 18MB). In the absence of a unit (MB, KB etc.), KB will be assumed.
  - `:install_url` - URL at which the app may be installed, if different from the URL of the item.
  - `:memory_requirements` - Minimum memory requirements.
  - `:operating_system` - Operating systems supported (Windows 7, OS X 10.6, Android 1.6).
  ...
  - `:processor_requirements` - Processor architecture required to run the application (e.g. IA64).
  - `:release_notes` - Description of what changed in this version.
  ...
  - `:runtime_platform` - Runtime platform or script interpreter dependencies (example: Java v1, Python 2.3, .NET Framework 3.0).
  - `:screenshot` - A link to a screenshot image of the app.
  - `:software_add_on` - Additional content for a software application.
  - `:software_help` - Software application help.
  - `:software_requirements` - Component dependency requirements for application. This includes runtime environments and shared libraries that are not included in the application distribution package, but required to run the application (examples: DirectX, Java or .NET runtime).
  - `:software_version` - Version of the software instance.
  - `:storage_requirements` - Storage requirements (free space required).
  - `:supporting_data` - Supporting data for a SoftwareApplication.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SoftwareApplication")
  end
end

...
defmodule SEO.JSONLD.OnlineBusiness do
  @moduledoc """
  ...
  Helper for building a Schema.org [OnlineBusiness](https://schema.org/OnlineBusiness) JSON-LD structure.
  """
  ...
  `"OnlineBusiness"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a OnlineBusiness JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "OnlineBusiness")
  end
end

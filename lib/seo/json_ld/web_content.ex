...
defmodule SEO.JSONLD.WebContent do
  @moduledoc """
  WebContent is a type representing all `SEO.JSONLD.WebPage`, `SEO.JSONLD.WebSite` and `SEO.JSONLD.WebPageElement` content. It is sometimes the case that detailed distinctions between Web pages, sites and their parts are not always important or obvious. The `SEO.JSONLD.WebContent` type makes it easier to describe Web-addressable content without requiring such distinctions to always be stated. (The intent is that the existing types `SEO.JSONLD.WebPage`, `SEO.JSONLD.WebSite` and `SEO.JSONLD.WebPageElement` will eventually be declared as subtypes of `SEO.JSONLD.WebContent`.)

  Helper for building a Schema.org [WebContent](https://schema.org/WebContent) JSON-LD structure.
  """
  ...
  `"WebContent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a WebContent JSON-LD map.

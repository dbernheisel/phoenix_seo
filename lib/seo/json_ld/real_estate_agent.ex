...
defmodule SEO.JSONLD.RealEstateAgent do
  @moduledoc """
  A real-estate agent.

  Helper for building a Schema.org [RealEstateAgent](https://schema.org/RealEstateAgent) JSON-LD structure.
  """
  ...
  `"RealEstateAgent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a RealEstateAgent JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "RealEstateAgent")
  end
end

...
defmodule SEO.JSONLD.Audiobook do
  @moduledoc """
  An audiobook.

  Helper for building a Schema.org [Audiobook](https://schema.org/Audiobook) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            optional(:read_by) => SEO.JSONLD.Person.t() | map(),
            ...
            optional(:book_edition) => String.t(),
            optional(:book_format) =>
              :audiobook_format | :e_book | :graphic_novel | :hardcover | :pamphlet | :paperback,
            optional(:illustrator) => SEO.JSONLD.Person.t() | map(),
            optional(:isbn) => String.t(),
            optional(:number_of_pages) => integer(),
          ...
          | [
              ...
              read_by: SEO.JSONLD.Person.t() | map(),
              caption: String.t() | SEO.JSONLD.MediaObject.t() | map(),
              embedded_text_caption: String.t(),
              transcript: String.t(),
              abridged: boolean(),
              book_edition: String.t(),
              book_format:
                :audiobook_format | :e_book | :graphic_novel | :hardcover | :pamphlet | :paperback,
              illustrator: SEO.JSONLD.Person.t() | map(),
              isbn: String.t(),
  ...
  `"Audiobook"` respectively, plus any camelCased field keys
  ...
  - `:read_by` - A person who reads (performs) the audiobook.

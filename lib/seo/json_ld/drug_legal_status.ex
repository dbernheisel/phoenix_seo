...
defmodule SEO.JSONLD.DrugLegalStatus do
  @moduledoc """
  The legal availability status of a medical drug.

  Helper for building a Schema.org [DrugLegalStatus](https://schema.org/DrugLegalStatus) JSON-LD structure.
  """
  ...
  `"DrugLegalStatus"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DrugLegalStatus JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "DrugLegalStatus")
  end
end

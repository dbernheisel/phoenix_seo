...
defmodule SEO.JSONLD.TransferAction do
  @moduledoc """
  The act of transferring/moving (abstract or concrete) animate or inanimate objects from one place to another.

  Helper for building a Schema.org [TransferAction](https://schema.org/TransferAction) JSON-LD structure.
  ...
  `"TransferAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TransferAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "TransferAction")
  end
end

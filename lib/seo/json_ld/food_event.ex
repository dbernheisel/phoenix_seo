...
defmodule SEO.JSONLD.FoodEvent do
  @moduledoc """
  Event type: Food event.

  Helper for building a Schema.org [FoodEvent](https://schema.org/FoodEvent) JSON-LD structure.
  """
  ...
  `"FoodEvent"` respectively, plus any camelCased field keys

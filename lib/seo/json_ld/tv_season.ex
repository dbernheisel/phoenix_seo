...
defmodule SEO.JSONLD.TVSeason do
  @moduledoc """
  Season dedicated to TV broadcast and associated online delivery.

  Helper for building a Schema.org [TVSeason](https://schema.org/TVSeason) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            optional(:season_number) => integer() | String.t(),
          ...
          | [
              ...
              season_number: integer() | String.t(),
  ...
  `"TVSeason"` respectively, plus any camelCased field keys

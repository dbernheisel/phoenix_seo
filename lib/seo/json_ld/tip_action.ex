...
defmodule SEO.JSONLD.TipAction do
  @moduledoc """
  The act of giving money voluntarily to a beneficiary in recognition of services rendered.

  Helper for building a Schema.org [TipAction](https://schema.org/TipAction) JSON-LD structure.
  ...
  `"TipAction"` respectively, plus any camelCased field keys

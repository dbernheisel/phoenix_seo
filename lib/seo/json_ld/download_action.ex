...
defmodule SEO.JSONLD.DownloadAction do
  @moduledoc """
  The act of downloading an object.

  Helper for building a Schema.org [DownloadAction](https://schema.org/DownloadAction) JSON-LD structure.
  ...
  `"DownloadAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DownloadAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "DownloadAction")
  end
end

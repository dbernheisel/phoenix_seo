...
defmodule SEO.JSONLD.FoodService do
  @moduledoc """
  A food service, like breakfast, lunch, or dinner.

  Helper for building a Schema.org [FoodService](https://schema.org/FoodService) JSON-LD structure.
  """
  ...
  `"FoodService"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a FoodService JSON-LD map.

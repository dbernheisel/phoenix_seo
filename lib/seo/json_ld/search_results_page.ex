...
defmodule SEO.JSONLD.SearchResultsPage do
  @moduledoc """
  Web page type: Search results page.

  Helper for building a Schema.org [SearchResultsPage](https://schema.org/SearchResultsPage) JSON-LD structure.
  """
  ...
  `"SearchResultsPage"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SearchResultsPage JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SearchResultsPage")
  end
end

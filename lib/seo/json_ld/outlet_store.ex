...
defmodule SEO.JSONLD.OutletStore do
  @moduledoc """
  An outlet store.

  Helper for building a Schema.org [OutletStore](https://schema.org/OutletStore) JSON-LD structure.
  """
  ...
  `"OutletStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a OutletStore JSON-LD map.

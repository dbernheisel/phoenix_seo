...
defmodule SEO.JSONLD.SeaBodyOfWater do
  @moduledoc """
  A sea (for example, the Caspian sea).

  Helper for building a Schema.org [SeaBodyOfWater](https://schema.org/SeaBodyOfWater) JSON-LD structure.
  """
  ...
  `"SeaBodyOfWater"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SeaBodyOfWater JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SeaBodyOfWater")
  end
end

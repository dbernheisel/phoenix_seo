...
defmodule SEO.JSONLD.Substance do
  @moduledoc """
  Any matter of defined composition that has discrete existence, whose origin may be biological, mineral or chemical.

  Helper for building a Schema.org [Substance](https://schema.org/Substance) JSON-LD structure.
  """
  ...
  `"Substance"` respectively, plus any camelCased field keys

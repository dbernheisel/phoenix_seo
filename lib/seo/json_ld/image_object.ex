...
defmodule SEO.JSONLD.ImageObject do
  @moduledoc """
  An image file.

  ![ImageObject rich-result example](./assets/image-metadata-example.png)
  ![ImageObject rich-result example](./assets/image-metadata-example-2.png)
  ...
  Helper for building a Schema.org [ImageObject](https://schema.org/ImageObject) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            optional(:exif_data) => SEO.JSONLD.PropertyValue.t() | map() | String.t(),
            optional(:representative_of_page) => boolean(),
            optional(:associated_article) => SEO.JSONLD.NewsArticle.t() | map(),
            optional(:bitrate) => String.t(),
            optional(:content_size) => String.t(),
            required(:content_url) => URI.t() | String.t(),
            optional(:duration) =>
          ...
          | [
              ...
              exif_data: SEO.JSONLD.PropertyValue.t() | map() | String.t(),
              representative_of_page: boolean(),
  ...
  `"ImageObject"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ImageObject JSON-LD map.
  ...
  - `:exif_data` - exif data for this object.
  - `:representative_of_page` - Indicates whether this image is representative of the content of the page.

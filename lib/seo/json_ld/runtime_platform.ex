...
defmodule SEO.JSONLD.RuntimePlatform do
  @moduledoc """
  ...
  Helper for building a Schema.org [RuntimePlatform](https://schema.org/RuntimePlatform) JSON-LD structure.
  """
  ...
  `"RuntimePlatform"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a RuntimePlatform JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "RuntimePlatform")
  end
end

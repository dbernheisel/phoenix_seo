...
defmodule SEO.JSONLD.MoneyTransfer do
  @moduledoc """
  The act of transferring money from one place to another place. This may occur electronically or physically.

  Helper for building a Schema.org [MoneyTransfer](https://schema.org/MoneyTransfer) JSON-LD structure.
  ...
  @type attrs ::
          %{
            ...
            optional(:beneficiary_bank) => String.t() | SEO.JSONLD.BankOrCreditUnion.t() | map(),
          ...
          | [
              ...
              beneficiary_bank: String.t() | SEO.JSONLD.BankOrCreditUnion.t() | map(),
  ...
  `"MoneyTransfer"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MoneyTransfer JSON-LD map.

  ## Fields

  - `:amount` - The amount of money.
  - `:beneficiary_bank` - A bank or bank’s branch, financial institution or international financial institution operating the beneficiary’s bank account or releasing funds for the beneficiary.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MoneyTransfer")
  end
end

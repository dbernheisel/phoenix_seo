...
defmodule SEO.JSONLD.GovernmentOrganization do
  @moduledoc """
  A governmental organization or agency.

  Helper for building a Schema.org [GovernmentOrganization](https://schema.org/GovernmentOrganization) JSON-LD structure.
  """
  ...
  `"GovernmentOrganization"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a GovernmentOrganization JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "GovernmentOrganization")
  end
end

...
defmodule SEO.JSONLD.CoverArt do
  @moduledoc """
  The artwork on the outer surface of a CreativeWork.

  Helper for building a Schema.org [CoverArt](https://schema.org/CoverArt) JSON-LD structure.
  """
  ...
  `"CoverArt"` respectively, plus any camelCased field keys

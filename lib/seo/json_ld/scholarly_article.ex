...
defmodule SEO.JSONLD.ScholarlyArticle do
  @moduledoc """
  A scholarly article.

  Helper for building a Schema.org [ScholarlyArticle](https://schema.org/ScholarlyArticle) JSON-LD structure.
  """
  ...
  `"ScholarlyArticle"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ScholarlyArticle JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ScholarlyArticle")
  end
end

...
defmodule SEO.JSONLD.AdministrativeArea do
  @moduledoc """
  A geographical region, typically under the jurisdiction of a particular government.

  Helper for building a Schema.org [AdministrativeArea](https://schema.org/AdministrativeArea) JSON-LD structure.
  """
  ...
  `"AdministrativeArea"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AdministrativeArea JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "AdministrativeArea")
  end
end

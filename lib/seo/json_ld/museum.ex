...
defmodule SEO.JSONLD.Museum do
  @moduledoc """
  A museum.

  Helper for building a Schema.org [Museum](https://schema.org/Museum) JSON-LD structure.
  """
  ...
  `"Museum"` respectively, plus any camelCased field keys

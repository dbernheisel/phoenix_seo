...
defmodule SEO.JSONLD.FilmAction do
  @moduledoc """
  The act of capturing sound and moving images on film, video, or digitally.

  Helper for building a Schema.org [FilmAction](https://schema.org/FilmAction) JSON-LD structure.
  ...
  `"FilmAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a FilmAction JSON-LD map.

...
defmodule SEO.JSONLD.MedicalTestPanel do
  @moduledoc """
  Any collection of tests commonly ordered together.

  Helper for building a Schema.org [MedicalTestPanel](https://schema.org/MedicalTestPanel) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:sub_test) => SEO.JSONLD.MedicalTest.t() | map(),
          ...
          | [
              sub_test: SEO.JSONLD.MedicalTest.t() | map(),
  ...
  `"MedicalTestPanel"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalTestPanel JSON-LD map.

  ## Fields

  - `:sub_test` - A component test of the panel.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalTestPanel")
  end
end

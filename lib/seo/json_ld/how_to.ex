...
defmodule SEO.JSONLD.HowTo do
  @moduledoc """
  Instructions that explain how to achieve a result by performing a sequence of steps.

  Helper for building a Schema.org [HowTo](https://schema.org/HowTo) JSON-LD structure.
  """
  ...
  `"HowTo"` respectively, plus any camelCased field keys

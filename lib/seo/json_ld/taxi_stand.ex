...
defmodule SEO.JSONLD.TaxiStand do
  @moduledoc """
  A taxi stand.

  Helper for building a Schema.org [TaxiStand](https://schema.org/TaxiStand) JSON-LD structure.
  """
  ...
  `"TaxiStand"` respectively, plus any camelCased field keys

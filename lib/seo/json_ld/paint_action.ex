...
defmodule SEO.JSONLD.PaintAction do
  @moduledoc """
  The act of producing a painting, typically with paint and canvas as instruments.

  Helper for building a Schema.org [PaintAction](https://schema.org/PaintAction) JSON-LD structure.
  ...
  `"PaintAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PaintAction JSON-LD map.

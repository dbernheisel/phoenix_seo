...
defmodule SEO.JSONLD.SportsTeam do
  @moduledoc """
  Organization: Sports team.

  Helper for building a Schema.org [SportsTeam](https://schema.org/SportsTeam) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:athlete) => SEO.JSONLD.Person.t() | map(),
            optional(:coach) => SEO.JSONLD.Person.t() | map(),
            optional(:gender) => String.t() | :female | :male,
            optional(:sport) => String.t() | URI.t(),
          ...
          | [
              athlete: SEO.JSONLD.Person.t() | map(),
              coach: SEO.JSONLD.Person.t() | map(),
              gender: String.t() | :female | :male,
              sport: String.t() | URI.t(),
  ...
  `"SportsTeam"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SportsTeam JSON-LD map.

...
defmodule SEO.JSONLD.LocalBusiness do
  ...
  ![LocalBusiness rich-result example](./assets/local-business-example.png)
  ...
  @type attrs ::
          %{
            ...
            required(:address) => String.t() | SEO.JSONLD.PostalAddress.t() | map(),
  ...
  `"LocalBusiness"` respectively, plus any camelCased field keys
  ...
  - `:branch_of` - The larger organization that this local business is a branch of, if any. Not to be confused with (anatomical) `branch`.
  - `:currencies_accepted` - The currency accepted.
  ...
  - `:opening_hours` - The general opening hours for a business. Opening hours can be specified as a weekly time range, starting with days, then times per day. Multiple days can be listed with commas ',' separating each day. Day or time ranges are specified using a hyphen '-'.

  * Days are specified using the following two-letter combinations: ```Mo```, ```Tu```, ```We```, ```Th```, ```Fr```, ```Sa```, ```Su```.
  * Times are specified using 24:00 format. For example, 3pm is specified as ```15:00```, 10am as ```10:00```.
  * Here is an example: &lt;time itemprop="openingHours" datetime=&quot;Tu,Th 16:00-20:00&quot;&gt;Tuesdays and Thursdays 4-8pm&lt;/time&gt;.
  * If a business is open 7 days a week, then it can be specified as &lt;time itemprop=&quot;openingHours&quot; datetime=&quot;Mo-Su&quot;&gt;Monday through Sunday, all day&lt;/time&gt;.
  - `:payment_accepted` - Cash, Credit Card, Cryptocurrency, Local Exchange Tradings System, etc.
  - `:price_range` - The price range of the business, for example ```$$$```.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "LocalBusiness")
  end
end

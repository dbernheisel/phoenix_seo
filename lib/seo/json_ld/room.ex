...
defmodule SEO.JSONLD.Room do
  ...
  Helper for building a Schema.org [Room](https://schema.org/Room) JSON-LD structure.
  """
  ...
  `"Room"` respectively, plus any camelCased field keys

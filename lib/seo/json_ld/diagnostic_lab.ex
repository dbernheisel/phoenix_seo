...
defmodule SEO.JSONLD.DiagnosticLab do
  @moduledoc """
  A medical laboratory that offers on-site or off-site diagnostic services.

  Helper for building a Schema.org [DiagnosticLab](https://schema.org/DiagnosticLab) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:available_test) => SEO.JSONLD.MedicalTest.t() | map(),
          ...
          | [
              available_test: SEO.JSONLD.MedicalTest.t() | map(),
  ...
  `"DiagnosticLab"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DiagnosticLab JSON-LD map.

  ## Fields

  - `:available_test` - A diagnostic test or procedure offered by this lab.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "DiagnosticLab")
  end
end

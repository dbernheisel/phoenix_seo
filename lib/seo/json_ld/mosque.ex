...
defmodule SEO.JSONLD.Mosque do
  @moduledoc """
  A mosque.

  Helper for building a Schema.org [Mosque](https://schema.org/Mosque) JSON-LD structure.
  """
  ...
  `"Mosque"` respectively, plus any camelCased field keys

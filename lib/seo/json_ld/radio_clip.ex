...
defmodule SEO.JSONLD.RadioClip do
  @moduledoc """
  A short radio program or a segment/part of a radio program.

  Helper for building a Schema.org [RadioClip](https://schema.org/RadioClip) JSON-LD structure.
  """
  ...
  `"RadioClip"` respectively, plus any camelCased field keys

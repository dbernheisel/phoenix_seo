...
defmodule SEO.JSONLD.LibrarySystem do
  @moduledoc """
  A `SEO.JSONLD.LibrarySystem` is a collaborative system amongst several libraries.

  Helper for building a Schema.org [LibrarySystem](https://schema.org/LibrarySystem) JSON-LD structure.
  """
  ...
  `"LibrarySystem"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a LibrarySystem JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "LibrarySystem")
  end
end

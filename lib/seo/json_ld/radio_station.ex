...
defmodule SEO.JSONLD.RadioStation do
  @moduledoc """
  A radio station.

  Helper for building a Schema.org [RadioStation](https://schema.org/RadioStation) JSON-LD structure.
  """
  ...
  `"RadioStation"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a RadioStation JSON-LD map.

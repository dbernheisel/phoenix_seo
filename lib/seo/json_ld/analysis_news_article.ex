...
defmodule SEO.JSONLD.AnalysisNewsArticle do
  @moduledoc """
  An AnalysisNewsArticle is a `SEO.JSONLD.NewsArticle` that, while based on factual reporting, incorporates the expertise of the author/producer, offering interpretations and conclusions.

  Helper for building a Schema.org [AnalysisNewsArticle](https://schema.org/AnalysisNewsArticle) JSON-LD structure.
  """
  ...
  `"AnalysisNewsArticle"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AnalysisNewsArticle JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "AnalysisNewsArticle")
  end
end

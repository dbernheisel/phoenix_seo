...
defmodule SEO.JSONLD.ComicStory do
  @moduledoc """
  The term "story" is any indivisible, re-printable
  unit of a comic, including the interior stories, covers, and backmatter. Most
  comics have at least two stories: a cover (ComicCoverArt) and an interior story.

  Helper for building a Schema.org [ComicStory](https://schema.org/ComicStory) JSON-LD structure.
  """
  ...
  `"ComicStory"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ComicStory JSON-LD map.

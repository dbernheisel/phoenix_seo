...
defmodule SEO.JSONLD.BeautySalon do
  @moduledoc """
  Beauty salon.

  Helper for building a Schema.org [BeautySalon](https://schema.org/BeautySalon) JSON-LD structure.
  """
  ...
  `"BeautySalon"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a BeautySalon JSON-LD map.

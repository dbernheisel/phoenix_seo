...
defmodule SEO.JSONLD.HousePainter do
  @moduledoc """
  A house painting service.

  Helper for building a Schema.org [HousePainter](https://schema.org/HousePainter) JSON-LD structure.
  """
  ...
  `"HousePainter"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a HousePainter JSON-LD map.

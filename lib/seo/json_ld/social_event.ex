...
defmodule SEO.JSONLD.SocialEvent do
  @moduledoc """
  Event type: Social event.

  Helper for building a Schema.org [SocialEvent](https://schema.org/SocialEvent) JSON-LD structure.
  """
  ...
  `"SocialEvent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SocialEvent JSON-LD map.

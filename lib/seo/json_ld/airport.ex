...
defmodule SEO.JSONLD.Airport do
  @moduledoc """
  An airport.

  Helper for building a Schema.org [Airport](https://schema.org/Airport) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:iata_code) => String.t(),
            optional(:icao_code) => String.t(),
  ...
  `"Airport"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Airport JSON-LD map.

  ## Fields

  - `:iata_code` - IATA identifier for an airline or airport.
  - `:icao_code` - ICAO identifier for an airport.

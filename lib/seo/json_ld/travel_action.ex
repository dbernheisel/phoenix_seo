...
defmodule SEO.JSONLD.TravelAction do
  @moduledoc """
  The act of traveling from a fromLocation to a destination by a specified mode of transport, optionally with participants.

  Helper for building a Schema.org [TravelAction](https://schema.org/TravelAction) JSON-LD structure.
  ...
  `"TravelAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TravelAction JSON-LD map.

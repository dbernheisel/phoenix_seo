...
defmodule SEO.JSONLD.LoginAction do
  @moduledoc """
  The action of logging into a device or application.

  Helper for building a Schema.org [LoginAction](https://schema.org/LoginAction) JSON-LD structure.
  ...
  `"LoginAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a LoginAction JSON-LD map.

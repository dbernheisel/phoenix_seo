...
defmodule SEO.JSONLD.OnlineMarketplace do
  @moduledoc """
  An eCommerce marketplace.

  Helper for building a Schema.org [OnlineMarketplace](https://schema.org/OnlineMarketplace) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:has_store) => SEO.JSONLD.OnlineStore.t() | map(),
            optional(:is_store_on) => SEO.JSONLD.OnlineMarketplace.t() | map(),
          ...
          | [
              has_store: SEO.JSONLD.OnlineStore.t() | map(),
              is_store_on: SEO.JSONLD.OnlineMarketplace.t() | map(),
  ...
  `"OnlineMarketplace"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a OnlineMarketplace JSON-LD map.

  ## Fields

  - `:has_store` - An eCommerce store part of an online marketplace.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "OnlineMarketplace")
  end
end

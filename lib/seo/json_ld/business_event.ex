...
defmodule SEO.JSONLD.BusinessEvent do
  @moduledoc """
  Event type: Business event.

  Helper for building a Schema.org [BusinessEvent](https://schema.org/BusinessEvent) JSON-LD structure.
  """
  ...
  `"BusinessEvent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a BusinessEvent JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "BusinessEvent")
  end
end

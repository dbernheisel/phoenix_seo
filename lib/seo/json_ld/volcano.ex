...
defmodule SEO.JSONLD.Volcano do
  @moduledoc """
  A volcano, like Fujisan.

  Helper for building a Schema.org [Volcano](https://schema.org/Volcano) JSON-LD structure.
  """
  ...
  `"Volcano"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.BuddhistTemple do
  @moduledoc """
  A Buddhist temple.

  Helper for building a Schema.org [BuddhistTemple](https://schema.org/BuddhistTemple) JSON-LD structure.
  """
  ...
  `"BuddhistTemple"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a BuddhistTemple JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "BuddhistTemple")
  end
end

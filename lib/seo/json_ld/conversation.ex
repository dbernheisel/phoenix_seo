...
defmodule SEO.JSONLD.Conversation do
  @moduledoc """
  One or more messages between organizations or people on a particular topic. Individual messages can be linked to the conversation with isPartOf or hasPart properties.

  Helper for building a Schema.org [Conversation](https://schema.org/Conversation) JSON-LD structure.
  """
  ...
  `"Conversation"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Conversation JSON-LD map.

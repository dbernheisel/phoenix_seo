...
defmodule SEO.JSONLD.DrugCost do
  @moduledoc """
  The cost per unit of a medical drug. Note that this type is not meant to represent the price in an offer of a drug for sale; see the Offer type for that. This type will typically be used to tag wholesale or average retail cost of a drug, or maximum reimbursable cost. Costs of medical drugs vary widely depending on how and where they are paid for, so while this type captures some of the variables, costs should be used with caution by consumers of this schema's markup.

  Helper for building a Schema.org [DrugCost](https://schema.org/DrugCost) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:applicable_location) => SEO.JSONLD.AdministrativeArea.t() | map(),
            optional(:cost_category) => :reimbursement_cap | :retail | :wholesale,
            optional(:cost_currency) => String.t(),
            optional(:cost_origin) => String.t(),
          ...
          | [
              applicable_location: SEO.JSONLD.AdministrativeArea.t() | map(),
              cost_category: :reimbursement_cap | :retail | :wholesale,
              cost_currency: String.t(),
              cost_origin: String.t(),
              cost_per_unit:
                :all_wheel_drive_configuration
                | :four_wheel_drive_configuration
                | :front_wheel_drive_configuration
  ...
  `"DrugCost"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DrugCost JSON-LD map.

  ## Fields

  - `:applicable_location` - The location in which the status applies.
  - `:cost_category` - The category of cost, such as wholesale, retail, reimbursement cap, etc. One of: `:reimbursement_cap`, `:retail`, `:wholesale`.
  - `:cost_currency` - The currency (in 3-letter) of the drug cost. See: http://en.wikipedia.org/wiki/ISO_4217.
  - `:cost_origin` - Additional details to capture the origin of the cost data. For example, 'Medicare Part B'.
  - `:cost_per_unit` - The cost per unit of the drug. One of: `:all_wheel_drive_configuration`, `:four_wheel_drive_configuration`, `:front_wheel_drive_configuration`, `:left_hand_driving`, `:rear_wheel_drive_configuration`, `:right_hand_driving`.

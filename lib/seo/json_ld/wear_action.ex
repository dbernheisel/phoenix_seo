...
defmodule SEO.JSONLD.WearAction do
  @moduledoc """
  The act of dressing oneself in clothing.

  Helper for building a Schema.org [WearAction](https://schema.org/WearAction) JSON-LD structure.
  ...
  `"WearAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a WearAction JSON-LD map.

...
defmodule SEO.JSONLD.Season do
  @moduledoc """
  A media season, e.g. TV, radio, video game etc.

  Helper for building a Schema.org [Season](https://schema.org/Season) JSON-LD structure.
  """
  ...
  `"Season"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.DiagnosticProcedure do
  @moduledoc """
  A medical procedure intended primarily for diagnostic, as opposed to therapeutic, purposes.

  Helper for building a Schema.org [DiagnosticProcedure](https://schema.org/DiagnosticProcedure) JSON-LD structure.
  """
  ...
  `"DiagnosticProcedure"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DiagnosticProcedure JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "DiagnosticProcedure")
  end
end

...
defmodule SEO.JSONLD.EducationalOrganization do
  @moduledoc """
  An educational organization.

  Helper for building a Schema.org [EducationalOrganization](https://schema.org/EducationalOrganization) JSON-LD structure.
  """
  ...
  `"EducationalOrganization"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a EducationalOrganization JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "EducationalOrganization")
  end
end

...
defmodule SEO.JSONLD.LiteraryEvent do
  @moduledoc """
  Event type: Literary event.

  Helper for building a Schema.org [LiteraryEvent](https://schema.org/LiteraryEvent) JSON-LD structure.
  """
  ...
  `"LiteraryEvent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a LiteraryEvent JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "LiteraryEvent")
  end
end

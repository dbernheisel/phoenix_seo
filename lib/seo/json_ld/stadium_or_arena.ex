...
defmodule SEO.JSONLD.StadiumOrArena do
  @moduledoc """
  A stadium.

  Helper for building a Schema.org [StadiumOrArena](https://schema.org/StadiumOrArena) JSON-LD structure.
  """
  ...
  `"StadiumOrArena"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a StadiumOrArena JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "StadiumOrArena")
  end
end

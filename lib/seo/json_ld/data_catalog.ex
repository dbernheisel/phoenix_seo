...
defmodule SEO.JSONLD.DataCatalog do
  @moduledoc """
  A collection of datasets.

  Helper for building a Schema.org [DataCatalog](https://schema.org/DataCatalog) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:dataset) => SEO.JSONLD.Dataset.t() | map(),
          ...
          | [
              dataset: SEO.JSONLD.Dataset.t() | map(),
              measurement_method:
                String.t()
                | URI.t()
                | :example_measurement_method_enum
  ...
  `"DataCatalog"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DataCatalog JSON-LD map.

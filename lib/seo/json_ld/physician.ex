...
defmodule SEO.JSONLD.Physician do
  @moduledoc """
  An individual physician or a physician's office considered as a `SEO.JSONLD.MedicalOrganization`.

  Helper for building a Schema.org [Physician](https://schema.org/Physician) JSON-LD structure.
  """
  ...
  `"Physician"` respectively, plus any camelCased field keys

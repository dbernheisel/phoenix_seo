...
defmodule SEO.JSONLD.AdultEntertainment do
  @moduledoc """
  An adult entertainment establishment.

  Helper for building a Schema.org [AdultEntertainment](https://schema.org/AdultEntertainment) JSON-LD structure.
  """
  ...
  `"AdultEntertainment"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AdultEntertainment JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "AdultEntertainment")
  end
end

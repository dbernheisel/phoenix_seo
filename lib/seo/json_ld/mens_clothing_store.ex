...
defmodule SEO.JSONLD.MensClothingStore do
  @moduledoc """
  A men's clothing store.

  Helper for building a Schema.org [MensClothingStore](https://schema.org/MensClothingStore) JSON-LD structure.
  """
  ...
  `"MensClothingStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MensClothingStore JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MensClothingStore")
  end
end

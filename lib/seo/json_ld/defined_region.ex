...
defmodule SEO.JSONLD.DefinedRegion do
  @moduledoc """
  ...
  Helper for building a Schema.org [DefinedRegion](https://schema.org/DefinedRegion) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            optional(:postal_code_prefix) => String.t(),
            optional(:postal_code_range) => SEO.JSONLD.PostalCodeRangeSpecification.t() | map(),
          ...
          | [
              ...
              postal_code_prefix: String.t(),
              postal_code_range: SEO.JSONLD.PostalCodeRangeSpecification.t() | map(),
  ...
  `"DefinedRegion"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DefinedRegion JSON-LD map.
  ...
  - `:postal_code_prefix` - A defined range of postal codes indicated by a common textual prefix. Used for non-numeric systems such as UK.
  - `:postal_code_range` - A defined range of postal codes.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "DefinedRegion")
  end
end

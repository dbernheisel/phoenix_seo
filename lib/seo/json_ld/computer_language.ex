...
defmodule SEO.JSONLD.ComputerLanguage do
  @moduledoc """
  This type covers computer programming languages such as Scheme and Lisp, as well as other language-like computer representations. Natural languages are best represented with the `SEO.JSONLD.Language` type.

  Helper for building a Schema.org [ComputerLanguage](https://schema.org/ComputerLanguage) JSON-LD structure.
  """
  ...
  `"ComputerLanguage"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ComputerLanguage JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ComputerLanguage")
  end
end

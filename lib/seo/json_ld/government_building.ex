...
defmodule SEO.JSONLD.GovernmentBuilding do
  @moduledoc """
  A government building.

  Helper for building a Schema.org [GovernmentBuilding](https://schema.org/GovernmentBuilding) JSON-LD structure.
  """
  ...
  `"GovernmentBuilding"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a GovernmentBuilding JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "GovernmentBuilding")
  end
end

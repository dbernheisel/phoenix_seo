...
defmodule SEO.JSONLD.ControlAction do
  @moduledoc """
  An agent controls a device or application.

  Helper for building a Schema.org [ControlAction](https://schema.org/ControlAction) JSON-LD structure.
  ...
  `"ControlAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ControlAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ControlAction")
  end
end

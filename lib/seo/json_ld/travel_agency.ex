...
defmodule SEO.JSONLD.TravelAgency do
  @moduledoc """
  A travel agency.

  Helper for building a Schema.org [TravelAgency](https://schema.org/TravelAgency) JSON-LD structure.
  """
  ...
  `"TravelAgency"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TravelAgency JSON-LD map.

...
defmodule SEO.JSONLD.Electrician do
  @moduledoc """
  An electrician.

  Helper for building a Schema.org [Electrician](https://schema.org/Electrician) JSON-LD structure.
  """
  ...
  `"Electrician"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Electrician JSON-LD map.

...
defmodule SEO.JSONLD.Airline do
  @moduledoc """
  An organization that provides flights for passengers.

  Helper for building a Schema.org [Airline](https://schema.org/Airline) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:boarding_policy) => :group_boarding_policy | :zone_boarding_policy,
            optional(:iata_code) => String.t(),
  ...
  `"Airline"` respectively, plus any camelCased field keys
  ...
  - `:iata_code` - IATA identifier for an airline or airport.

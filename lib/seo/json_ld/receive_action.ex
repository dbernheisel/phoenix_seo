...
defmodule SEO.JSONLD.ReceiveAction do
  @moduledoc """
  The act of physically/electronically taking delivery of an object that has been transferred from an origin to a destination. Reciprocal of SendAction.

  Related actions:

  * `SEO.JSONLD.SendAction`: The reciprocal of ReceiveAction.
  * `SEO.JSONLD.TakeAction`: Unlike TakeAction, ReceiveAction does not imply that the ownership has been transferred (e.g. I can receive a package, but it does not mean the package is now mine).

  Helper for building a Schema.org [ReceiveAction](https://schema.org/ReceiveAction) JSON-LD structure.
  ...
  @type attrs ::
          %{
            optional(:delivery_method) => :locker_delivery | :on_site_pickup | :parcel_service,
            optional(:sender) =>
          ...
          | [
              delivery_method: :locker_delivery | :on_site_pickup | :parcel_service,
              sender:
                SEO.JSONLD.Organization.t()
                | map()
                | SEO.JSONLD.Person.t()
  ...
  `"ReceiveAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ReceiveAction JSON-LD map.

  ## Fields

  - `:delivery_method` - A sub property of instrument. The method of delivery. One of: `:locker_delivery`, `:on_site_pickup`, `:parcel_service`.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ReceiveAction")
  end
end

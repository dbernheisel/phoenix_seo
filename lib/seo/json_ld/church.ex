...
defmodule SEO.JSONLD.Church do
  @moduledoc """
  A church.

  Helper for building a Schema.org [Church](https://schema.org/Church) JSON-LD structure.
  """
  ...
  `"Church"` respectively, plus any camelCased field keys

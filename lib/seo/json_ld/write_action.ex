...
defmodule SEO.JSONLD.WriteAction do
  @moduledoc """
  The act of authoring written creative content.

  Helper for building a Schema.org [WriteAction](https://schema.org/WriteAction) JSON-LD structure.
  ...
  `"WriteAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a WriteAction JSON-LD map.

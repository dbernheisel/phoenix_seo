...
defmodule SEO.JSONLD.Book do
  @moduledoc """
  A book.

  Helper for building a Schema.org [Book](https://schema.org/Book) JSON-LD structure.
  """
  ...
  `"Book"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Book JSON-LD map.

  ## Fields

  - `:abridged` - Indicates whether the book is an abridged edition.
  - `:book_edition` - The edition of the book.
  - `:book_format` - The format of the book. One of: `:audiobook_format`, `:e_book`, `:graphic_novel`, `:hardcover`, `:pamphlet`, `:paperback`.

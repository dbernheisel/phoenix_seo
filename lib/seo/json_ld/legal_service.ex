...
defmodule SEO.JSONLD.LegalService do
  @moduledoc """
  A LegalService is a business that provides legally-oriented services, advice and representation, e.g. law firms.

  As a `SEO.JSONLD.LocalBusiness` it can be described as a `provider` of one or more `SEO.JSONLD.Service`\(s).

  Helper for building a Schema.org [LegalService](https://schema.org/LegalService) JSON-LD structure.
  """
  ...
  `"LegalService"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a LegalService JSON-LD map.

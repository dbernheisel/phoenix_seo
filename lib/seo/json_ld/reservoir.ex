...
defmodule SEO.JSONLD.Reservoir do
  @moduledoc """
  A reservoir of water, typically an artificially created lake, like the Lake Kariba reservoir.

  Helper for building a Schema.org [Reservoir](https://schema.org/Reservoir) JSON-LD structure.
  """
  ...
  `"Reservoir"` respectively, plus any camelCased field keys

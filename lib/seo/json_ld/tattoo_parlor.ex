...
defmodule SEO.JSONLD.TattooParlor do
  @moduledoc """
  A tattoo parlor.

  Helper for building a Schema.org [TattooParlor](https://schema.org/TattooParlor) JSON-LD structure.
  """
  ...
  `"TattooParlor"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TattooParlor JSON-LD map.

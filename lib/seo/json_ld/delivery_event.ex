...
defmodule SEO.JSONLD.DeliveryEvent do
  @moduledoc """
  An event involving the delivery of an item.

  Helper for building a Schema.org [DeliveryEvent](https://schema.org/DeliveryEvent) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:access_code) => String.t(),
            optional(:available_from) => DateTime.t() | NaiveDateTime.t() | String.t(),
            optional(:available_through) => DateTime.t() | NaiveDateTime.t() | String.t(),
          ...
          | [
              ...
              available_from: DateTime.t() | NaiveDateTime.t() | String.t(),
              available_through: DateTime.t() | NaiveDateTime.t() | String.t(),
  ...
  `"DeliveryEvent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DeliveryEvent JSON-LD map.

  ## Fields

  - `:access_code` - Password, PIN, or access code needed for delivery (e.g. from a locker).
  - `:available_from` - When the item is available for pickup from the store, locker, etc.
  - `:available_through` - After this date, the item will no longer be available for pickup.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "DeliveryEvent")
  end
end

...
defmodule SEO.JSONLD.EatAction do
  @moduledoc """
  The act of swallowing solid objects.

  Helper for building a Schema.org [EatAction](https://schema.org/EatAction) JSON-LD structure.
  ...
  `"EatAction"` respectively, plus any camelCased field keys

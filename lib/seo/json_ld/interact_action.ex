...
defmodule SEO.JSONLD.InteractAction do
  @moduledoc """
  The act of interacting with another person or organization.

  Helper for building a Schema.org [InteractAction](https://schema.org/InteractAction) JSON-LD structure.
  ...
  `"InteractAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a InteractAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "InteractAction")
  end
end

...
defmodule SEO.JSONLD.MedicalCause do
  @moduledoc """
  ...
  Helper for building a Schema.org [MedicalCause](https://schema.org/MedicalCause) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:cause_of) => SEO.JSONLD.MedicalEntity.t() | map(),
          ...
          | [
              cause_of: SEO.JSONLD.MedicalEntity.t() | map(),
  ...
  `"MedicalCause"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalCause JSON-LD map.

  ## Fields

  - `:cause_of` - The condition, complication, symptom, sign, etc. caused.

...
defmodule SEO.JSONLD.MiddleSchool do
  @moduledoc """
  A middle school (typically for children aged around 11-14, although this varies somewhat).

  Helper for building a Schema.org [MiddleSchool](https://schema.org/MiddleSchool) JSON-LD structure.
  """
  ...
  `"MiddleSchool"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MiddleSchool JSON-LD map.

...
defmodule SEO.JSONLD.TouristAttraction do
  @moduledoc """
  A tourist attraction. In principle any Thing can be a `SEO.JSONLD.TouristAttraction`, from a `SEO.JSONLD.Mountain` and `SEO.JSONLD.LandmarksOrHistoricalBuildings` to a `SEO.JSONLD.LocalBusiness`. This Type can be used on its own to describe a general `SEO.JSONLD.TouristAttraction`, or be used as an `additionalType` to add tourist attraction properties to any other type. (See examples below)

  Helper for building a Schema.org [TouristAttraction](https://schema.org/TouristAttraction) JSON-LD structure.
  """
  ...
  `"TouristAttraction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TouristAttraction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "TouristAttraction")
  end
end

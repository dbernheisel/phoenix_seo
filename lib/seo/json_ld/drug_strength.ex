...
defmodule SEO.JSONLD.DrugStrength do
  @moduledoc """
  A specific strength in which a medical drug is available in a specific country.

  Helper for building a Schema.org [DrugStrength](https://schema.org/DrugStrength) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:active_ingredient) => String.t(),
            optional(:available_in) => SEO.JSONLD.AdministrativeArea.t() | map(),
            optional(:maximum_intake) => SEO.JSONLD.MaximumDoseSchedule.t() | map(),
            optional(:strength_unit) => String.t(),
            optional(:strength_value) => number(),
          ...
          | [
              ...
              available_in: SEO.JSONLD.AdministrativeArea.t() | map(),
              maximum_intake: SEO.JSONLD.MaximumDoseSchedule.t() | map(),
              strength_unit: String.t(),
  ...
  `"DrugStrength"` respectively, plus any camelCased field keys
  ...
  - `:strength_unit` - The units of an active ingredient's strength, e.g. mg.
  - `:strength_value` - The value of an active ingredient's strength, e.g. 325.

...
defmodule SEO.JSONLD.MarryAction do
  @moduledoc """
  The act of marrying a person.

  Helper for building a Schema.org [MarryAction](https://schema.org/MarryAction) JSON-LD structure.
  ...
  `"MarryAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MarryAction JSON-LD map.

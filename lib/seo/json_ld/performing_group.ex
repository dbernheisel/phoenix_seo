...
defmodule SEO.JSONLD.PerformingGroup do
  @moduledoc """
  A performance group, such as a band, an orchestra, or a circus.

  Helper for building a Schema.org [PerformingGroup](https://schema.org/PerformingGroup) JSON-LD structure.
  """
  ...
  `"PerformingGroup"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PerformingGroup JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PerformingGroup")
  end
end

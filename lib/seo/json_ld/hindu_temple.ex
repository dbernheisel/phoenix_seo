...
defmodule SEO.JSONLD.HinduTemple do
  @moduledoc """
  A Hindu temple.

  Helper for building a Schema.org [HinduTemple](https://schema.org/HinduTemple) JSON-LD structure.
  """
  ...
  `"HinduTemple"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a HinduTemple JSON-LD map.

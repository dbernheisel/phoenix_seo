...
defmodule SEO.JSONLD.VideoGameClip do
  @moduledoc """
  A short segment/part of a video game.

  Helper for building a Schema.org [VideoGameClip](https://schema.org/VideoGameClip) JSON-LD structure.
  """
  ...
  `"VideoGameClip"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a VideoGameClip JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "VideoGameClip")
  end
end

...
defmodule SEO.JSONLD.AccountingService do
  @moduledoc """
  Accountancy business.

  As a `SEO.JSONLD.LocalBusiness` it can be described as a `provider` of one or more `SEO.JSONLD.Service`\(s).

  Helper for building a Schema.org [AccountingService](https://schema.org/AccountingService) JSON-LD structure.
  """
  ...
  `"AccountingService"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AccountingService JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "AccountingService")
  end
end

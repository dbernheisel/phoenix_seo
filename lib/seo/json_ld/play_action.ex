...
defmodule SEO.JSONLD.PlayAction do
  @moduledoc """
  The act of playing/exercising/training/performing for enjoyment, leisure, recreation, competition or exercise.

  Related actions:

  * `SEO.JSONLD.ListenAction`: Unlike ListenAction (which is under ConsumeAction), PlayAction refers to performing for an audience or at an event, rather than consuming music.
  * `SEO.JSONLD.WatchAction`: Unlike WatchAction (which is under ConsumeAction), PlayAction refers to showing/displaying for an audience or at an event, rather than consuming visual content.

  Helper for building a Schema.org [PlayAction](https://schema.org/PlayAction) JSON-LD structure.
  ...
  `"PlayAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PlayAction JSON-LD map.

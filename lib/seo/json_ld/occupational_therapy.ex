...
defmodule SEO.JSONLD.OccupationalTherapy do
  @moduledoc """
  A treatment of people with physical, emotional, or social problems, using purposeful activity to help them overcome or learn to deal with their problems.

  Helper for building a Schema.org [OccupationalTherapy](https://schema.org/OccupationalTherapy) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            optional(:duplicate_therapy) => SEO.JSONLD.MedicalTherapy.t() | map(),
          ...
          | [
              ...
              duplicate_therapy: SEO.JSONLD.MedicalTherapy.t() | map(),
  ...
  `"OccupationalTherapy"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a OccupationalTherapy JSON-LD map.
  ...
  - `SEO.JSONLD.MedicalTherapy`
  - `SEO.JSONLD.TherapeuticProcedure`
  - `SEO.JSONLD.MedicalProcedure`
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "OccupationalTherapy")
  end
end

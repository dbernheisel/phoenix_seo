...
defmodule SEO.JSONLD.DiscussionForumPosting do
  @moduledoc """
  A posting to a discussion forum.

  ![DiscussionForumPosting rich-result example](./assets/discussion-forum-example.png)

  Helper for building a Schema.org [DiscussionForumPosting](https://schema.org/DiscussionForumPosting) JSON-LD structure.
  """
  ...
  `"DiscussionForumPosting"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DiscussionForumPosting JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "DiscussionForumPosting")
  end
end

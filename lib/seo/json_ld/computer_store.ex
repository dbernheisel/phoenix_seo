...
defmodule SEO.JSONLD.ComputerStore do
  @moduledoc """
  A computer store.

  Helper for building a Schema.org [ComputerStore](https://schema.org/ComputerStore) JSON-LD structure.
  """
  ...
  `"ComputerStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ComputerStore JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ComputerStore")
  end
end

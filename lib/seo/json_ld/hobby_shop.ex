...
defmodule SEO.JSONLD.HobbyShop do
  @moduledoc """
  A store that sells materials useful or necessary for various hobbies.

  Helper for building a Schema.org [HobbyShop](https://schema.org/HobbyShop) JSON-LD structure.
  """
  ...
  `"HobbyShop"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.MenuSection do
  @moduledoc """
  A sub-grouping of food or drink items in a menu. E.g. courses (such as 'Dinner', 'Breakfast', etc.), specific type of dishes (such as 'Meat', 'Vegan', 'Drinks', etc.), or some other classification made by the menu provider.

  Helper for building a Schema.org [MenuSection](https://schema.org/MenuSection) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:has_menu_item) => SEO.JSONLD.MenuItem.t() | map(),
            optional(:has_menu_section) => SEO.JSONLD.MenuSection.t() | map(),
          ...
          | [
              has_menu_item: SEO.JSONLD.MenuItem.t() | map(),
              has_menu_section: SEO.JSONLD.MenuSection.t() | map(),
  ...
  `"MenuSection"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MenuSection JSON-LD map.

  ## Fields

  - `:has_menu_item` - A food or drink item contained in a menu or menu section.
  - `:has_menu_section` - A subgrouping of the menu (by dishes, course, serving time period, etc.).

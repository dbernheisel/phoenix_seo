...
defmodule SEO.JSONLD.FurnitureStore do
  @moduledoc """
  A furniture store.

  Helper for building a Schema.org [FurnitureStore](https://schema.org/FurnitureStore) JSON-LD structure.
  """
  ...
  `"FurnitureStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a FurnitureStore JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "FurnitureStore")
  end
end

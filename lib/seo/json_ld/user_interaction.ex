...
defmodule SEO.JSONLD.UserInteraction do
  @moduledoc """
  ...
  Helper for building a Schema.org [UserInteraction](https://schema.org/UserInteraction) JSON-LD structure.
  """
  ...
  `"UserInteraction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a UserInteraction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "UserInteraction")
  end
end

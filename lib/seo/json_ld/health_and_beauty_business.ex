...
defmodule SEO.JSONLD.HealthAndBeautyBusiness do
  @moduledoc """
  Health and beauty.

  Helper for building a Schema.org [HealthAndBeautyBusiness](https://schema.org/HealthAndBeautyBusiness) JSON-LD structure.
  """
  ...
  `"HealthAndBeautyBusiness"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a HealthAndBeautyBusiness JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "HealthAndBeautyBusiness")
  end
end

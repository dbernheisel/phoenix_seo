...
defmodule SEO.JSONLD.ProductModel do
  @moduledoc """
  A datasheet or vendor specification of a product (in the sense of a prototypical description).

  Helper for building a Schema.org [ProductModel](https://schema.org/ProductModel) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            optional(:predecessor_of) => SEO.JSONLD.ProductModel.t() | map(),
            optional(:successor_of) => SEO.JSONLD.ProductModel.t() | map(),
          ...
          | [
              ...
              predecessor_of: SEO.JSONLD.ProductModel.t() | map(),
              successor_of: SEO.JSONLD.ProductModel.t() | map(),
  ...
  `"ProductModel"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ProductModel JSON-LD map.
  ...
  - `:predecessor_of` - A pointer from a previous, often discontinued variant of the product to its newer variant.
  - `:successor_of` - A pointer from a newer variant of a product to its previous, often discontinued predecessor.

...
defmodule SEO.JSONLD.RecommendedDoseSchedule do
  @moduledoc """
  A recommended dosing schedule for a drug or supplement as prescribed or recommended by an authority or by the drug/supplement's manufacturer. Capture the recommending authority in the recognizingAuthority property of MedicalEntity.

  Helper for building a Schema.org [RecommendedDoseSchedule](https://schema.org/RecommendedDoseSchedule) JSON-LD structure.
  """
  ...
  `"RecommendedDoseSchedule"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a RecommendedDoseSchedule JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "RecommendedDoseSchedule")
  end
end

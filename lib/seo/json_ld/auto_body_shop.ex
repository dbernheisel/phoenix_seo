...
defmodule SEO.JSONLD.AutoBodyShop do
  @moduledoc """
  Auto body shop.

  Helper for building a Schema.org [AutoBodyShop](https://schema.org/AutoBodyShop) JSON-LD structure.
  """
  ...
  `"AutoBodyShop"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AutoBodyShop JSON-LD map.

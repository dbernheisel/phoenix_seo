...
defmodule SEO.JSONLD.UserTweets do
  @moduledoc """
  ...
  Helper for building a Schema.org [UserTweets](https://schema.org/UserTweets) JSON-LD structure.
  """
  ...
  `"UserTweets"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a UserTweets JSON-LD map.

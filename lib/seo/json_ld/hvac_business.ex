...
defmodule SEO.JSONLD.HVACBusiness do
  @moduledoc """
  A business that provides Heating, Ventilation and Air Conditioning services.

  Helper for building a Schema.org [HVACBusiness](https://schema.org/HVACBusiness) JSON-LD structure.
  """
  ...
  `"HVACBusiness"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a HVACBusiness JSON-LD map.

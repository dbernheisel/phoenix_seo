...
defmodule SEO.JSONLD.Menu do
  @moduledoc """
  A structured representation of food or drink items available from a FoodEstablishment.

  Helper for building a Schema.org [Menu](https://schema.org/Menu) JSON-LD structure.
  """
  ...
  `"Menu"` respectively, plus any camelCased field keys

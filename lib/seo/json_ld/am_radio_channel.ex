...
defmodule SEO.JSONLD.AMRadioChannel do
  @moduledoc """
  A radio channel that uses AM.

  Helper for building a Schema.org [AMRadioChannel](https://schema.org/AMRadioChannel) JSON-LD structure.
  """
  ...
  `"AMRadioChannel"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AMRadioChannel JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "AMRadioChannel")
  end
end

...
defmodule SEO.JSONLD.CreateAction do
  @moduledoc """
  The act of deliberately creating/producing/generating/building a result out of the agent.

  Helper for building a Schema.org [CreateAction](https://schema.org/CreateAction) JSON-LD structure.
  ...
  `"CreateAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CreateAction JSON-LD map.

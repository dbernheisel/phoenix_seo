...
defmodule SEO.JSONLD.MovieSeries do
  @moduledoc """
  A series of movies. Included movies can be indicated with the hasPart property.

  Helper for building a Schema.org [MovieSeries](https://schema.org/MovieSeries) JSON-LD structure.
  """
  ...
  `"MovieSeries"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MovieSeries JSON-LD map.

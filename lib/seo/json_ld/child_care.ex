...
defmodule SEO.JSONLD.ChildCare do
  @moduledoc """
  A Childcare center.

  Helper for building a Schema.org [ChildCare](https://schema.org/ChildCare) JSON-LD structure.
  """
  ...
  `"ChildCare"` respectively, plus any camelCased field keys

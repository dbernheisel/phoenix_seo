...
defmodule SEO.JSONLD.DefenceEstablishment do
  @moduledoc """
  A defence establishment, such as an army or navy base.

  Helper for building a Schema.org [DefenceEstablishment](https://schema.org/DefenceEstablishment) JSON-LD structure.
  """
  ...
  `"DefenceEstablishment"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DefenceEstablishment JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "DefenceEstablishment")
  end
end

...
defmodule SEO.JSONLD.SportsOrganization do
  @moduledoc """
  Represents the collection of all sports organizations, including sports teams, governing bodies, and sports associations.

  Helper for building a Schema.org [SportsOrganization](https://schema.org/SportsOrganization) JSON-LD structure.
  """
  ...
  `"SportsOrganization"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SportsOrganization JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SportsOrganization")
  end
end

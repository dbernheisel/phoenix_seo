...
defmodule SEO.JSONLD.RadioSeason do
  @moduledoc """
  Season dedicated to radio broadcast and associated online delivery.

  Helper for building a Schema.org [RadioSeason](https://schema.org/RadioSeason) JSON-LD structure.
  """
  ...
  `"RadioSeason"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a RadioSeason JSON-LD map.

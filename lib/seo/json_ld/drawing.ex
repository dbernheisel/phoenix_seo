...
defmodule SEO.JSONLD.Drawing do
  @moduledoc """
  A picture or diagram made with a pencil, pen, or crayon rather than paint.

  Helper for building a Schema.org [Drawing](https://schema.org/Drawing) JSON-LD structure.
  """
  ...
  `"Drawing"` respectively, plus any camelCased field keys

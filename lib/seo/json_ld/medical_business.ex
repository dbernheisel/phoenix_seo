...
defmodule SEO.JSONLD.MedicalBusiness do
  @moduledoc """
  ...
  Helper for building a Schema.org [MedicalBusiness](https://schema.org/MedicalBusiness) JSON-LD structure.
  """
  ...
  `"MedicalBusiness"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalBusiness JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalBusiness")
  end
end

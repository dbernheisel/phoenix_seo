...
defmodule SEO.JSONLD.MathSolver do
  @moduledoc """
  A math solver which is capable of solving a subset of mathematical problems.

  ![MathSolver rich-result example](./assets/math-solvers-example.png)

  Helper for building a Schema.org [MathSolver](https://schema.org/MathSolver) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:math_expression) => String.t() | SEO.JSONLD.SolveMathAction.t() | map(),
            ...
            required(:usage_info) => SEO.JSONLD.CreativeWork.t() | map() | URI.t() | String.t(),
            ...
            required(:url) => URI.t() | String.t()
          }
          | [
              math_expression: String.t() | SEO.JSONLD.SolveMathAction.t() | map(),
  ...
  `["MathSolver", "LearningResource"]` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MathSolver JSON-LD map.

  ## Fields

  - `:math_expression` - A mathematical expression (e.g. 'x^2-3x=0') that may be solved for a specific variable, simplified, or transformed. This can take many formats, e.g. LaTeX, Ascii-Math, or math as you would write with a keyboard.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", ["MathSolver", "LearningResource"])
  end
end

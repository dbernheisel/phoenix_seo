...
defmodule SEO.JSONLD.BusStation do
  @moduledoc """
  A bus station.

  Helper for building a Schema.org [BusStation](https://schema.org/BusStation) JSON-LD structure.
  """
  ...
  `"BusStation"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a BusStation JSON-LD map.

...
defmodule SEO.JSONLD.UserCheckins do
  @moduledoc """
  ...
  Helper for building a Schema.org [UserCheckins](https://schema.org/UserCheckins) JSON-LD structure.
  """
  ...
  `"UserCheckins"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a UserCheckins JSON-LD map.

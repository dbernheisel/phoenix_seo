...
defmodule SEO.JSONLD.MedicalSignOrSymptom do
  @moduledoc """
  Any feature associated or not with a medical condition. In medicine a symptom is generally subjective while a sign is objective.

  Helper for building a Schema.org [MedicalSignOrSymptom](https://schema.org/MedicalSignOrSymptom) JSON-LD structure.
  """
  ...
  `"MedicalSignOrSymptom"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalSignOrSymptom JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalSignOrSymptom")
  end
end

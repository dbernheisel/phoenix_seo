...
defmodule SEO.JSONLD.BankOrCreditUnion do
  @moduledoc """
  Bank or credit union.

  Helper for building a Schema.org [BankOrCreditUnion](https://schema.org/BankOrCreditUnion) JSON-LD structure.
  """
  ...
  `"BankOrCreditUnion"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a BankOrCreditUnion JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "BankOrCreditUnion")
  end
end

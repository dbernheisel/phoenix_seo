...
defmodule SEO.JSONLD.EmployerReview do
  @moduledoc """
  An `SEO.JSONLD.EmployerReview` is a review of an `SEO.JSONLD.Organization` regarding its role as an employer, written by a current or former employee of that organization.

  Helper for building a Schema.org [EmployerReview](https://schema.org/EmployerReview) JSON-LD structure.
  """
  ...
  `"EmployerReview"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a EmployerReview JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "EmployerReview")
  end
end

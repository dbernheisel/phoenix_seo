...
defmodule SEO.JSONLD.OperatingSystem do
  @moduledoc """
  System software that manages computer hardware and software resources, and provides common services for computer programs.

  Helper for building a Schema.org [OperatingSystem](https://schema.org/OperatingSystem) JSON-LD structure.
  """
  ...
  `"OperatingSystem"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a OperatingSystem JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "OperatingSystem")
  end
end

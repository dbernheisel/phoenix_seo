...
defmodule SEO.JSONLD.SpreadsheetDigitalDocument do
  @moduledoc """
  A spreadsheet file.

  Helper for building a Schema.org [SpreadsheetDigitalDocument](https://schema.org/SpreadsheetDigitalDocument) JSON-LD structure.
  """
  ...
  `"SpreadsheetDigitalDocument"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SpreadsheetDigitalDocument JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SpreadsheetDigitalDocument")
  end
end

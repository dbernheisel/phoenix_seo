...
defmodule SEO.JSONLD.LakeBodyOfWater do
  @moduledoc """
  A lake (for example, Lake Pontrachain).

  Helper for building a Schema.org [LakeBodyOfWater](https://schema.org/LakeBodyOfWater) JSON-LD structure.
  """
  ...
  `"LakeBodyOfWater"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a LakeBodyOfWater JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "LakeBodyOfWater")
  end
end

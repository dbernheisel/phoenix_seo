...
defmodule SEO.JSONLD.LiveBlogPosting do
  @moduledoc """
  A `SEO.JSONLD.LiveBlogPosting` is a `SEO.JSONLD.BlogPosting` intended to provide a rolling textual coverage of an ongoing event through continuous updates.

  Helper for building a Schema.org [LiveBlogPosting](https://schema.org/LiveBlogPosting) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:coverage_end_time) => DateTime.t() | NaiveDateTime.t() | String.t(),
            optional(:coverage_start_time) => DateTime.t() | NaiveDateTime.t() | String.t(),
            optional(:live_blog_update) => SEO.JSONLD.BlogPosting.t() | map(),
            optional(:shared_content) => SEO.JSONLD.CreativeWork.t() | map(),
            optional(:article_body) => String.t(),
            optional(:article_section) => String.t(),
            optional(:backstory) => SEO.JSONLD.CreativeWork.t() | map() | String.t(),
            optional(:page_end) => integer() | String.t(),
            optional(:page_start) => integer() | String.t(),
            optional(:pagination) => String.t(),
            optional(:speakable) =>
          ...
          | [
              coverage_end_time: DateTime.t() | NaiveDateTime.t() | String.t(),
              coverage_start_time: DateTime.t() | NaiveDateTime.t() | String.t(),
              live_blog_update: SEO.JSONLD.BlogPosting.t() | map(),
              shared_content: SEO.JSONLD.CreativeWork.t() | map(),
              article_body: String.t(),
              article_section: String.t(),
              backstory: SEO.JSONLD.CreativeWork.t() | map() | String.t(),
              page_end: integer() | String.t(),
              page_start: integer() | String.t(),
              pagination: String.t(),
  ...
  `"LiveBlogPosting"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a LiveBlogPosting JSON-LD map.

  ## Fields

  - `:coverage_end_time` - The time when the live blog will stop covering the Event. Note that coverage may continue after the Event concludes.
  - `:coverage_start_time` - The time when the live blog will begin covering the Event. Note that coverage may begin before the Event's start time. The LiveBlogPosting may also be created before coverage begins.
  - `:live_blog_update` - An update to the LiveBlog.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "LiveBlogPosting")
  end
end

...
defmodule SEO.JSONLD.MusicStore do
  @moduledoc """
  A music store.

  Helper for building a Schema.org [MusicStore](https://schema.org/MusicStore) JSON-LD structure.
  """
  ...
  `"MusicStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MusicStore JSON-LD map.

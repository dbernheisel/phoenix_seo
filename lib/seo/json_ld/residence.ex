...
defmodule SEO.JSONLD.Residence do
  @moduledoc """
  The place where a person lives.

  Helper for building a Schema.org [Residence](https://schema.org/Residence) JSON-LD structure.
  """
  ...
  `"Residence"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.Syllabus do
  @moduledoc """
  A syllabus that describes the material covered in a course, often with several such sections per `SEO.JSONLD.Course` so that a distinct `timeRequired` can be provided for that section of the `SEO.JSONLD.Course`.

  Helper for building a Schema.org [Syllabus](https://schema.org/Syllabus) JSON-LD structure.
  """
  ...
  `"Syllabus"` respectively, plus any camelCased field keys

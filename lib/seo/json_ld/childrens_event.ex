...
defmodule SEO.JSONLD.ChildrensEvent do
  @moduledoc """
  Event type: Children's event.

  Helper for building a Schema.org [ChildrensEvent](https://schema.org/ChildrensEvent) JSON-LD structure.
  """
  ...
  `"ChildrensEvent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ChildrensEvent JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ChildrensEvent")
  end
end

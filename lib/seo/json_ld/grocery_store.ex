...
defmodule SEO.JSONLD.GroceryStore do
  @moduledoc """
  A grocery store.

  Helper for building a Schema.org [GroceryStore](https://schema.org/GroceryStore) JSON-LD structure.
  """
  ...
  `"GroceryStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a GroceryStore JSON-LD map.

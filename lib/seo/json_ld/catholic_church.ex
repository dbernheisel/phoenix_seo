...
defmodule SEO.JSONLD.CatholicChurch do
  @moduledoc """
  A Catholic church.

  Helper for building a Schema.org [CatholicChurch](https://schema.org/CatholicChurch) JSON-LD structure.
  """
  ...
  `"CatholicChurch"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CatholicChurch JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "CatholicChurch")
  end
end

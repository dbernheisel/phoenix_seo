...
defmodule SEO.JSONLD.PublicToilet do
  @moduledoc """
  A public toilet is a room or small building containing one or more toilets (and possibly also urinals) which is available for use by the general public, or by customers or employees of certain businesses.

  Helper for building a Schema.org [PublicToilet](https://schema.org/PublicToilet) JSON-LD structure.
  """
  ...
  `"PublicToilet"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PublicToilet JSON-LD map.

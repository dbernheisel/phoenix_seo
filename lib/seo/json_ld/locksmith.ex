...
defmodule SEO.JSONLD.Locksmith do
  @moduledoc """
  A locksmith.

  Helper for building a Schema.org [Locksmith](https://schema.org/Locksmith) JSON-LD structure.
  """
  ...
  `"Locksmith"` respectively, plus any camelCased field keys

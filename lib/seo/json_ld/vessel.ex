...
defmodule SEO.JSONLD.Vessel do
  @moduledoc """
  A component of the human body circulatory system comprised of an intricate network of hollow tubes that transport blood throughout the entire body.

  Helper for building a Schema.org [Vessel](https://schema.org/Vessel) JSON-LD structure.
  """
  ...
  `"Vessel"` respectively, plus any camelCased field keys

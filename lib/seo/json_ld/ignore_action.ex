...
defmodule SEO.JSONLD.IgnoreAction do
  @moduledoc """
  The act of intentionally disregarding the object. An agent ignores an object.

  Helper for building a Schema.org [IgnoreAction](https://schema.org/IgnoreAction) JSON-LD structure.
  ...
  `"IgnoreAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a IgnoreAction JSON-LD map.

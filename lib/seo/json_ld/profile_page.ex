...
defmodule SEO.JSONLD.ProfilePage do
  @moduledoc """
  Web page type: Profile page.

  Helper for building a Schema.org [ProfilePage](https://schema.org/ProfilePage) JSON-LD structure.
  """
  ...
  `"ProfilePage"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ProfilePage JSON-LD map.

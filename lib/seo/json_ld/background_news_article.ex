...
defmodule SEO.JSONLD.BackgroundNewsArticle do
  @moduledoc """
  A `SEO.JSONLD.NewsArticle` providing historical context, definition and detail on a specific topic (aka "explainer" or "backgrounder"). For example, an in-depth article or frequently-asked-questions ([FAQ](https://en.wikipedia.org/wiki/FAQ)) document on topics such as Climate Change or the European Union. Other kinds of background material from a non-news setting are often described using `SEO.JSONLD.Book` or `SEO.JSONLD.Article`, in particular `SEO.JSONLD.ScholarlyArticle`. See also `SEO.JSONLD.NewsArticle` for related vocabulary from a learning/education perspective.

  Helper for building a Schema.org [BackgroundNewsArticle](https://schema.org/BackgroundNewsArticle) JSON-LD structure.
  """
  ...
  `"BackgroundNewsArticle"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a BackgroundNewsArticle JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "BackgroundNewsArticle")
  end
end

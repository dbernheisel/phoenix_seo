...
defmodule SEO.JSONLD.DepartmentStore do
  @moduledoc """
  A department store.

  Helper for building a Schema.org [DepartmentStore](https://schema.org/DepartmentStore) JSON-LD structure.
  """
  ...
  `"DepartmentStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DepartmentStore JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "DepartmentStore")
  end
end

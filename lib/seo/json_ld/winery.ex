...
defmodule SEO.JSONLD.Winery do
  @moduledoc """
  A winery.

  Helper for building a Schema.org [Winery](https://schema.org/Winery) JSON-LD structure.
  """
  ...
  `"Winery"` respectively, plus any camelCased field keys

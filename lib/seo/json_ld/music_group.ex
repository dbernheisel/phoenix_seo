...
defmodule SEO.JSONLD.MusicGroup do
  @moduledoc """
  A musical group, such as a band, an orchestra, or a choir. Can also be a solo musician.

  Helper for building a Schema.org [MusicGroup](https://schema.org/MusicGroup) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:album) => SEO.JSONLD.MusicAlbum.t() | map(),
            optional(:albums) => SEO.JSONLD.MusicAlbum.t() | map(),
            optional(:genre) => String.t() | URI.t() | SEO.JSONLD.DefinedTerm.t() | map(),
            optional(:music_group_member) => SEO.JSONLD.Person.t() | map(),
          ...
          | [
              album: SEO.JSONLD.MusicAlbum.t() | map(),
              albums: SEO.JSONLD.MusicAlbum.t() | map(),
              genre: String.t() | URI.t() | SEO.JSONLD.DefinedTerm.t() | map(),
              music_group_member: SEO.JSONLD.Person.t() | map(),
  ...
  `"MusicGroup"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MusicGroup JSON-LD map.
  ...
  - `:music_group_member` - A member of a music group&#x2014;for example, John, Paul, George, or Ringo.

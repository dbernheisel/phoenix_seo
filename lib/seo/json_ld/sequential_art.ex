...
defmodule SEO.JSONLD.SequentialArt do
  @moduledoc """
  ...
  Helper for building a Schema.org [SequentialArt](https://schema.org/SequentialArt) JSON-LD structure.
  """
  ...
  `"SequentialArt"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SequentialArt JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SequentialArt")
  end
end

...
defmodule SEO.JSONLD.ComedyClub do
  @moduledoc """
  A comedy club.

  Helper for building a Schema.org [ComedyClub](https://schema.org/ComedyClub) JSON-LD structure.
  """
  ...
  `"ComedyClub"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ComedyClub JSON-LD map.

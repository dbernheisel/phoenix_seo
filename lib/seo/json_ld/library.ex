...
defmodule SEO.JSONLD.Library do
  @moduledoc """
  A library.

  Helper for building a Schema.org [Library](https://schema.org/Library) JSON-LD structure.
  """
  ...
  `"Library"` respectively, plus any camelCased field keys

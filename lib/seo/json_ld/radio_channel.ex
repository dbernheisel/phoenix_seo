...
defmodule SEO.JSONLD.RadioChannel do
  @moduledoc """
  A unique instance of a radio BroadcastService on a CableOrSatelliteService lineup.

  Helper for building a Schema.org [RadioChannel](https://schema.org/RadioChannel) JSON-LD structure.
  """
  ...
  `"RadioChannel"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a RadioChannel JSON-LD map.

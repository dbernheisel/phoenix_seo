...
defmodule SEO.JSONLD.DrawAction do
  @moduledoc """
  The act of producing a visual/graphical representation of an object, typically with a pen/pencil and paper as instruments.

  Helper for building a Schema.org [DrawAction](https://schema.org/DrawAction) JSON-LD structure.
  ...
  `"DrawAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DrawAction JSON-LD map.

...
defmodule SEO.JSONLD.Sculpture do
  @moduledoc """
  A piece of sculpture.

  Helper for building a Schema.org [Sculpture](https://schema.org/Sculpture) JSON-LD structure.
  """
  ...
  `"Sculpture"` respectively, plus any camelCased field keys

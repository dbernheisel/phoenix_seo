...
defmodule SEO.JSONLD.WorkersUnion do
  @moduledoc """
  A Workers Union (also known as a Labor Union, Labour Union, or Trade Union) is an organization that promotes the interests of its worker members by collectively bargaining with management, organizing, and political lobbying.

  Helper for building a Schema.org [WorkersUnion](https://schema.org/WorkersUnion) JSON-LD structure.
  """
  ...
  `"WorkersUnion"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a WorkersUnion JSON-LD map.

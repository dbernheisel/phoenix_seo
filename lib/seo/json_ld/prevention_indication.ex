...
defmodule SEO.JSONLD.PreventionIndication do
  @moduledoc """
  An indication for preventing an underlying condition, symptom, etc.

  Helper for building a Schema.org [PreventionIndication](https://schema.org/PreventionIndication) JSON-LD structure.
  """
  ...
  `"PreventionIndication"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PreventionIndication JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PreventionIndication")
  end
end

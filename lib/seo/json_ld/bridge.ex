...
defmodule SEO.JSONLD.Bridge do
  @moduledoc """
  A bridge.

  Helper for building a Schema.org [Bridge](https://schema.org/Bridge) JSON-LD structure.
  """
  ...
  `"Bridge"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.ArriveAction do
  @moduledoc """
  The act of arriving at a place. An agent arrives at a destination from a fromLocation, optionally with participants.

  Helper for building a Schema.org [ArriveAction](https://schema.org/ArriveAction) JSON-LD structure.
  ...
  `"ArriveAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ArriveAction JSON-LD map.

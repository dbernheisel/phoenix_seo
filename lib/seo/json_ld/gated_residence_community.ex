...
defmodule SEO.JSONLD.GatedResidenceCommunity do
  @moduledoc """
  Residence type: Gated community.

  Helper for building a Schema.org [GatedResidenceCommunity](https://schema.org/GatedResidenceCommunity) JSON-LD structure.
  """
  ...
  `"GatedResidenceCommunity"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a GatedResidenceCommunity JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "GatedResidenceCommunity")
  end
end

...
defmodule SEO.JSONLD.DeleteAction do
  @moduledoc """
  The act of editing a recipient by removing one of its objects.

  Helper for building a Schema.org [DeleteAction](https://schema.org/DeleteAction) JSON-LD structure.
  ...
  `"DeleteAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DeleteAction JSON-LD map.

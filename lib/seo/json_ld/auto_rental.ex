...
defmodule SEO.JSONLD.AutoRental do
  @moduledoc """
  A car rental business.

  Helper for building a Schema.org [AutoRental](https://schema.org/AutoRental) JSON-LD structure.
  """
  ...
  `"AutoRental"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AutoRental JSON-LD map.

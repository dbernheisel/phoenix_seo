...
defmodule SEO.JSONLD.BookmarkAction do
  @moduledoc """
  An agent bookmarks/flags/labels/tags/marks an object.

  Helper for building a Schema.org [BookmarkAction](https://schema.org/BookmarkAction) JSON-LD structure.
  ...
  `"BookmarkAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a BookmarkAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "BookmarkAction")
  end
end

...
defmodule SEO.JSONLD.Motorcycle do
  @moduledoc """
  A motorcycle or motorbike is a single-track, two-wheeled motor vehicle.

  Helper for building a Schema.org [Motorcycle](https://schema.org/Motorcycle) JSON-LD structure.
  """
  ...
  `"Motorcycle"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Motorcycle JSON-LD map.

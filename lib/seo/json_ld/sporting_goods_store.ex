...
defmodule SEO.JSONLD.SportingGoodsStore do
  @moduledoc """
  A sporting goods store.

  Helper for building a Schema.org [SportingGoodsStore](https://schema.org/SportingGoodsStore) JSON-LD structure.
  """
  ...
  `"SportingGoodsStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SportingGoodsStore JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SportingGoodsStore")
  end
end

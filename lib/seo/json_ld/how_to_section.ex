...
defmodule SEO.JSONLD.HowToSection do
  @moduledoc """
  A sub-grouping of steps in the instructions for how to achieve a result (e.g. steps for making a pie crust within a pie recipe).

  Helper for building a Schema.org [HowToSection](https://schema.org/HowToSection) JSON-LD structure.
  """
  ...
  `"HowToSection"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a HowToSection JSON-LD map.

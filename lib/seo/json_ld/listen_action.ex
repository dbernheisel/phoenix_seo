...
defmodule SEO.JSONLD.ListenAction do
  @moduledoc """
  The act of consuming audio content.

  Helper for building a Schema.org [ListenAction](https://schema.org/ListenAction) JSON-LD structure.
  ...
  `"ListenAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ListenAction JSON-LD map.

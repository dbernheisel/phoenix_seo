...
defmodule SEO.JSONLD.DietarySupplement do
  @moduledoc """
  A product taken by mouth that contains a dietary ingredient intended to supplement the diet. Dietary ingredients may include vitamins, minerals, herbs or other botanicals, amino acids, and substances such as enzymes, organ tissues, glandulars and metabolites.

  Helper for building a Schema.org [DietarySupplement](https://schema.org/DietarySupplement) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            optional(:recommended_intake) => SEO.JSONLD.RecommendedDoseSchedule.t() | map(),
            optional(:safety_consideration) => String.t(),
            optional(:target_population) => String.t(),
          ...
          | [
              ...
              recommended_intake: SEO.JSONLD.RecommendedDoseSchedule.t() | map(),
              safety_consideration: String.t(),
              target_population: String.t(),
  ...
  `"DietarySupplement"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DietarySupplement JSON-LD map.
  ...
  - `:recommended_intake` - Recommended intake of this supplement for a given population as defined by a specific recommending authority.
  - `:safety_consideration` - Any potential safety concern associated with the supplement. May include interactions with other drugs and foods, pregnancy, breastfeeding, known adverse reactions, and documented efficacy of the supplement.
  - `:target_population` - Characteristics of the population for which this is intended, or which typically uses it, e.g. 'adults'.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "DietarySupplement")
  end
end

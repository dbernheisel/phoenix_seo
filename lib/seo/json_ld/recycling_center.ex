...
defmodule SEO.JSONLD.RecyclingCenter do
  @moduledoc """
  A recycling center.

  Helper for building a Schema.org [RecyclingCenter](https://schema.org/RecyclingCenter) JSON-LD structure.
  """
  ...
  `"RecyclingCenter"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a RecyclingCenter JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "RecyclingCenter")
  end
end

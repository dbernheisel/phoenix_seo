...
defmodule SEO.JSONLD.VideoGame do
  @moduledoc """
  A video game is an electronic game that involves human interaction with a user interface to generate visual feedback on a video device.

  Helper for building a Schema.org [VideoGame](https://schema.org/VideoGame) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:actor) => SEO.JSONLD.Person.t() | map() | SEO.JSONLD.PerformingGroup.t(),
            optional(:actors) => SEO.JSONLD.Person.t() | map(),
            optional(:cheat_code) => SEO.JSONLD.CreativeWork.t() | map(),
            optional(:director) => SEO.JSONLD.Person.t() | map(),
            optional(:directors) => SEO.JSONLD.Person.t() | map(),
            optional(:game_edition) => String.t(),
            optional(:game_platform) => String.t() | URI.t() | SEO.JSONLD.Thing.t() | map(),
            optional(:game_server) => SEO.JSONLD.GameServer.t() | map(),
            optional(:game_tip) => SEO.JSONLD.CreativeWork.t() | map(),
            optional(:music_by) => SEO.JSONLD.Person.t() | map() | SEO.JSONLD.MusicGroup.t(),
            optional(:play_mode) => :co_op | :multi_player | :single_player,
            optional(:trailer) => SEO.JSONLD.VideoObject.t() | map(),
            optional(:application_category) => String.t() | URI.t(),
            ...
            optional(:operating_system) => SEO.JSONLD.OperatingSystem.t() | map() | String.t(),
            ...
            optional(:character_attribute) => SEO.JSONLD.Thing.t() | map(),
            optional(:game_item) => SEO.JSONLD.Thing.t() | map(),
            optional(:game_location) =>
              SEO.JSONLD.Place.t() | map() | URI.t() | String.t() | SEO.JSONLD.PostalAddress.t(),
            optional(:number_of_players) => SEO.JSONLD.QuantitativeValue.t() | map(),
            optional(:quest) => SEO.JSONLD.Thing.t() | map(),
          ...
          | [
              ...
              actors: SEO.JSONLD.Person.t() | map(),
              cheat_code: SEO.JSONLD.CreativeWork.t() | map(),
              director: SEO.JSONLD.Person.t() | map(),
              directors: SEO.JSONLD.Person.t() | map(),
              game_edition: String.t(),
              game_platform: String.t() | URI.t() | SEO.JSONLD.Thing.t() | map(),
              game_server: SEO.JSONLD.GameServer.t() | map(),
              game_tip: SEO.JSONLD.CreativeWork.t() | map(),
              music_by: SEO.JSONLD.Person.t() | map() | SEO.JSONLD.MusicGroup.t(),
              play_mode: :co_op | :multi_player | :single_player,
              trailer: SEO.JSONLD.VideoObject.t() | map(),
              ...
              character_attribute: SEO.JSONLD.Thing.t() | map(),
              game_item: SEO.JSONLD.Thing.t() | map(),
              game_location:
                SEO.JSONLD.Place.t() | map() | URI.t() | String.t() | SEO.JSONLD.PostalAddress.t(),
              number_of_players: SEO.JSONLD.QuantitativeValue.t() | map(),
              quest: SEO.JSONLD.Thing.t() | map(),
  ...
  `"VideoGame"` respectively, plus any camelCased field keys
  ...
  - `:cheat_code` - Cheat codes to the game.
  ...
  - `:game_edition` - The edition of a video game.
  - `:game_platform` - The electronic systems used to play video games.
  - `:game_server` - The server on which it is possible to play the game.
  - `:game_tip` - Links to tips, tactics, etc.
  - `:music_by` - The composer of the soundtrack.
  - `:play_mode` - Indicates whether this game is multi-player, co-op or single-player. The game can be marked as multi-player, co-op and single-player at the same time. One of: `:co_op`, `:multi_player`, `:single_player`.

...
defmodule SEO.JSONLD.JoinAction do
  @moduledoc """
  An agent joins an event/group with participants/friends at a location.

  Related actions:

  * `SEO.JSONLD.RegisterAction`: Unlike RegisterAction, JoinAction refers to joining a group/team of people.
  * `SEO.JSONLD.SubscribeAction`: Unlike SubscribeAction, JoinAction does not imply that you'll be receiving updates.
  * `SEO.JSONLD.FollowAction`: Unlike FollowAction, JoinAction does not imply that you'll be polling for updates.

  Helper for building a Schema.org [JoinAction](https://schema.org/JoinAction) JSON-LD structure.
  ...
  `"JoinAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a JoinAction JSON-LD map.

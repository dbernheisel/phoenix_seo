...
defmodule SEO.JSONLD.InstallAction do
  @moduledoc """
  The act of installing an application.

  Helper for building a Schema.org [InstallAction](https://schema.org/InstallAction) JSON-LD structure.
  ...
  `"InstallAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a InstallAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "InstallAction")
  end
end

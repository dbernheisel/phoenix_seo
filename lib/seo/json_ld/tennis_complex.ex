...
defmodule SEO.JSONLD.TennisComplex do
  @moduledoc """
  A tennis complex.

  Helper for building a Schema.org [TennisComplex](https://schema.org/TennisComplex) JSON-LD structure.
  """
  ...
  `"TennisComplex"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TennisComplex JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "TennisComplex")
  end
end

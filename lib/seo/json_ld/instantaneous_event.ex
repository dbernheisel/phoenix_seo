...
defmodule SEO.JSONLD.InstantaneousEvent do
  @moduledoc """
  An event with no duration, like for instance a computer log entry.

  Helper for building a Schema.org [InstantaneousEvent](https://schema.org/InstantaneousEvent) JSON-LD structure.
  """
  ...
  `"InstantaneousEvent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a InstantaneousEvent JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "InstantaneousEvent")
  end
end

...
defmodule SEO.JSONLD.DrinkAction do
  @moduledoc """
  The act of swallowing liquids.

  Helper for building a Schema.org [DrinkAction](https://schema.org/DrinkAction) JSON-LD structure.
  ...
  `"DrinkAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DrinkAction JSON-LD map.

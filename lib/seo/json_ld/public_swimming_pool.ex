...
defmodule SEO.JSONLD.PublicSwimmingPool do
  @moduledoc """
  A public swimming pool.

  Helper for building a Schema.org [PublicSwimmingPool](https://schema.org/PublicSwimmingPool) JSON-LD structure.
  """
  ...
  `"PublicSwimmingPool"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PublicSwimmingPool JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PublicSwimmingPool")
  end
end

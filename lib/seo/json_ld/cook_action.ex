...
defmodule SEO.JSONLD.CookAction do
  @moduledoc """
  The act of producing/preparing food.

  Helper for building a Schema.org [CookAction](https://schema.org/CookAction) JSON-LD structure.
  ...
  @type attrs ::
          %{
            optional(:food_establishment) =>
              SEO.JSONLD.FoodEstablishment.t() | map() | SEO.JSONLD.Place.t(),
            optional(:food_event) => SEO.JSONLD.FoodEvent.t() | map(),
            optional(:recipe) => SEO.JSONLD.Recipe.t() | map(),
          ...
          | [
              food_establishment: SEO.JSONLD.FoodEstablishment.t() | map() | SEO.JSONLD.Place.t(),
              food_event: SEO.JSONLD.FoodEvent.t() | map(),
              recipe: SEO.JSONLD.Recipe.t() | map(),
  ...
  `"CookAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CookAction JSON-LD map.

  ## Fields

  - `:food_establishment` - A sub property of location. The specific food establishment where the action occurred.
  - `:food_event` - A sub property of location. The specific food event where the action occurred.

...
defmodule SEO.JSONLD.OrderAction do
  @moduledoc """
  An agent orders an object/product/service to be delivered/sent.

  Helper for building a Schema.org [OrderAction](https://schema.org/OrderAction) JSON-LD structure.
  ...
  `"OrderAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a OrderAction JSON-LD map.

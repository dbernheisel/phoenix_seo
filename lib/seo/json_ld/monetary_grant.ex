...
defmodule SEO.JSONLD.MonetaryGrant do
  @moduledoc """
  A monetary grant.

  Helper for building a Schema.org [MonetaryGrant](https://schema.org/MonetaryGrant) JSON-LD structure.
  """
  ...
  `"MonetaryGrant"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MonetaryGrant JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MonetaryGrant")
  end
end

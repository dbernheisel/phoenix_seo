...
defmodule SEO.JSONLD.Florist do
  @moduledoc """
  A florist.

  Helper for building a Schema.org [Florist](https://schema.org/Florist) JSON-LD structure.
  """
  ...
  `"Florist"` respectively, plus any camelCased field keys

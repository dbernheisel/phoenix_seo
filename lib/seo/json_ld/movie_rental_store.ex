...
defmodule SEO.JSONLD.MovieRentalStore do
  @moduledoc """
  A movie rental store.

  Helper for building a Schema.org [MovieRentalStore](https://schema.org/MovieRentalStore) JSON-LD structure.
  """
  ...
  `"MovieRentalStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MovieRentalStore JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MovieRentalStore")
  end
end

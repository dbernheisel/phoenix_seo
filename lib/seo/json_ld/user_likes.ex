...
defmodule SEO.JSONLD.UserLikes do
  @moduledoc """
  ...
  Helper for building a Schema.org [UserLikes](https://schema.org/UserLikes) JSON-LD structure.
  """
  ...
  `"UserLikes"` respectively, plus any camelCased field keys

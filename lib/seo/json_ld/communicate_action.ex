...
defmodule SEO.JSONLD.CommunicateAction do
  @moduledoc """
  The act of conveying information to another person via a communication medium (instrument) such as speech, email, or telephone conversation.

  Helper for building a Schema.org [CommunicateAction](https://schema.org/CommunicateAction) JSON-LD structure.
  ...
  `"CommunicateAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CommunicateAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "CommunicateAction")
  end
end

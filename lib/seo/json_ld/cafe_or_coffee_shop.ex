...
defmodule SEO.JSONLD.CafeOrCoffeeShop do
  @moduledoc """
  A cafe or coffee shop.

  Helper for building a Schema.org [CafeOrCoffeeShop](https://schema.org/CafeOrCoffeeShop) JSON-LD structure.
  """
  ...
  `"CafeOrCoffeeShop"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CafeOrCoffeeShop JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "CafeOrCoffeeShop")
  end
end

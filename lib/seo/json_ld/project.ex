...
defmodule SEO.JSONLD.Project do
  @moduledoc """
  An enterprise (potentially individual but typically collaborative), planned to achieve a particular aim.
  Use properties from `SEO.JSONLD.Organization`, `subOrganization`/`parentOrganization` to indicate project sub-structures.

  Helper for building a Schema.org [Project](https://schema.org/Project) JSON-LD structure.
  """
  ...
  `"Project"` respectively, plus any camelCased field keys

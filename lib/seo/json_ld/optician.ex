...
defmodule SEO.JSONLD.Optician do
  @moduledoc """
  A store that sells reading glasses and similar devices for improving vision.

  Helper for building a Schema.org [Optician](https://schema.org/Optician) JSON-LD structure.
  """
  ...
  `"Optician"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.ContactPage do
  @moduledoc """
  Web page type: Contact page.

  Helper for building a Schema.org [ContactPage](https://schema.org/ContactPage) JSON-LD structure.
  """
  ...
  `"ContactPage"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ContactPage JSON-LD map.

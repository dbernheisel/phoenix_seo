...
defmodule SEO.JSONLD.Recommendation do
  @moduledoc """
  `SEO.JSONLD.Recommendation` is a type of `SEO.JSONLD.Review` that suggests or proposes something as the best option or best course of action. Recommendations may be for products or services, or other concrete things, as in the case of a ranked list or product guide. A `SEO.JSONLD.Guide` may list multiple recommendations for different categories. For example, in a `SEO.JSONLD.Guide` about which TVs to buy, the author may have several `SEO.JSONLD.Recommendation`s.

  Helper for building a Schema.org [Recommendation](https://schema.org/Recommendation) JSON-LD structure.
  """
  ...
  `"Recommendation"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Recommendation JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "Recommendation")
  end
end

...
defmodule SEO.JSONLD.Intangible do
  @moduledoc """
  A utility class that serves as the umbrella for a number of 'intangible' things such as quantities, structured values, etc.

  Helper for building a Schema.org [Intangible](https://schema.org/Intangible) JSON-LD structure.
  """
  ...
  `"Intangible"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Intangible JSON-LD map.

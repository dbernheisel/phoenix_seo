...
defmodule SEO.JSONLD.ClothingStore do
  @moduledoc """
  A clothing store.

  Helper for building a Schema.org [ClothingStore](https://schema.org/ClothingStore) JSON-LD structure.
  """
  ...
  `"ClothingStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ClothingStore JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ClothingStore")
  end
end

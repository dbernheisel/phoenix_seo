...
defmodule SEO.JSONLD.RentAction do
  @moduledoc """
  The act of giving money in return for temporary use, but not ownership, of an object such as a vehicle or property. For example, an agent rents a property from a landlord in exchange for a periodic payment.

  Helper for building a Schema.org [RentAction](https://schema.org/RentAction) JSON-LD structure.
  ...
  @type attrs ::
          %{
            optional(:landlord) => SEO.JSONLD.Organization.t() | map() | SEO.JSONLD.Person.t(),
            optional(:real_estate_agent) => SEO.JSONLD.RealEstateAgent.t() | map(),
          ...
          | [
              landlord: SEO.JSONLD.Organization.t() | map() | SEO.JSONLD.Person.t(),
              real_estate_agent: SEO.JSONLD.RealEstateAgent.t() | map(),
  ...
  `"RentAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a RentAction JSON-LD map.

  ## Fields

  - `:landlord` - A sub property of participant. The owner of the real estate property.
  - `:real_estate_agent` - A sub property of participant. The real estate agent involved in the action.

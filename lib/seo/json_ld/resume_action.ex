...
defmodule SEO.JSONLD.ResumeAction do
  @moduledoc """
  The act of resuming a device or application which was formerly paused (e.g. resume music playback or resume a timer).

  Helper for building a Schema.org [ResumeAction](https://schema.org/ResumeAction) JSON-LD structure.
  ...
  `"ResumeAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ResumeAction JSON-LD map.

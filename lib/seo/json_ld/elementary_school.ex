...
defmodule SEO.JSONLD.ElementarySchool do
  @moduledoc """
  An elementary school.

  Helper for building a Schema.org [ElementarySchool](https://schema.org/ElementarySchool) JSON-LD structure.
  """
  ...
  `"ElementarySchool"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ElementarySchool JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ElementarySchool")
  end
end

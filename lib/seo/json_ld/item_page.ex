...
defmodule SEO.JSONLD.ItemPage do
  @moduledoc """
  A page devoted to a single item, such as a particular product or hotel.

  Helper for building a Schema.org [ItemPage](https://schema.org/ItemPage) JSON-LD structure.
  """
  ...
  `"ItemPage"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.RegisterAction do
  @moduledoc """
  The act of registering to be a user of a service, product or web page.

  Related actions:

  * `SEO.JSONLD.JoinAction`: Unlike JoinAction, RegisterAction implies you are registering to be a user of a service, *not* a group/team of people.
  * `SEO.JSONLD.FollowAction`: Unlike FollowAction, RegisterAction doesn't imply that the agent is expecting to poll for updates from the object.
  * `SEO.JSONLD.SubscribeAction`: Unlike SubscribeAction, RegisterAction doesn't imply that the agent is expecting updates from the object.

  Helper for building a Schema.org [RegisterAction](https://schema.org/RegisterAction) JSON-LD structure.
  ...
  `"RegisterAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a RegisterAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "RegisterAction")
  end
end

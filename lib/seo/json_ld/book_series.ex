...
defmodule SEO.JSONLD.BookSeries do
  @moduledoc """
  A series of books. Included books can be indicated with the hasPart property.

  Helper for building a Schema.org [BookSeries](https://schema.org/BookSeries) JSON-LD structure.
  """
  ...
  `"BookSeries"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a BookSeries JSON-LD map.

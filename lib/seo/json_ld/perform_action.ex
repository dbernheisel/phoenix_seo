...
defmodule SEO.JSONLD.PerformAction do
  @moduledoc """
  The act of participating in performance arts.

  Helper for building a Schema.org [PerformAction](https://schema.org/PerformAction) JSON-LD structure.
  ...
  @type attrs ::
          %{
            optional(:entertainment_business) => SEO.JSONLD.EntertainmentBusiness.t() | map(),
          ...
          | [
              entertainment_business: SEO.JSONLD.EntertainmentBusiness.t() | map(),
  ...
  `"PerformAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PerformAction JSON-LD map.

  ## Fields

  - `:entertainment_business` - A sub property of location. The entertainment business where the action occurred.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PerformAction")
  end
end

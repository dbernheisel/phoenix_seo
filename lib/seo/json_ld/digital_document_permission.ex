...
defmodule SEO.JSONLD.DigitalDocumentPermission do
  @moduledoc """
  A permission for a particular person or group to access a particular file.

  Helper for building a Schema.org [DigitalDocumentPermission](https://schema.org/DigitalDocumentPermission) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            optional(:permission_type) =>
              :comment_permission | :read_permission | :write_permission,
          ...
          | [
              grantee:
                ...
                | SEO.JSONLD.ContactPoint.t()
                | SEO.JSONLD.Audience.t(),
              permission_type: :comment_permission | :read_permission | :write_permission,
  ...
  `"DigitalDocumentPermission"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DigitalDocumentPermission JSON-LD map.

  ## Fields

  - `:grantee` - The person, organization, contact point, or audience that has been granted this permission.
  - `:permission_type` - The type of permission granted the person, organization, or audience. One of: `:comment_permission`, `:read_permission`, `:write_permission`.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "DigitalDocumentPermission")
  end
end

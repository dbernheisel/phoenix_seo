...
defmodule SEO.JSONLD.EventVenue do
  @moduledoc """
  An event venue.

  Helper for building a Schema.org [EventVenue](https://schema.org/EventVenue) JSON-LD structure.
  """
  ...
  `"EventVenue"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a EventVenue JSON-LD map.

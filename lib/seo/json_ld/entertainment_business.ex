...
defmodule SEO.JSONLD.EntertainmentBusiness do
  @moduledoc """
  A business providing entertainment.

  Helper for building a Schema.org [EntertainmentBusiness](https://schema.org/EntertainmentBusiness) JSON-LD structure.
  """
  ...
  `"EntertainmentBusiness"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a EntertainmentBusiness JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "EntertainmentBusiness")
  end
end

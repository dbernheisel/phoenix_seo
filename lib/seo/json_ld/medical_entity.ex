...
defmodule SEO.JSONLD.MedicalEntity do
  @moduledoc """
  The most generic type of entity related to health and the practice of medicine.

  Helper for building a Schema.org [MedicalEntity](https://schema.org/MedicalEntity) JSON-LD structure.
  """
  ...
  `"MedicalEntity"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalEntity JSON-LD map.
  ...
  - `:medicine_system` - The system of medicine that includes this MedicalEntity, for example 'evidence-based', 'homeopathic', 'chiropractic', etc. One of: `:ayurvedic`, `:chiropractic`, `:homeopathic`, `:osteopathic`, `:traditional_chinese`, `:western_conventional`.
  - `:recognizing_authority` - If applicable, the organization that officially recognizes this entity as part of its endorsed system of medicine.
  - `:relevant_specialty` - If applicable, a medical specialty in which this entity is relevant. One of: `:anesthesia`, `:cardiovascular`, `:community_health`, `:dentistry`, `:dermatologic`, `:dermatology`, `:diet_nutrition`, `:emergency`, `:endocrine`, `:gastroenterologic`, `:genetic`, `:geriatric`, `:gynecologic`, `:hematologic`, `:infectious`, `:laboratory_science`, `:midwifery`, `:musculoskeletal`, `:neurologic`, `:nursing`, `:obstetric`, `:oncologic`, `:optometric`, `:otolaryngologic`, `:pathology`, `:pediatric`, `:pharmacy_specialty`, `:physiotherapy`, `:plastic_surgery`, `:podiatric`, `:primary_care`, `:psychiatric`, `:public_health`, `:pulmonary`, `:radiography`, `:renal`, `:respiratory_therapy`, `:rheumatologic`, `:speech_pathology`, `:surgical`, `:toxicologic`, `:urologic`.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalEntity")
  end
end

...
defmodule SEO.JSONLD.APIReference do
  @moduledoc """
  Reference documentation for application programming interfaces (APIs).

  Helper for building a Schema.org [APIReference](https://schema.org/APIReference) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:assembly) => String.t(),
            optional(:assembly_version) => String.t(),
            optional(:executable_library_name) => String.t(),
            optional(:programming_model) => String.t(),
            optional(:target_platform) => String.t(),
            optional(:dependencies) => String.t(),
            optional(:proficiency_level) => String.t(),
          ...
          | [
              assembly: String.t(),
              assembly_version: String.t(),
              executable_library_name: String.t(),
              programming_model: String.t(),
              target_platform: String.t(),
              dependencies: String.t(),
              proficiency_level: String.t(),
  ...
  `"APIReference"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a APIReference JSON-LD map.

  ## Fields

  - `:assembly` - Library file name, e.g., mscorlib.dll, system.web.dll.
  - `:assembly_version` - Associated product/technology version. E.g., .NET Framework 4.5.
  - `:executable_library_name` - Library file name, e.g., mscorlib.dll, system.web.dll.
  - `:programming_model` - Indicates whether API is managed or unmanaged.
  - `:target_platform` - Type of app development: phone, Metro style, desktop, XBox, etc.

...
defmodule SEO.JSONLD.RadioBroadcastService do
  @moduledoc """
  A delivery service through which radio content is provided via broadcast over the air or online.

  Helper for building a Schema.org [RadioBroadcastService](https://schema.org/RadioBroadcastService) JSON-LD structure.
  """
  ...
  `"RadioBroadcastService"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a RadioBroadcastService JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "RadioBroadcastService")
  end
end

...
defmodule SEO.JSONLD.MedicalContraindication do
  @moduledoc """
  ...
  Helper for building a Schema.org [MedicalContraindication](https://schema.org/MedicalContraindication) JSON-LD structure.
  """
  ...
  `"MedicalContraindication"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalContraindication JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalContraindication")
  end
end

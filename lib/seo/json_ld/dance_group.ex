...
defmodule SEO.JSONLD.DanceGroup do
  @moduledoc """
  A dance group&#x2014;for example, the Alvin Ailey Dance Theater or Riverdance.

  Helper for building a Schema.org [DanceGroup](https://schema.org/DanceGroup) JSON-LD structure.
  """
  ...
  `"DanceGroup"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DanceGroup JSON-LD map.

...
defmodule SEO.JSONLD.WebPageElement do
  @moduledoc """
  A web page element, like a table or an image.

  Helper for building a Schema.org [WebPageElement](https://schema.org/WebPageElement) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:css_selector) => String.t(),
  ...
  `"WebPageElement"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a WebPageElement JSON-LD map.

  ## Fields

  - `:css_selector` - A CSS selector, e.g. of a `SEO.JSONLD.SpeakableSpecification` or `SEO.JSONLD.WebPageElement`. In the latter case, multiple matches within a page can constitute a single conceptual "Web page element".
  - `:xpath` - An XPath, e.g. of a `SEO.JSONLD.SpeakableSpecification` or `SEO.JSONLD.WebPageElement`. In the latter case, multiple matches within a page can constitute a single conceptual "Web page element".
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "WebPageElement")
  end
end

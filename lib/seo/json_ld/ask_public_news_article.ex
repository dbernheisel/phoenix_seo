...
defmodule SEO.JSONLD.AskPublicNewsArticle do
  @moduledoc """
  A `SEO.JSONLD.NewsArticle` expressing an open call by a `SEO.JSONLD.NewsMediaOrganization` asking the public for input, insights, clarifications, anecdotes, documentation, etc., on an issue, for reporting purposes.

  Helper for building a Schema.org [AskPublicNewsArticle](https://schema.org/AskPublicNewsArticle) JSON-LD structure.
  """
  ...
  `"AskPublicNewsArticle"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AskPublicNewsArticle JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "AskPublicNewsArticle")
  end
end

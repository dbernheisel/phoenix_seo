...
defmodule SEO.JSONLD.PublicationIssue do
  @moduledoc """
  A part of a successively published publication such as a periodical or publication volume, often numbered, usually containing a grouping of works such as articles.

  See also [blog post](https://blog-schema.org/2014/09/02/schema-org-support-for-bibliographic-relationships-and-periodicals/).

  Helper for building a Schema.org [PublicationIssue](https://schema.org/PublicationIssue) JSON-LD structure.
  """
  ...
  `"PublicationIssue"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PublicationIssue JSON-LD map.

  ## Fields

  - `:issue_number` - Identifies the issue of publication; for example, "iii" or "2".
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PublicationIssue")
  end
end

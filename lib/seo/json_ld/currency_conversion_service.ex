...
defmodule SEO.JSONLD.CurrencyConversionService do
  @moduledoc """
  A service to convert funds from one currency to another currency.

  Helper for building a Schema.org [CurrencyConversionService](https://schema.org/CurrencyConversionService) JSON-LD structure.
  """
  ...
  `"CurrencyConversionService"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CurrencyConversionService JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "CurrencyConversionService")
  end
end

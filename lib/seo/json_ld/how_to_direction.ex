...
defmodule SEO.JSONLD.HowToDirection do
  @moduledoc """
  A direction indicating a single action to do in the instructions for how to achieve a result.

  Helper for building a Schema.org [HowToDirection](https://schema.org/HowToDirection) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:after_media) => SEO.JSONLD.MediaObject.t() | map() | URI.t() | String.t(),
            optional(:before_media) => SEO.JSONLD.MediaObject.t() | map() | URI.t() | String.t(),
            optional(:during_media) => URI.t() | String.t() | SEO.JSONLD.MediaObject.t() | map(),
          ...
          | [
              after_media: SEO.JSONLD.MediaObject.t() | map() | URI.t() | String.t(),
              before_media: SEO.JSONLD.MediaObject.t() | map() | URI.t() | String.t(),
              during_media: URI.t() | String.t() | SEO.JSONLD.MediaObject.t() | map(),
  ...
  `"HowToDirection"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a HowToDirection JSON-LD map.

  ## Fields

  - `:after_media` - A media object representing the circumstances after performing this direction.
  - `:before_media` - A media object representing the circumstances before performing this direction.
  - `:during_media` - A media object representing the circumstances while performing this direction.
  - `:perform_time` - The length of time it takes to perform instructions or a direction (not including time to prepare the supplies), in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).
  - `:prep_time` - The length of time it takes to prepare the items to be used in instructions or a direction, in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).
  ...
  - `:total_time` - The total time required to perform instructions or a direction (including time to prepare the supplies), in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "HowToDirection")
  end
end

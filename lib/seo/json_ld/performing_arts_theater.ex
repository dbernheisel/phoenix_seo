...
defmodule SEO.JSONLD.PerformingArtsTheater do
  @moduledoc """
  A theater or other performing art center.

  Helper for building a Schema.org [PerformingArtsTheater](https://schema.org/PerformingArtsTheater) JSON-LD structure.
  """
  ...
  `"PerformingArtsTheater"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PerformingArtsTheater JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PerformingArtsTheater")
  end
end

...
defmodule SEO.JSONLD.SaleEvent do
  @moduledoc """
  Event type: Sales event.

  Helper for building a Schema.org [SaleEvent](https://schema.org/SaleEvent) JSON-LD structure.
  """
  ...
  `"SaleEvent"` respectively, plus any camelCased field keys

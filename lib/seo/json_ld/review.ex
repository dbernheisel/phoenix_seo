...
defmodule SEO.JSONLD.Review do
  @moduledoc """
  A review of an item - for example, of a restaurant, movie, or store.

  ![Review rich-result example](./assets/review-snippet-example.png)
  ...
  Helper for building a Schema.org [Review](https://schema.org/Review) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            required(:review_rating) => SEO.JSONLD.Rating.t() | map(),
            ...
            required(:author) => SEO.JSONLD.Organization.t() | map() | SEO.JSONLD.Person.t(),
  ...
  `"Review"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Review JSON-LD map.

  ## Fields

  - `:associated_claim_review` - An associated `SEO.JSONLD.ClaimReview`, related by specific common content, topic or claim. The expectation is that this property would be most typically used in cases where a single activity is conducting both claim reviews and media reviews, in which case `relatedMediaReview` would commonly be used on a `SEO.JSONLD.ClaimReview`, while `associatedClaimReview` would be used on `SEO.JSONLD.MediaReview`.
  - `:associated_media_review` - An associated `SEO.JSONLD.MediaReview`, related by specific common content, topic or claim. The expectation is that this property would be most typically used in cases where a single activity is conducting both claim reviews and media reviews, in which case `relatedMediaReview` would commonly be used on a `SEO.JSONLD.ClaimReview`, while `associatedClaimReview` would be used on `SEO.JSONLD.MediaReview`.
  - `:associated_review` - An associated `SEO.JSONLD.Review`.
  - `:item_reviewed` - The item that is being reviewed/rated.
  ...
  - `:review_body` - The actual body of the review.
  - `:review_rating` - The rating given in this review. Note that reviews can themselves be rated. The ```reviewRating``` applies to rating given by the review. The `aggregateRating` property applies to the review itself, as a creative work.

...
defmodule SEO.JSONLD.BloodTest do
  @moduledoc """
  A medical test performed on a sample of a patient's blood.

  Helper for building a Schema.org [BloodTest](https://schema.org/BloodTest) JSON-LD structure.
  """
  ...
  `"BloodTest"` respectively, plus any camelCased field keys

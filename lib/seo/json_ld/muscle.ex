...
defmodule SEO.JSONLD.Muscle do
  @moduledoc """
  A muscle is an anatomical structure consisting of a contractile form of tissue that animals use to effect movement.

  Helper for building a Schema.org [Muscle](https://schema.org/Muscle) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:antagonist) => SEO.JSONLD.Muscle.t() | map(),
            optional(:blood_supply) => SEO.JSONLD.Vessel.t() | map(),
            optional(:insertion) => SEO.JSONLD.AnatomicalStructure.t() | map(),
            optional(:muscle_action) => String.t(),
            optional(:nerve) => SEO.JSONLD.Nerve.t() | map(),
          ...
          | [
              antagonist: SEO.JSONLD.Muscle.t() | map(),
              blood_supply: SEO.JSONLD.Vessel.t() | map(),
              insertion: SEO.JSONLD.AnatomicalStructure.t() | map(),
              muscle_action: String.t(),
              nerve: SEO.JSONLD.Nerve.t() | map(),
  ...
  `"Muscle"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Muscle JSON-LD map.

  ## Fields

  - `:antagonist` - The muscle whose action counteracts the specified muscle.
  - `:blood_supply` - The blood vessel that carries blood from the heart to the muscle.
  - `:insertion` - The place of attachment of a muscle, or what the muscle moves.
  - `:muscle_action` - The movement the muscle generates.

...
defmodule SEO.JSONLD.FindAction do
  @moduledoc """
  The act of finding an object.

  Related actions:

  * `SEO.JSONLD.SearchAction`: FindAction is generally lead by a SearchAction, but not necessarily.

  Helper for building a Schema.org [FindAction](https://schema.org/FindAction) JSON-LD structure.
  ...
  `"FindAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a FindAction JSON-LD map.

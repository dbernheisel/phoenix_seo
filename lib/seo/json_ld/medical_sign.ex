...
defmodule SEO.JSONLD.MedicalSign do
  @moduledoc """
  Any physical manifestation of a person's medical condition discoverable by objective diagnostic tests or physical examination.

  Helper for building a Schema.org [MedicalSign](https://schema.org/MedicalSign) JSON-LD structure.
  """
  ...
  `"MedicalSign"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalSign JSON-LD map.

  ## Fields

  - `:identifying_exam` - A physical examination that can identify this sign. One of: `:abdomen`, `:appearance`, `:cardiovascular_exam`, `:ear`, `:eye`, `:genitourinary`, `:head`, `:lung`, `:musculoskeletal_exam`, `:neck`, `:neuro`, `:nose`, `:skin`, `:throat`.
  - `:identifying_test` - A diagnostic test that can identify this sign.

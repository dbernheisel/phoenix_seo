...
defmodule SEO.JSONLD.ImagingTest do
  @moduledoc """
  Any medical imaging modality typically used for diagnostic purposes.

  Helper for building a Schema.org [ImagingTest](https://schema.org/ImagingTest) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:imaging_technique) =>
              :ct | :mri | :pet | :radiography | :ultrasound | :x_ray,
          ...
          | [
              imaging_technique: :ct | :mri | :pet | :radiography | :ultrasound | :x_ray,
  ...
  `"ImagingTest"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ImagingTest JSON-LD map.

  ## Fields

  - `:imaging_technique` - Imaging technique used. One of: `:ct`, `:mri`, `:pet`, `:radiography`, `:ultrasound`, `:x_ray`.

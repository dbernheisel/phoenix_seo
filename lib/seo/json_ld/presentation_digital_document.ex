...
defmodule SEO.JSONLD.PresentationDigitalDocument do
  @moduledoc """
  A file containing slides or used for a presentation.

  Helper for building a Schema.org [PresentationDigitalDocument](https://schema.org/PresentationDigitalDocument) JSON-LD structure.
  """
  ...
  `"PresentationDigitalDocument"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PresentationDigitalDocument JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PresentationDigitalDocument")
  end
end

...
defmodule SEO.JSONLD.TakeAction do
  @moduledoc """
  The act of gaining ownership of an object from an origin. Reciprocal of GiveAction.

  Related actions:

  * `SEO.JSONLD.GiveAction`: The reciprocal of TakeAction.
  * `SEO.JSONLD.ReceiveAction`: Unlike ReceiveAction, TakeAction implies that ownership has been transferred.

  Helper for building a Schema.org [TakeAction](https://schema.org/TakeAction) JSON-LD structure.
  ...
  `"TakeAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TakeAction JSON-LD map.

...
defmodule SEO.JSONLD.TrackAction do
  @moduledoc """
  An agent tracks an object for updates.

  Related actions:

  * `SEO.JSONLD.FollowAction`: Unlike FollowAction, TrackAction refers to the interest on the location of innanimates objects.
  * `SEO.JSONLD.SubscribeAction`: Unlike SubscribeAction, TrackAction refers to the interest on the location of innanimate objects.

  Helper for building a Schema.org [TrackAction](https://schema.org/TrackAction) JSON-LD structure.
  ...
  `"TrackAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TrackAction JSON-LD map.

...
defmodule SEO.JSONLD.ShareAction do
  @moduledoc """
  The act of distributing content to people for their amusement or edification.

  Helper for building a Schema.org [ShareAction](https://schema.org/ShareAction) JSON-LD structure.
  ...
  `"ShareAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ShareAction JSON-LD map.

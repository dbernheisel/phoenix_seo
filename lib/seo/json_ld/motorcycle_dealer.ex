...
defmodule SEO.JSONLD.MotorcycleDealer do
  @moduledoc """
  A motorcycle dealer.

  Helper for building a Schema.org [MotorcycleDealer](https://schema.org/MotorcycleDealer) JSON-LD structure.
  """
  ...
  `"MotorcycleDealer"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MotorcycleDealer JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MotorcycleDealer")
  end
end

...
defmodule SEO.JSONLD.TheaterGroup do
  @moduledoc """
  A theater group or company, for example, the Royal Shakespeare Company or Druid Theatre.

  Helper for building a Schema.org [TheaterGroup](https://schema.org/TheaterGroup) JSON-LD structure.
  """
  ...
  `"TheaterGroup"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TheaterGroup JSON-LD map.

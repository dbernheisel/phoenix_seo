...
defmodule SEO.JSONLD.AppendAction do
  @moduledoc """
  The act of inserting at the end if an ordered collection.

  Helper for building a Schema.org [AppendAction](https://schema.org/AppendAction) JSON-LD structure.
  ...
  `"AppendAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AppendAction JSON-LD map.

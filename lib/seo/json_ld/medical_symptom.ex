...
defmodule SEO.JSONLD.MedicalSymptom do
  @moduledoc """
  Any complaint sensed and expressed by the patient (therefore defined as subjective) like stomachache, lower-back pain, or fatigue.

  Helper for building a Schema.org [MedicalSymptom](https://schema.org/MedicalSymptom) JSON-LD structure.
  """
  ...
  `"MedicalSymptom"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalSymptom JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalSymptom")
  end
end

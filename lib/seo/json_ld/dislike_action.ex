...
defmodule SEO.JSONLD.DislikeAction do
  @moduledoc """
  The act of expressing a negative sentiment about the object. An agent dislikes an object (a proposition, topic or theme) with participants.

  Helper for building a Schema.org [DislikeAction](https://schema.org/DislikeAction) JSON-LD structure.
  ...
  `"DislikeAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DislikeAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "DislikeAction")
  end
end

...
defmodule SEO.JSONLD.NewsArticle do
  @moduledoc """
  A NewsArticle is an article whose content reports news, or provides background context and supporting materials for understanding the news.

  A more detailed overview of [schema.org News markup](https://schema.org/docs/news.html) is also available.

  Helper for building a Schema.org [NewsArticle](https://schema.org/NewsArticle) JSON-LD structure.
  """
  ...
  `"NewsArticle"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a NewsArticle JSON-LD map.
  ...
  - `:print_column` - The number of the column in which the NewsArticle appears in the print edition.
  - `:print_edition` - The edition of the print product in which the NewsArticle appears.
  - `:print_page` - If this NewsArticle appears in print, this field indicates the name of the page on which the article is found. Please note that this field is intended for the exact page name (e.g. A5, B18).
  - `:print_section` - If this NewsArticle appears in print, this field indicates the print section in which the article appeared.

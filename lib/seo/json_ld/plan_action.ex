...
defmodule SEO.JSONLD.PlanAction do
  @moduledoc """
  The act of planning the execution of an event/task/action/reservation/plan to a future date.

  Helper for building a Schema.org [PlanAction](https://schema.org/PlanAction) JSON-LD structure.
  ...
  `"PlanAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PlanAction JSON-LD map.

  ## Fields

  - `:scheduled_time` - The time the object is scheduled to.

...
defmodule SEO.JSONLD.WPSideBar do
  @moduledoc """
  A sidebar section of the page.

  Helper for building a Schema.org [WPSideBar](https://schema.org/WPSideBar) JSON-LD structure.
  """
  ...
  `"WPSideBar"` respectively, plus any camelCased field keys

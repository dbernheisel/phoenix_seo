...
defmodule SEO.JSONLD.ShoppingCenter do
  @moduledoc """
  A shopping center or mall.

  Helper for building a Schema.org [ShoppingCenter](https://schema.org/ShoppingCenter) JSON-LD structure.
  """
  ...
  `"ShoppingCenter"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ShoppingCenter JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ShoppingCenter")
  end
end

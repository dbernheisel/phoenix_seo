...
defmodule SEO.JSONLD.Casino do
  @moduledoc """
  A casino.

  Helper for building a Schema.org [Casino](https://schema.org/Casino) JSON-LD structure.
  """
  ...
  `"Casino"` respectively, plus any camelCased field keys

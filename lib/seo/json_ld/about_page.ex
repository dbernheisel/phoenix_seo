...
defmodule SEO.JSONLD.AboutPage do
  @moduledoc """
  Web page type: About page.

  Helper for building a Schema.org [AboutPage](https://schema.org/AboutPage) JSON-LD structure.
  """
  ...
  `"AboutPage"` respectively, plus any camelCased field keys

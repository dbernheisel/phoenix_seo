...
defmodule SEO.JSONLD.GeneralContractor do
  @moduledoc """
  A general contractor.

  Helper for building a Schema.org [GeneralContractor](https://schema.org/GeneralContractor) JSON-LD structure.
  """
  ...
  `"GeneralContractor"` respectively, plus any camelCased field keys
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "GeneralContractor")
  end
end

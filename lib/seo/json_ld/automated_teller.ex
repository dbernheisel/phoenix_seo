...
defmodule SEO.JSONLD.AutomatedTeller do
  @moduledoc """
  ATM/cash machine.

  Helper for building a Schema.org [AutomatedTeller](https://schema.org/AutomatedTeller) JSON-LD structure.
  """
  ...
  `"AutomatedTeller"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AutomatedTeller JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "AutomatedTeller")
  end
end

...
defmodule SEO.JSONLD.DepositAccount do
  @moduledoc """
  A type of Bank Account with a main purpose of depositing funds to gain interest or other benefits.

  Helper for building a Schema.org [DepositAccount](https://schema.org/DepositAccount) JSON-LD structure.
  """
  ...
  `"DepositAccount"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DepositAccount JSON-LD map.
  ...
  - `SEO.JSONLD.InvestmentOrDeposit`
  - `SEO.JSONLD.BankAccount`
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "DepositAccount")
  end
end

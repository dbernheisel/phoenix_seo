...
defmodule SEO.JSONLD.MotorcycleRepair do
  @moduledoc """
  A motorcycle repair shop.

  Helper for building a Schema.org [MotorcycleRepair](https://schema.org/MotorcycleRepair) JSON-LD structure.
  """
  ...
  `"MotorcycleRepair"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MotorcycleRepair JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MotorcycleRepair")
  end
end

...
defmodule SEO.JSONLD.Park do
  @moduledoc """
  A park.

  Helper for building a Schema.org [Park](https://schema.org/Park) JSON-LD structure.
  """
  ...
  `"Park"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.PhysicalTherapy do
  @moduledoc """
  A process of progressive physical care and rehabilitation aimed at improving a health condition.

  Helper for building a Schema.org [PhysicalTherapy](https://schema.org/PhysicalTherapy) JSON-LD structure.
  """
  ...
  `"PhysicalTherapy"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PhysicalTherapy JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PhysicalTherapy")
  end
end

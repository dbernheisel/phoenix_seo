...
defmodule SEO.JSONLD.MedicalRiskScore do
  @moduledoc """
  A simple system that adds up the number of risk factors to yield a score that is associated with prognosis, e.g. CHAD score, TIMI risk score.

  Helper for building a Schema.org [MedicalRiskScore](https://schema.org/MedicalRiskScore) JSON-LD structure.
  """
  ...
  `"MedicalRiskScore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalRiskScore JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalRiskScore")
  end
end

...
defmodule SEO.JSONLD.SelfStorage do
  @moduledoc """
  A self-storage facility.

  Helper for building a Schema.org [SelfStorage](https://schema.org/SelfStorage) JSON-LD structure.
  """
  ...
  `"SelfStorage"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SelfStorage JSON-LD map.

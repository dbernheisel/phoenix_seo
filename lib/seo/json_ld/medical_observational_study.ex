...
defmodule SEO.JSONLD.MedicalObservationalStudy do
  @moduledoc """
  An observational study is a type of medical study that attempts to infer the possible effect of a treatment through observation of a cohort of subjects over a period of time. In an observational study, the assignment of subjects into treatment groups versus control groups is outside the control of the investigator. This is in contrast with controlled studies, such as the randomized controlled trials represented by MedicalTrial, where each subject is randomly assigned to a treatment group or a control group before the start of the treatment.

  Helper for building a Schema.org [MedicalObservationalStudy](https://schema.org/MedicalObservationalStudy) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:study_design) =>
              :case_series
              | :cohort_study
              | :cross_sectional
              | :longitudinal
  ...
  `"MedicalObservationalStudy"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalObservationalStudy JSON-LD map.

  ## Fields

  - `:study_design` - Specifics about the observational study design (enumerated). One of: `:case_series`, `:cohort_study`, `:cross_sectional`, `:longitudinal`, `:observational`, `:registry`.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalObservationalStudy")
  end
end

...
defmodule SEO.JSONLD.UserPlusOnes do
  @moduledoc """
  ...
  Helper for building a Schema.org [UserPlusOnes](https://schema.org/UserPlusOnes) JSON-LD structure.
  """
  ...
  `"UserPlusOnes"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a UserPlusOnes JSON-LD map.

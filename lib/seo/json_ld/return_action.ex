...
defmodule SEO.JSONLD.ReturnAction do
  @moduledoc """
  The act of returning to the origin that which was previously received (concrete objects) or taken (ownership).

  Helper for building a Schema.org [ReturnAction](https://schema.org/ReturnAction) JSON-LD structure.
  ...
  `"ReturnAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ReturnAction JSON-LD map.

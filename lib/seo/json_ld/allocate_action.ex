...
defmodule SEO.JSONLD.AllocateAction do
  @moduledoc """
  The act of organizing tasks/objects/events by associating resources to it.

  Helper for building a Schema.org [AllocateAction](https://schema.org/AllocateAction) JSON-LD structure.
  ...
  `"AllocateAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AllocateAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "AllocateAction")
  end
end

...
defmodule SEO.JSONLD.AnatomicalStructure do
  @moduledoc """
  Any part of the human body, typically a component of an anatomical system. Organs, tissues, and cells are all anatomical structures.

  Helper for building a Schema.org [AnatomicalStructure](https://schema.org/AnatomicalStructure) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:associated_pathophysiology) => String.t(),
            optional(:body_location) => String.t(),
            optional(:connected_to) => SEO.JSONLD.AnatomicalStructure.t() | map(),
            optional(:diagram) => SEO.JSONLD.ImageObject.t() | map(),
            optional(:part_of_system) => SEO.JSONLD.AnatomicalSystem.t() | map(),
            optional(:related_condition) => SEO.JSONLD.MedicalCondition.t() | map(),
            optional(:related_therapy) => SEO.JSONLD.MedicalTherapy.t() | map(),
            optional(:sub_structure) => SEO.JSONLD.AnatomicalStructure.t() | map(),
          ...
          | [
              associated_pathophysiology: String.t(),
              body_location: String.t(),
              connected_to: SEO.JSONLD.AnatomicalStructure.t() | map(),
              diagram: SEO.JSONLD.ImageObject.t() | map(),
              part_of_system: SEO.JSONLD.AnatomicalSystem.t() | map(),
              related_condition: SEO.JSONLD.MedicalCondition.t() | map(),
              related_therapy: SEO.JSONLD.MedicalTherapy.t() | map(),
              sub_structure: SEO.JSONLD.AnatomicalStructure.t() | map(),
  ...
  `"AnatomicalStructure"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AnatomicalStructure JSON-LD map.

  ## Fields

  - `:associated_pathophysiology` - If applicable, a description of the pathophysiology associated with the anatomical system, including potential abnormal changes in the mechanical, physical, and biochemical functions of the system.
  - `:body_location` - Location in the body of the anatomical structure.
  - `:connected_to` - Other anatomical structures to which this structure is connected.
  ...
  - `:part_of_system` - The anatomical or organ system that this structure is part of.
  - `:related_condition` - A medical condition associated with this anatomy.
  - `:related_therapy` - A medical therapy related to this anatomy.
  - `:sub_structure` - Component (sub-)structure(s) that comprise this anatomical structure.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "AnatomicalStructure")
  end
end

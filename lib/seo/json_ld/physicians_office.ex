...
defmodule SEO.JSONLD.PhysiciansOffice do
  @moduledoc """
  A doctor's office or clinic.

  Helper for building a Schema.org [PhysiciansOffice](https://schema.org/PhysiciansOffice) JSON-LD structure.
  """
  ...
  `"PhysiciansOffice"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PhysiciansOffice JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PhysiciansOffice")
  end
end

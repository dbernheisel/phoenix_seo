...
defmodule SEO.JSONLD.ViewAction do
  @moduledoc """
  The act of consuming static visual content.

  Helper for building a Schema.org [ViewAction](https://schema.org/ViewAction) JSON-LD structure.
  ...
  `"ViewAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ViewAction JSON-LD map.

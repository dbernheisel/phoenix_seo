...
defmodule SEO.JSONLD.MediaReviewItem do
  @moduledoc """
  Represents an item or group of closely related items treated as a unit for the sake of evaluation in a `SEO.JSONLD.MediaReview`. Authorship etc. apply to the items rather than to the curation/grouping or reviewing party.

  Helper for building a Schema.org [MediaReviewItem](https://schema.org/MediaReviewItem) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:media_item_appearance) => SEO.JSONLD.MediaObject.t() | map(),
          ...
          | [
              media_item_appearance: SEO.JSONLD.MediaObject.t() | map(),
  ...
  `"MediaReviewItem"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MediaReviewItem JSON-LD map.

  ## Fields

  - `:media_item_appearance` - In the context of a `SEO.JSONLD.MediaReview`, indicates specific media item(s) that are grouped using a `SEO.JSONLD.MediaReviewItem`.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MediaReviewItem")
  end
end

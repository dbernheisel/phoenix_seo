...
defmodule SEO.JSONLD.MoveAction do
  @moduledoc """
  The act of an agent relocating to a place.

  Related actions:

  * `SEO.JSONLD.TransferAction`: Unlike TransferAction, the subject of the move is a living Person or Organization rather than an inanimate object.

  Helper for building a Schema.org [MoveAction](https://schema.org/MoveAction) JSON-LD structure.
  ...
  `"MoveAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MoveAction JSON-LD map.

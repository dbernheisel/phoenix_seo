...
defmodule SEO.JSONLD.BrokerageAccount do
  @moduledoc """
  An account that allows an investor to deposit funds and place investment orders with a licensed broker or brokerage firm.

  Helper for building a Schema.org [BrokerageAccount](https://schema.org/BrokerageAccount) JSON-LD structure.
  """
  ...
  `"BrokerageAccount"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a BrokerageAccount JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "BrokerageAccount")
  end
end

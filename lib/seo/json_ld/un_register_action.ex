...
defmodule SEO.JSONLD.UnRegisterAction do
  @moduledoc """
  The act of un-registering from a service.

  Related actions:

  * `SEO.JSONLD.RegisterAction`: antonym of UnRegisterAction.
  * `SEO.JSONLD.LeaveAction`: Unlike LeaveAction, UnRegisterAction implies that you are unregistering from a service you were previously registered, rather than leaving a team/group of people.

  Helper for building a Schema.org [UnRegisterAction](https://schema.org/UnRegisterAction) JSON-LD structure.
  ...
  `"UnRegisterAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a UnRegisterAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "UnRegisterAction")
  end
end

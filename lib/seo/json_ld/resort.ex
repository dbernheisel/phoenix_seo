...
defmodule SEO.JSONLD.Resort do
  @moduledoc """
  ...
  Helper for building a Schema.org [Resort](https://schema.org/Resort) JSON-LD structure.
  """
  ...
  `"Resort"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.BreadcrumbList do
  @moduledoc """
  ...
  ![BreadcrumbList rich-result example](./assets/breadcrumb-example.png)
  ...
  Helper for building a Schema.org [BreadcrumbList](https://schema.org/BreadcrumbList) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:aggregate_element) => SEO.JSONLD.Thing.t() | map(),
            required(:item_list_element) =>
  ...
  `"BreadcrumbList"` respectively, plus any camelCased field keys
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "BreadcrumbList")
  end
end

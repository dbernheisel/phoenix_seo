...
defmodule SEO.JSONLD.ToyStore do
  @moduledoc """
  A toy store.

  Helper for building a Schema.org [ToyStore](https://schema.org/ToyStore) JSON-LD structure.
  """
  ...
  `"ToyStore"` respectively, plus any camelCased field keys

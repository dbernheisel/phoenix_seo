...
defmodule SEO.JSONLD.OceanBodyOfWater do
  @moduledoc """
  An ocean (for example, the Pacific).

  Helper for building a Schema.org [OceanBodyOfWater](https://schema.org/OceanBodyOfWater) JSON-LD structure.
  """
  ...
  `"OceanBodyOfWater"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a OceanBodyOfWater JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "OceanBodyOfWater")
  end
end

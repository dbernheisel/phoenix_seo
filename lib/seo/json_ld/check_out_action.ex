...
defmodule SEO.JSONLD.CheckOutAction do
  @moduledoc """
  The act of an agent communicating (service provider, social media, etc) their departure of a previously reserved service (e.g. flight check-in) or place (e.g. hotel).

  Related actions:

  * `SEO.JSONLD.CheckInAction`: The antonym of CheckOutAction.
  * `SEO.JSONLD.DepartAction`: Unlike DepartAction, CheckOutAction implies that the agent is informing/confirming the end of a previously reserved service.
  * `SEO.JSONLD.CancelAction`: Unlike CancelAction, CheckOutAction implies that the agent is informing/confirming the end of a previously reserved service.

  Helper for building a Schema.org [CheckOutAction](https://schema.org/CheckOutAction) JSON-LD structure.
  ...
  `"CheckOutAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CheckOutAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "CheckOutAction")
  end
end

...
defmodule SEO.JSONLD.TreatmentIndication do
  @moduledoc """
  An indication for treating an underlying condition, symptom, etc.

  Helper for building a Schema.org [TreatmentIndication](https://schema.org/TreatmentIndication) JSON-LD structure.
  """
  ...
  `"TreatmentIndication"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TreatmentIndication JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "TreatmentIndication")
  end
end

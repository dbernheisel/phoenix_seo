...
defmodule SEO.JSONLD.Hackathon do
  @moduledoc """
  A [hackathon](https://en.wikipedia.org/wiki/Hackathon) event.

  Helper for building a Schema.org [Hackathon](https://schema.org/Hackathon) JSON-LD structure.
  """
  ...
  `"Hackathon"` respectively, plus any camelCased field keys

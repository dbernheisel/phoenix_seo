...
defmodule SEO.JSONLD.WebApplication do
  @moduledoc """
  Web applications.

  Helper for building a Schema.org [WebApplication](https://schema.org/WebApplication) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:browser_requirements) => String.t(),
  ...
  `"WebApplication"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a WebApplication JSON-LD map.

  ## Fields

  - `:browser_requirements` - Specifies browser requirements in human-readable text. For example, 'requires HTML5 support'.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "WebApplication")
  end
end

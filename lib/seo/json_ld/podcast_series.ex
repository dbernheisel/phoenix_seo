...
defmodule SEO.JSONLD.PodcastSeries do
  @moduledoc """
  A podcast is an episodic series of digital audio or video files which a user can download and listen to.

  Helper for building a Schema.org [PodcastSeries](https://schema.org/PodcastSeries) JSON-LD structure.
  """
  ...
  `"PodcastSeries"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PodcastSeries JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PodcastSeries")
  end
end

...
defmodule SEO.JSONLD.NGO do
  @moduledoc """
  Organization: Non-governmental Organization.

  Helper for building a Schema.org [NGO](https://schema.org/NGO) JSON-LD structure.
  """
  ...
  `"NGO"` respectively, plus any camelCased field keys

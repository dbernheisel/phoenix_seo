...
defmodule SEO.JSONLD.MusicPlaylist do
  @moduledoc """
  A collection of music tracks in playlist form.

  Helper for building a Schema.org [MusicPlaylist](https://schema.org/MusicPlaylist) JSON-LD structure.
  """
  ...
  `"MusicPlaylist"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MusicPlaylist JSON-LD map.

  ## Fields

  - `:num_tracks` - The number of tracks in this album or playlist.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MusicPlaylist")
  end
end

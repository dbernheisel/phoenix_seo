...
defmodule SEO.JSONLD.MedicalGuidelineContraindication do
  @moduledoc """
  A guideline contraindication that designates a process as harmful and where quality of the data supporting the contraindication is sound.

  Helper for building a Schema.org [MedicalGuidelineContraindication](https://schema.org/MedicalGuidelineContraindication) JSON-LD structure.
  """
  ...
  `"MedicalGuidelineContraindication"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalGuidelineContraindication JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalGuidelineContraindication")
  end
end

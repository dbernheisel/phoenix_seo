...
defmodule SEO.JSONLD.TouristInformationCenter do
  @moduledoc """
  A tourist information center.

  Helper for building a Schema.org [TouristInformationCenter](https://schema.org/TouristInformationCenter) JSON-LD structure.
  """
  ...
  `"TouristInformationCenter"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TouristInformationCenter JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "TouristInformationCenter")
  end
end

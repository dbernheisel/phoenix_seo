...
defmodule SEO.JSONLD.IndividualPhysician do
  @moduledoc """
  ...
  The `practicesAt` property can be used to indicate `SEO.JSONLD.MedicalOrganization` hospitals, clinics, pharmacies etc. where this physician practices.

  Helper for building a Schema.org [IndividualPhysician](https://schema.org/IndividualPhysician) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:practices_at) => SEO.JSONLD.MedicalOrganization.t() | map(),
            optional(:available_service) =>
              SEO.JSONLD.MedicalProcedure.t()
              | map()
              | SEO.JSONLD.MedicalTest.t()
              | SEO.JSONLD.MedicalTherapy.t(),
            optional(:hospital_affiliation) => SEO.JSONLD.Hospital.t() | map(),
            ...
            optional(:us_npi) => String.t(),
            optional(:health_plan_network_id) => String.t(),
            optional(:is_accepting_new_patients) => boolean(),
          ...
          | [
              practices_at: SEO.JSONLD.MedicalOrganization.t() | map(),
              available_service:
                SEO.JSONLD.MedicalProcedure.t()
                | map()
                | SEO.JSONLD.MedicalTest.t()
                | SEO.JSONLD.MedicalTherapy.t(),
              hospital_affiliation: SEO.JSONLD.Hospital.t() | map(),
              medical_specialty:
                :anesthesia
                | :cardiovascular
                | :community_health
  ...
  `"IndividualPhysician"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a IndividualPhysician JSON-LD map.

  ## Fields

  - `:practices_at` - A `SEO.JSONLD.MedicalOrganization` where the `SEO.JSONLD.IndividualPhysician` practices.
  ...
  - `SEO.JSONLD.Physician`
  - `SEO.JSONLD.MedicalOrganization`
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "IndividualPhysician")
  end
end

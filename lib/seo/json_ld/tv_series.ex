...
defmodule SEO.JSONLD.TVSeries do
  @moduledoc """
  CreativeWorkSeries dedicated to TV broadcast and associated online delivery.

  Helper for building a Schema.org [TVSeries](https://schema.org/TVSeries) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            optional(:title_eidr) => String.t() | URI.t(),
  ...
  `"TVSeries"` respectively, plus any camelCased field keys
  ...
  - `:title_eidr` - An [EIDR](https://eidr.org/) (Entertainment Identifier Registry) `identifier` representing at the most general/abstract level, a work of film or television.

  For example, the motion picture known as "Ghostbusters" has a titleEIDR of "10.5240/7EC7-228A-510A-053E-CBB8-J". This title (or work) may have several variants, which EIDR calls "edits". See `editEIDR`.

  Since schema.org types like `SEO.JSONLD.Movie`, `SEO.JSONLD.TVEpisode`, `SEO.JSONLD.TVSeason`, and `SEO.JSONLD.TVSeries` can be used for both works and their multiple expressions, it is possible to use `titleEIDR` alone (for a general description), or alongside `editEIDR` for a more edit-specific description.

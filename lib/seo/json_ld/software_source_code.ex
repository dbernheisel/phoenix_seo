...
defmodule SEO.JSONLD.SoftwareSourceCode do
  @moduledoc """
  Computer programming source code. Example: Full (compile ready) solutions, code snippet samples, scripts, templates.

  Helper for building a Schema.org [SoftwareSourceCode](https://schema.org/SoftwareSourceCode) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:code_repository) => URI.t() | String.t(),
            optional(:code_sample_type) => String.t(),
            optional(:programming_language) =>
              String.t() | SEO.JSONLD.ComputerLanguage.t() | map(),
            optional(:runtime) => String.t(),
            optional(:runtime_platform) => SEO.JSONLD.RuntimePlatform.t() | map() | String.t(),
            optional(:sample_type) => String.t(),
            optional(:target_product) => SEO.JSONLD.SoftwareApplication.t() | map(),
          ...
          | [
              code_repository: URI.t() | String.t(),
              code_sample_type: String.t(),
              programming_language: String.t() | SEO.JSONLD.ComputerLanguage.t() | map(),
              runtime: String.t(),
              runtime_platform: SEO.JSONLD.RuntimePlatform.t() | map() | String.t(),
              sample_type: String.t(),
              target_product: SEO.JSONLD.SoftwareApplication.t() | map(),
  ...
  `"SoftwareSourceCode"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SoftwareSourceCode JSON-LD map.

  ## Fields

  - `:code_repository` - Link to the repository where the un-compiled, human readable code and related code is located (SVN, GitHub, CodePlex).
  - `:code_sample_type` - What type of code sample: full (compile ready) solution, code snippet, inline code, scripts, template.
  - `:programming_language` - The computer programming language.
  ...
  - `:sample_type` - What type of code sample: full (compile ready) solution, code snippet, inline code, scripts, template.
  - `:target_product` - Target Operating System / Product to which the code applies. If applies to several versions, just the product name can be used.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SoftwareSourceCode")
  end
end

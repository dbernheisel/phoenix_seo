...
defmodule SEO.JSONLD.RejectAction do
  @moduledoc """
  The act of rejecting to/adopting an object.

  Related actions:

  * `SEO.JSONLD.AcceptAction`: The antonym of RejectAction.

  Helper for building a Schema.org [RejectAction](https://schema.org/RejectAction) JSON-LD structure.
  ...
  `"RejectAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a RejectAction JSON-LD map.

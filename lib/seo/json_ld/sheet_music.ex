...
defmodule SEO.JSONLD.SheetMusic do
  @moduledoc """
  Printed music, as opposed to performed or recorded music.

  Helper for building a Schema.org [SheetMusic](https://schema.org/SheetMusic) JSON-LD structure.
  """
  ...
  `"SheetMusic"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SheetMusic JSON-LD map.

...
defmodule SEO.JSONLD.TaxiService do
  @moduledoc """
  A service for a vehicle for hire with a driver for local travel. Fares are usually calculated based on distance traveled.

  Helper for building a Schema.org [TaxiService](https://schema.org/TaxiService) JSON-LD structure.
  """
  ...
  `"TaxiService"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TaxiService JSON-LD map.

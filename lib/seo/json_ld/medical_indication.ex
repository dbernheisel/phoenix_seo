...
defmodule SEO.JSONLD.MedicalIndication do
  @moduledoc """
  A condition or factor that indicates use of a medical therapy, including signs, symptoms, risk factors, anatomical states, etc.

  Helper for building a Schema.org [MedicalIndication](https://schema.org/MedicalIndication) JSON-LD structure.
  """
  ...
  `"MedicalIndication"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalIndication JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalIndication")
  end
end

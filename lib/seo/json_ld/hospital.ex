...
defmodule SEO.JSONLD.Hospital do
  @moduledoc """
  A hospital.

  Helper for building a Schema.org [Hospital](https://schema.org/Hospital) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            optional(:healthcare_reporting_data) =>
              SEO.JSONLD.CDCPMDRecord.t() | map() | SEO.JSONLD.Dataset.t(),
  ...
  `"Hospital"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Hospital JSON-LD map.

  ## Fields

  - `:available_service` - A medical service available from this provider.
  - `:healthcare_reporting_data` - Indicates data describing a hospital, e.g. a CDC `SEO.JSONLD.CDCPMDRecord` or as some kind of `SEO.JSONLD.Dataset`.

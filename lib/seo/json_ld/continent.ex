...
defmodule SEO.JSONLD.Continent do
  @moduledoc """
  One of the continents (for example, Europe or Africa).

  Helper for building a Schema.org [Continent](https://schema.org/Continent) JSON-LD structure.
  """
  ...
  `"Continent"` respectively, plus any camelCased field keys

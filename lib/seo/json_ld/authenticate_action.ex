...
defmodule SEO.JSONLD.AuthenticateAction do
  @moduledoc """
  The action of authenticating into a device or application.

  Helper for building a Schema.org [AuthenticateAction](https://schema.org/AuthenticateAction) JSON-LD structure.
  ...
  `"AuthenticateAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AuthenticateAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "AuthenticateAction")
  end
end

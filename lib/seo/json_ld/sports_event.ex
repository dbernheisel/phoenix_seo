...
defmodule SEO.JSONLD.SportsEvent do
  @moduledoc """
  Event type: Sports event.

  Helper for building a Schema.org [SportsEvent](https://schema.org/SportsEvent) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:away_team) => SEO.JSONLD.SportsTeam.t() | map() | SEO.JSONLD.Person.t(),
            optional(:competitor) => SEO.JSONLD.SportsTeam.t() | map() | SEO.JSONLD.Person.t(),
            optional(:home_team) => SEO.JSONLD.SportsTeam.t() | map() | SEO.JSONLD.Person.t(),
            optional(:referee) => SEO.JSONLD.Person.t() | map(),
          ...
          | [
              away_team: SEO.JSONLD.SportsTeam.t() | map() | SEO.JSONLD.Person.t(),
              competitor: SEO.JSONLD.SportsTeam.t() | map() | SEO.JSONLD.Person.t(),
              home_team: SEO.JSONLD.SportsTeam.t() | map() | SEO.JSONLD.Person.t(),
              referee: SEO.JSONLD.Person.t() | map(),
  ...
  `"SportsEvent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SportsEvent JSON-LD map.

  ## Fields

  - `:away_team` - The away team in a sports event.
  - `:competitor` - A competitor in a sports event.
  - `:home_team` - The home team in a sports event.

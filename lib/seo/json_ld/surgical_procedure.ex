...
defmodule SEO.JSONLD.SurgicalProcedure do
  @moduledoc """
  A medical procedure involving an incision with instruments; performed for diagnose, or therapeutic purposes.

  Helper for building a Schema.org [SurgicalProcedure](https://schema.org/SurgicalProcedure) JSON-LD structure.
  """
  ...
  `"SurgicalProcedure"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SurgicalProcedure JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SurgicalProcedure")
  end
end

...
defmodule SEO.JSONLD.PrependAction do
  @moduledoc """
  The act of inserting at the beginning if an ordered collection.

  Helper for building a Schema.org [PrependAction](https://schema.org/PrependAction) JSON-LD structure.
  ...
  `"PrependAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PrependAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PrependAction")
  end
end

...
defmodule SEO.JSONLD.RadiationTherapy do
  @moduledoc """
  A process of care using radiation aimed at improving a health condition.

  Helper for building a Schema.org [RadiationTherapy](https://schema.org/RadiationTherapy) JSON-LD structure.
  """
  ...
  `"RadiationTherapy"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a RadiationTherapy JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "RadiationTherapy")
  end
end

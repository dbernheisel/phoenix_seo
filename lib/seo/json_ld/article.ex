...
defmodule SEO.JSONLD.Article do
  ...
  ![Article rich-result example](./assets/article-example.png)
  ...
  @type attrs ::
          %{
            ...
            required(:date_published) => Date.t() | String.t() | DateTime.t() | NaiveDateTime.t(),
  ...
  `"Article"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Article JSON-LD map.

  ## Fields

  - `:article_body` - The actual body of the article.
  - `:article_section` - Articles may belong to one or more 'sections' in a magazine or newspaper, such as Sports, Lifestyle, etc.
  - `:backstory` - For an `SEO.JSONLD.Article`, typically a `SEO.JSONLD.NewsArticle`, the backstory property provides a textual summary giving a brief explanation of why and how an article was created. In a journalistic setting this could include information about reporting process, methods, interviews, data sources, etc.
  - `:page_end` - The page on which the work ends; for example "138" or "xvi".
  - `:page_start` - The page on which the work starts; for example "135" or "xiii".

...
defmodule SEO.JSONLD.Preschool do
  @moduledoc """
  A preschool.

  Helper for building a Schema.org [Preschool](https://schema.org/Preschool) JSON-LD structure.
  """
  ...
  `"Preschool"` respectively, plus any camelCased field keys

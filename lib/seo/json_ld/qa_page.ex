...
defmodule SEO.JSONLD.QAPage do
  @moduledoc """
  A QAPage is a WebPage focussed on a specific Question and its Answer(s), e.g. in a question answering site or documenting Frequently Asked Questions (FAQs).

  ![QAPage rich-result example](./assets/qa-example.png)

  Helper for building a Schema.org [QAPage](https://schema.org/QAPage) JSON-LD structure.
  """
  ...
  `"QAPage"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.FastFoodRestaurant do
  @moduledoc """
  A fast-food restaurant.

  Helper for building a Schema.org [FastFoodRestaurant](https://schema.org/FastFoodRestaurant) JSON-LD structure.
  """
  ...
  `"FastFoodRestaurant"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a FastFoodRestaurant JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "FastFoodRestaurant")
  end
end

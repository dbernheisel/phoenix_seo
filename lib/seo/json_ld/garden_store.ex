...
defmodule SEO.JSONLD.GardenStore do
  @moduledoc """
  A garden store.

  Helper for building a Schema.org [GardenStore](https://schema.org/GardenStore) JSON-LD structure.
  """
  ...
  `"GardenStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a GardenStore JSON-LD map.

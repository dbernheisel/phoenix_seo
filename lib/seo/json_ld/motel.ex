...
defmodule SEO.JSONLD.Motel do
  @moduledoc """
  A motel.

  See also the dedicated document on the use of schema.org for marking up hotels and other forms of accommodations.

  Helper for building a Schema.org [Motel](https://schema.org/Motel) JSON-LD structure.
  """
  ...
  `"Motel"` respectively, plus any camelCased field keys

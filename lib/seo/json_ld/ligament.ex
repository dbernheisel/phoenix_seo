...
defmodule SEO.JSONLD.Ligament do
  @moduledoc """
  A short band of tough, flexible, fibrous connective tissue that functions to connect multiple bones, cartilages, and structurally support joints.

  Helper for building a Schema.org [Ligament](https://schema.org/Ligament) JSON-LD structure.
  """
  ...
  `"Ligament"` respectively, plus any camelCased field keys

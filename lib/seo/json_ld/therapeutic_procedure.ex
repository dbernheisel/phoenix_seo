...
defmodule SEO.JSONLD.TherapeuticProcedure do
  @moduledoc """
  A medical procedure intended primarily for therapeutic purposes, aimed at improving a health condition.

  Helper for building a Schema.org [TherapeuticProcedure](https://schema.org/TherapeuticProcedure) JSON-LD structure.
  """
  ...
  `"TherapeuticProcedure"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TherapeuticProcedure JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "TherapeuticProcedure")
  end
end

...
defmodule SEO.JSONLD.CheckInAction do
  @moduledoc """
  The act of an agent communicating (service provider, social media, etc) their arrival by registering/confirming for a previously reserved service (e.g. flight check-in) or at a place (e.g. hotel), possibly resulting in a result (boarding pass, etc).

  Related actions:

  * `SEO.JSONLD.CheckOutAction`: The antonym of CheckInAction.
  * `SEO.JSONLD.ArriveAction`: Unlike ArriveAction, CheckInAction implies that the agent is informing/confirming the start of a previously reserved service.
  * `SEO.JSONLD.ConfirmAction`: Unlike ConfirmAction, CheckInAction implies that the agent is informing/confirming the *start* of a previously reserved service rather than its validity/existence.

  Helper for building a Schema.org [CheckInAction](https://schema.org/CheckInAction) JSON-LD structure.
  ...
  `"CheckInAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CheckInAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "CheckInAction")
  end
end

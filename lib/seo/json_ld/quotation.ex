...
defmodule SEO.JSONLD.Quotation do
  @moduledoc """
  A quotation. Often but not necessarily from some written work, attributable to a real world author and - if associated with a fictional character - to any fictional Person. Use `isBasedOn` to link to source/origin. The `recordedIn` property can be used to reference a Quotation from an `SEO.JSONLD.Event`.

  Helper for building a Schema.org [Quotation](https://schema.org/Quotation) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:spoken_by_character) =>
          ...
          | [
              spoken_by_character: SEO.JSONLD.Organization.t() | map() | SEO.JSONLD.Person.t(),
  ...
  `"Quotation"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Quotation JSON-LD map.

  ## Fields

  - `:spoken_by_character` - The (e.g. fictional) character, Person or Organization to whom the quotation is attributed within the containing CreativeWork.

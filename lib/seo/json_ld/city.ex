...
defmodule SEO.JSONLD.City do
  @moduledoc """
  A city or town.

  Helper for building a Schema.org [City](https://schema.org/City) JSON-LD structure.
  """
  ...
  `"City"` respectively, plus any camelCased field keys

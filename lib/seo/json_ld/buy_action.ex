...
defmodule SEO.JSONLD.BuyAction do
  @moduledoc """
  The act of giving money to a seller in exchange for goods or services rendered. An agent buys an object, product, or service from a seller for a price. Reciprocal of SellAction.

  Helper for building a Schema.org [BuyAction](https://schema.org/BuyAction) JSON-LD structure.
  ...
  @type attrs ::
          %{
            ...
            optional(:vendor) => SEO.JSONLD.Organization.t() | map() | SEO.JSONLD.Person.t(),
          ...
          | [
              ...
              vendor: SEO.JSONLD.Organization.t() | map() | SEO.JSONLD.Person.t(),
  ...
  `"BuyAction"` respectively, plus any camelCased field keys

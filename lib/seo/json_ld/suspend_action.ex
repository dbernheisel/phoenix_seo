...
defmodule SEO.JSONLD.SuspendAction do
  @moduledoc """
  The act of momentarily pausing a device or application (e.g. pause music playback or pause a timer).

  Helper for building a Schema.org [SuspendAction](https://schema.org/SuspendAction) JSON-LD structure.
  ...
  `"SuspendAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SuspendAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SuspendAction")
  end
end

...
defmodule SEO.JSONLD.BoatTerminal do
  @moduledoc """
  A terminal for boats, ships, and other water vessels.

  Helper for building a Schema.org [BoatTerminal](https://schema.org/BoatTerminal) JSON-LD structure.
  """
  ...
  `"BoatTerminal"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a BoatTerminal JSON-LD map.

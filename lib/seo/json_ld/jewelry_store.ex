...
defmodule SEO.JSONLD.JewelryStore do
  @moduledoc """
  A jewelry store.

  Helper for building a Schema.org [JewelryStore](https://schema.org/JewelryStore) JSON-LD structure.
  """
  ...
  `"JewelryStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a JewelryStore JSON-LD map.

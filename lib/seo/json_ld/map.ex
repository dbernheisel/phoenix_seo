...
defmodule SEO.JSONLD.Map do
  @moduledoc """
  A map.

  Helper for building a Schema.org [Map](https://schema.org/Map) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:map_type) => :parking_map | :seating_map | :transit_map | :venue_map,
          ...
          | [
              map_type: :parking_map | :seating_map | :transit_map | :venue_map,
  ...
  `"Map"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Map JSON-LD map.

  ## Fields

  - `:map_type` - Indicates the kind of Map, from the MapCategoryType Enumeration. One of: `:parking_map`, `:seating_map`, `:transit_map`, `:venue_map`.

...
defmodule SEO.JSONLD.Playground do
  @moduledoc """
  A playground.

  Helper for building a Schema.org [Playground](https://schema.org/Playground) JSON-LD structure.
  """
  ...
  `"Playground"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Playground JSON-LD map.

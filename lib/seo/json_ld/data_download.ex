...
defmodule SEO.JSONLD.DataDownload do
  @moduledoc """
  All or part of a `SEO.JSONLD.Dataset` in downloadable form.

  Helper for building a Schema.org [DataDownload](https://schema.org/DataDownload) JSON-LD structure.
  """
  ...
  `"DataDownload"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DataDownload JSON-LD map.

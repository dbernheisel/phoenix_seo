...
defmodule SEO.JSONLD.Beach do
  @moduledoc """
  Beach.

  Helper for building a Schema.org [Beach](https://schema.org/Beach) JSON-LD structure.
  """
  ...
  `"Beach"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.FinancialService do
  @moduledoc """
  Financial services business.

  Helper for building a Schema.org [FinancialService](https://schema.org/FinancialService) JSON-LD structure.
  """
  ...
  `"FinancialService"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a FinancialService JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "FinancialService")
  end
end

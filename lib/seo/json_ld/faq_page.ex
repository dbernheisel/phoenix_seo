...
defmodule SEO.JSONLD.FAQPage do
  @moduledoc """
  A `SEO.JSONLD.FAQPage` is a `SEO.JSONLD.WebPage` presenting one or more "[Frequently asked questions](https://en.wikipedia.org/wiki/FAQ)" (see also `SEO.JSONLD.QAPage`).

  ![FAQPage rich-result example](./assets/faqpage-example.png)
  ...
  @type attrs ::
          %{
            ...
            required(:main_entity) => SEO.JSONLD.Thing.t() | map(),
  ...
  `"FAQPage"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.InviteAction do
  @moduledoc """
  The act of asking someone to attend an event. Reciprocal of RsvpAction.

  Helper for building a Schema.org [InviteAction](https://schema.org/InviteAction) JSON-LD structure.
  ...
  `"InviteAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a InviteAction JSON-LD map.

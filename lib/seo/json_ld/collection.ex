...
defmodule SEO.JSONLD.Collection do
  @moduledoc """
  A collection of items, e.g. creative works or products.

  Helper for building a Schema.org [Collection](https://schema.org/Collection) JSON-LD structure.
  """
  ...
  `"Collection"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Collection JSON-LD map.

  ## Fields

  - `:collection_size` - The number of items in the `SEO.JSONLD.Collection`.

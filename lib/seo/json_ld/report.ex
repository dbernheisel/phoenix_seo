...
defmodule SEO.JSONLD.Report do
  @moduledoc """
  A Report generated by governmental or non-governmental organization.

  Helper for building a Schema.org [Report](https://schema.org/Report) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:report_number) => String.t(),
  ...
  `"Report"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Report JSON-LD map.

  ## Fields

  - `:report_number` - The number or other unique designator assigned to a Report by the publishing organization.

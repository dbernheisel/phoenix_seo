...
defmodule SEO.JSONLD.MedicalRiskFactor do
  @moduledoc """
  A risk factor is anything that increases a person's likelihood of developing or contracting a disease, medical condition, or complication.

  Helper for building a Schema.org [MedicalRiskFactor](https://schema.org/MedicalRiskFactor) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:increases_risk_of) => SEO.JSONLD.MedicalEntity.t() | map(),
          ...
          | [
              increases_risk_of: SEO.JSONLD.MedicalEntity.t() | map(),
  ...
  `"MedicalRiskFactor"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalRiskFactor JSON-LD map.

  ## Fields

  - `:increases_risk_of` - The condition, complication, etc. influenced by this factor.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalRiskFactor")
  end
end

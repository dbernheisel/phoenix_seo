...
defmodule SEO.JSONLD.PlaceOfWorship do
  @moduledoc """
  Place of worship, such as a church, synagogue, or mosque.

  Helper for building a Schema.org [PlaceOfWorship](https://schema.org/PlaceOfWorship) JSON-LD structure.
  """
  ...
  `"PlaceOfWorship"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PlaceOfWorship JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PlaceOfWorship")
  end
end

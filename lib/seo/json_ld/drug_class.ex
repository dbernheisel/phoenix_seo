...
defmodule SEO.JSONLD.DrugClass do
  @moduledoc """
  A class of medical drugs, e.g., statins. Classes can represent general pharmacological class, common mechanisms of action, common physiological effects, etc.

  Helper for building a Schema.org [DrugClass](https://schema.org/DrugClass) JSON-LD structure.
  """
  ...
  `"DrugClass"` respectively, plus any camelCased field keys

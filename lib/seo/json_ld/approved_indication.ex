...
defmodule SEO.JSONLD.ApprovedIndication do
  @moduledoc """
  An indication for a medical therapy that has been formally specified or approved by a regulatory body that regulates use of the therapy; for example, the US FDA approves indications for most drugs in the US.

  Helper for building a Schema.org [ApprovedIndication](https://schema.org/ApprovedIndication) JSON-LD structure.
  """
  ...
  `"ApprovedIndication"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ApprovedIndication JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ApprovedIndication")
  end
end

...
defmodule SEO.JSONLD.DanceEvent do
  @moduledoc """
  Event type: A social dance.

  Helper for building a Schema.org [DanceEvent](https://schema.org/DanceEvent) JSON-LD structure.
  """
  ...
  `"DanceEvent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DanceEvent JSON-LD map.

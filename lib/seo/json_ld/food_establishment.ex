...
defmodule SEO.JSONLD.FoodEstablishment do
  @moduledoc """
  A food-related business.

  Helper for building a Schema.org [FoodEstablishment](https://schema.org/FoodEstablishment) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:accepts_reservations) => URI.t() | String.t() | boolean(),
            optional(:has_menu) => SEO.JSONLD.Menu.t() | map() | String.t() | URI.t(),
            optional(:menu) => SEO.JSONLD.Menu.t() | map() | String.t() | URI.t(),
            optional(:serves_cuisine) => String.t(),
          ...
          | [
              accepts_reservations: URI.t() | String.t() | boolean(),
              has_menu: SEO.JSONLD.Menu.t() | map() | String.t() | URI.t(),
              menu: SEO.JSONLD.Menu.t() | map() | String.t() | URI.t(),
              serves_cuisine: String.t(),
  ...
  `"FoodEstablishment"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a FoodEstablishment JSON-LD map.

  ## Fields

  - `:accepts_reservations` - Indicates whether a FoodEstablishment accepts reservations. Values can be Boolean, an URL at which reservations can be made or (for backwards compatibility) the strings ```Yes``` or ```No```.
  - `:has_menu` - Either the actual menu as a structured representation, as text, or a URL of the menu.
  - `:menu` - Either the actual menu as a structured representation, as text, or a URL of the menu.
  - `:serves_cuisine` - The cuisine of the restaurant.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "FoodEstablishment")
  end
end

...
defmodule SEO.JSONLD.DonateAction do
  @moduledoc """
  The act of providing goods, services, or money without compensation, often for philanthropic reasons.

  Helper for building a Schema.org [DonateAction](https://schema.org/DonateAction) JSON-LD structure.
  ...
  `"DonateAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DonateAction JSON-LD map.

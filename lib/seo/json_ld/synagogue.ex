...
defmodule SEO.JSONLD.Synagogue do
  @moduledoc """
  A synagogue.

  Helper for building a Schema.org [Synagogue](https://schema.org/Synagogue) JSON-LD structure.
  """
  ...
  `"Synagogue"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.Code do
  @moduledoc """
  Computer programming source code. Example: Full (compile ready) solutions, code snippet samples, scripts, templates.

  Helper for building a Schema.org [Code](https://schema.org/Code) JSON-LD structure.
  """
  ...
  `"Code"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.AmusementPark do
  @moduledoc """
  An amusement park.

  Helper for building a Schema.org [AmusementPark](https://schema.org/AmusementPark) JSON-LD structure.
  """
  ...
  `"AmusementPark"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AmusementPark JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "AmusementPark")
  end
end

...
defmodule SEO.JSONLD.VisualArtsEvent do
  @moduledoc """
  Event type: Visual arts event.

  Helper for building a Schema.org [VisualArtsEvent](https://schema.org/VisualArtsEvent) JSON-LD structure.
  """
  ...
  `"VisualArtsEvent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a VisualArtsEvent JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "VisualArtsEvent")
  end
end

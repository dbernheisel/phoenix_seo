...
defmodule SEO.JSONLD.EmploymentAgency do
  @moduledoc """
  An employment agency.

  Helper for building a Schema.org [EmploymentAgency](https://schema.org/EmploymentAgency) JSON-LD structure.
  """
  ...
  `"EmploymentAgency"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a EmploymentAgency JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "EmploymentAgency")
  end
end

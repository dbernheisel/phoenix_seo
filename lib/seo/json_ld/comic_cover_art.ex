...
defmodule SEO.JSONLD.ComicCoverArt do
  @moduledoc """
  The artwork on the cover of a comic.

  Helper for building a Schema.org [ComicCoverArt](https://schema.org/ComicCoverArt) JSON-LD structure.
  """
  ...
  `"ComicCoverArt"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ComicCoverArt JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ComicCoverArt")
  end
end

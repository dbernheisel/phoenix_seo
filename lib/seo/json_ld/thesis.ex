...
defmodule SEO.JSONLD.Thesis do
  @moduledoc """
  A thesis or dissertation document submitted in support of candidature for an academic degree or professional qualification.

  Helper for building a Schema.org [Thesis](https://schema.org/Thesis) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:in_support_of) => String.t(),
  ...
  `"Thesis"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Thesis JSON-LD map.

  ## Fields

  - `:in_support_of` - Qualification, candidature, degree, application that Thesis supports.

...
defmodule SEO.JSONLD.Distillery do
  @moduledoc """
  A distillery.

  Helper for building a Schema.org [Distillery](https://schema.org/Distillery) JSON-LD structure.
  """
  ...
  `"Distillery"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Distillery JSON-LD map.

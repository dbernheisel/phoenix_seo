...
defmodule SEO.JSONLD.GolfCourse do
  @moduledoc """
  A golf course.

  Helper for building a Schema.org [GolfCourse](https://schema.org/GolfCourse) JSON-LD structure.
  """
  ...
  `"GolfCourse"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a GolfCourse JSON-LD map.

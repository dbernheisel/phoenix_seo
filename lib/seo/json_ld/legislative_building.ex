...
defmodule SEO.JSONLD.LegislativeBuilding do
  @moduledoc """
  A legislative building&#x2014;for example, the state capitol.

  Helper for building a Schema.org [LegislativeBuilding](https://schema.org/LegislativeBuilding) JSON-LD structure.
  """
  ...
  `"LegislativeBuilding"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a LegislativeBuilding JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "LegislativeBuilding")
  end
end

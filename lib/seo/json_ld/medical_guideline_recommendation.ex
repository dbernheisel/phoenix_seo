...
defmodule SEO.JSONLD.MedicalGuidelineRecommendation do
  @moduledoc """
  A guideline recommendation that is regarded as efficacious and where quality of the data supporting the recommendation is sound.

  Helper for building a Schema.org [MedicalGuidelineRecommendation](https://schema.org/MedicalGuidelineRecommendation) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:recommendation_strength) => String.t(),
          ...
          | [
              recommendation_strength: String.t(),
  ...
  `"MedicalGuidelineRecommendation"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalGuidelineRecommendation JSON-LD map.

  ## Fields

  - `:recommendation_strength` - Strength of the guideline's recommendation (e.g. 'class I').
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalGuidelineRecommendation")
  end
end

...
defmodule SEO.JSONLD.RiverBodyOfWater do
  @moduledoc """
  A river (for example, the broad majestic Shannon).

  Helper for building a Schema.org [RiverBodyOfWater](https://schema.org/RiverBodyOfWater) JSON-LD structure.
  """
  ...
  `"RiverBodyOfWater"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a RiverBodyOfWater JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "RiverBodyOfWater")
  end
end

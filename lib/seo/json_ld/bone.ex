...
defmodule SEO.JSONLD.Bone do
  @moduledoc """
  Rigid connective tissue that comprises up the skeletal structure of the human body.

  Helper for building a Schema.org [Bone](https://schema.org/Bone) JSON-LD structure.
  """
  ...
  `"Bone"` respectively, plus any camelCased field keys

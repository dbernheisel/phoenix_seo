...
defmodule SEO.JSONLD.DepartAction do
  @moduledoc """
  The act of departing from a place. An agent departs from a fromLocation for a destination, optionally with participants.

  Helper for building a Schema.org [DepartAction](https://schema.org/DepartAction) JSON-LD structure.
  ...
  `"DepartAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DepartAction JSON-LD map.

...
defmodule SEO.JSONLD.CourseInstance do
  @moduledoc """
  An instance of a `SEO.JSONLD.Course` which is distinct from other instances because it is offered at a different time or location or through different media or modes of study or to a specific section of students.

  Helper for building a Schema.org [CourseInstance](https://schema.org/CourseInstance) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:course_mode) => String.t() | URI.t(),
            optional(:course_schedule) => SEO.JSONLD.Schedule.t() | map(),
            optional(:course_workload) => String.t(),
            optional(:instructor) => SEO.JSONLD.Person.t() | map(),
          ...
          | [
              course_mode: String.t() | URI.t(),
              course_schedule: SEO.JSONLD.Schedule.t() | map(),
              course_workload: String.t(),
              instructor: SEO.JSONLD.Person.t() | map(),
  ...
  `"CourseInstance"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CourseInstance JSON-LD map.

  ## Fields

  - `:course_mode` - The medium or means of delivery of the course instance or the mode of study, either as a text label (e.g. "online", "onsite" or "blended"; "synchronous" or "asynchronous"; "full-time" or "part-time") or as a URL reference to a term from a controlled vocabulary (e.g. https://ceds.ed.gov/element/001311#Asynchronous).
  - `:course_schedule` - Represents the length and pace of a course, expressed as a `SEO.JSONLD.Schedule`.
  - `:course_workload` - The amount of work expected of students taking the course, often provided as a figure per week or per month, and may be broken down by type. For example, "2 hours of lectures, 1 hour of lab work and 3 hours of independent study per week".
  - `:instructor` - A person assigned to instruct or provide instructional assistance for the `SEO.JSONLD.CourseInstance`.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "CourseInstance")
  end
end

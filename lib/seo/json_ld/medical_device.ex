...
defmodule SEO.JSONLD.MedicalDevice do
  @moduledoc """
  Any object used in a medical capacity, such as to diagnose or treat a patient.

  Helper for building a Schema.org [MedicalDevice](https://schema.org/MedicalDevice) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            optional(:post_op) => String.t(),
            optional(:pre_op) => String.t(),
            optional(:procedure) => String.t(),
          ...
          | [
              ...
              contraindication: String.t() | SEO.JSONLD.MedicalContraindication.t() | map(),
              post_op: String.t(),
              pre_op: String.t(),
              procedure: String.t(),
  ...
  `"MedicalDevice"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalDevice JSON-LD map.

  ## Fields

  - `:adverse_outcome` - A possible complication and/or side effect of this therapy. If it is known that an adverse outcome is serious (resulting in death, disability, or permanent damage; requiring hospitalization; or otherwise life-threatening or requiring immediate medical attention), tag it as a seriousAdverseOutcome instead.
  - `:contraindication` - A contraindication for this therapy.
  - `:post_op` - A description of the postoperative procedures, care, and/or followups for this device.
  - `:pre_op` - A description of the workup, testing, and other preparations required before implanting this device.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalDevice")
  end
end

...
defmodule SEO.JSONLD.InsuranceAgency do
  @moduledoc """
  An Insurance agency.

  Helper for building a Schema.org [InsuranceAgency](https://schema.org/InsuranceAgency) JSON-LD structure.
  """
  ...
  `"InsuranceAgency"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a InsuranceAgency JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "InsuranceAgency")
  end
end

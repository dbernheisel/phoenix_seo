...
defmodule SEO.JSONLD.MusicComposition do
  @moduledoc """
  A musical composition.

  Helper for building a Schema.org [MusicComposition](https://schema.org/MusicComposition) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:composer) => SEO.JSONLD.Organization.t() | map() | SEO.JSONLD.Person.t(),
            optional(:first_performance) => SEO.JSONLD.Event.t() | map(),
            optional(:included_composition) => SEO.JSONLD.MusicComposition.t() | map(),
            optional(:iswc_code) => String.t(),
            optional(:lyricist) => SEO.JSONLD.Person.t() | map(),
            optional(:lyrics) => SEO.JSONLD.CreativeWork.t() | map(),
            optional(:music_arrangement) => SEO.JSONLD.MusicComposition.t() | map(),
            optional(:music_composition_form) => String.t(),
            optional(:musical_key) => String.t(),
            optional(:recorded_as) => SEO.JSONLD.MusicRecording.t() | map(),
          ...
          | [
              ...
              first_performance: SEO.JSONLD.Event.t() | map(),
              included_composition: SEO.JSONLD.MusicComposition.t() | map(),
              iswc_code: String.t(),
              lyricist: SEO.JSONLD.Person.t() | map(),
              lyrics: SEO.JSONLD.CreativeWork.t() | map(),
              music_arrangement: SEO.JSONLD.MusicComposition.t() | map(),
              music_composition_form: String.t(),
              musical_key: String.t(),
              recorded_as: SEO.JSONLD.MusicRecording.t() | map(),
  ...
  `"MusicComposition"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MusicComposition JSON-LD map.

  ## Fields

  - `:composer` - The person or organization who wrote a composition, or who is the composer of a work performed at some event.
  - `:first_performance` - The date and place the work was first performed.
  - `:included_composition` - Smaller compositions included in this work (e.g. a movement in a symphony).
  - `:iswc_code` - The International Standard Musical Work Code for the composition.
  - `:lyricist` - The person who wrote the words.
  - `:lyrics` - The words in the song.
  - `:music_arrangement` - An arrangement derived from the composition.
  - `:music_composition_form` - The type of composition (e.g. overture, sonata, symphony, etc.).
  - `:musical_key` - The key, mode, or scale this composition uses.
  - `:recorded_as` - An audio recording of the work.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MusicComposition")
  end
end

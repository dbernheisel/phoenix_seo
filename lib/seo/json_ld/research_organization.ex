...
defmodule SEO.JSONLD.ResearchOrganization do
  @moduledoc """
  A Research Organization (e.g. scientific institute, research company).

  Helper for building a Schema.org [ResearchOrganization](https://schema.org/ResearchOrganization) JSON-LD structure.
  """
  ...
  `"ResearchOrganization"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ResearchOrganization JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ResearchOrganization")
  end
end

...
defmodule SEO.JSONLD.NailSalon do
  @moduledoc """
  A nail salon.

  Helper for building a Schema.org [NailSalon](https://schema.org/NailSalon) JSON-LD structure.
  """
  ...
  `"NailSalon"` respectively, plus any camelCased field keys

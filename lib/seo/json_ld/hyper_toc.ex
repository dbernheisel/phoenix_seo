...
defmodule SEO.JSONLD.HyperToc do
  @moduledoc """
  A HyperToc represents a hypertext table of contents for complex media objects, such as `SEO.JSONLD.VideoObject`, `SEO.JSONLD.AudioObject`. Items in the table of contents are indicated using the `tocEntry` property, and typed `SEO.JSONLD.HyperTocEntry`. For cases where the same larger work is split into multiple files, `associatedMedia` can be used on individual `SEO.JSONLD.HyperTocEntry` items.

  Helper for building a Schema.org [HyperToc](https://schema.org/HyperToc) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:associated_media) => SEO.JSONLD.MediaObject.t() | map(),
            optional(:toc_entry) => SEO.JSONLD.HyperTocEntry.t() | map(),
          ...
          | [
              ...
              toc_entry: SEO.JSONLD.HyperTocEntry.t() | map(),
  ...
  `"HyperToc"` respectively, plus any camelCased field keys

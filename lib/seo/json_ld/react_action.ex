...
defmodule SEO.JSONLD.ReactAction do
  @moduledoc """
  The act of responding instinctively and emotionally to an object, expressing a sentiment.

  Helper for building a Schema.org [ReactAction](https://schema.org/ReactAction) JSON-LD structure.
  ...
  `"ReactAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ReactAction JSON-LD map.

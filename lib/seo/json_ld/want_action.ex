...
defmodule SEO.JSONLD.WantAction do
  @moduledoc """
  The act of expressing a desire about the object. An agent wants an object.

  Helper for building a Schema.org [WantAction](https://schema.org/WantAction) JSON-LD structure.
  ...
  `"WantAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a WantAction JSON-LD map.

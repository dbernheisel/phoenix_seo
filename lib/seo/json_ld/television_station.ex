...
defmodule SEO.JSONLD.TelevisionStation do
  @moduledoc """
  A television station.

  Helper for building a Schema.org [TelevisionStation](https://schema.org/TelevisionStation) JSON-LD structure.
  """
  ...
  `"TelevisionStation"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TelevisionStation JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "TelevisionStation")
  end
end

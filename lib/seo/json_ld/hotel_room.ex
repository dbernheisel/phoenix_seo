...
defmodule SEO.JSONLD.HotelRoom do
  @moduledoc """
  A hotel room is a single room in a hotel.

  See also the dedicated document on the use of schema.org for marking up hotels and other forms of accommodations.

  Helper for building a Schema.org [HotelRoom](https://schema.org/HotelRoom) JSON-LD structure.
  """
  ...
  `"HotelRoom"` respectively, plus any camelCased field keys

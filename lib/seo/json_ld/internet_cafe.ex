...
defmodule SEO.JSONLD.InternetCafe do
  @moduledoc """
  An internet cafe.

  Helper for building a Schema.org [InternetCafe](https://schema.org/InternetCafe) JSON-LD structure.
  """
  ...
  `"InternetCafe"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a InternetCafe JSON-LD map.

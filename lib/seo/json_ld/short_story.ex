...
defmodule SEO.JSONLD.ShortStory do
  @moduledoc """
  Short story or tale. A brief work of literature, usually written in narrative prose.

  Helper for building a Schema.org [ShortStory](https://schema.org/ShortStory) JSON-LD structure.
  """
  ...
  `"ShortStory"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ShortStory JSON-LD map.

...
defmodule SEO.JSONLD.Nerve do
  @moduledoc """
  A common pathway for the electrochemical nerve impulses that are transmitted along each of the axons.

  Helper for building a Schema.org [Nerve](https://schema.org/Nerve) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:branch) => SEO.JSONLD.AnatomicalStructure.t() | map(),
            optional(:nerve_motor) => SEO.JSONLD.Muscle.t() | map(),
            optional(:sensory_unit) =>
              SEO.JSONLD.SuperficialAnatomy.t() | map() | SEO.JSONLD.AnatomicalStructure.t(),
            optional(:sourced_from) => SEO.JSONLD.BrainStructure.t() | map(),
          ...
          | [
              branch: SEO.JSONLD.AnatomicalStructure.t() | map(),
              nerve_motor: SEO.JSONLD.Muscle.t() | map(),
              sensory_unit:
                SEO.JSONLD.SuperficialAnatomy.t() | map() | SEO.JSONLD.AnatomicalStructure.t(),
              sourced_from: SEO.JSONLD.BrainStructure.t() | map(),
  ...
  `"Nerve"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Nerve JSON-LD map.

  ## Fields

  - `:branch` - The branches that delineate from the nerve bundle. Not to be confused with `branchOf`.
  - `:nerve_motor` - The neurological pathway extension that involves muscle control.
  - `:sensory_unit` - The neurological pathway extension that inputs and sends information to the brain or spinal cord.
  - `:sourced_from` - The neurological pathway that originates the neurons.
  ...
  - `SEO.JSONLD.AnatomicalStructure`

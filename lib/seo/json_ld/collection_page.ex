...
defmodule SEO.JSONLD.CollectionPage do
  @moduledoc """
  Web page type: Collection page.

  Helper for building a Schema.org [CollectionPage](https://schema.org/CollectionPage) JSON-LD structure.
  """
  ...
  `"CollectionPage"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CollectionPage JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "CollectionPage")
  end
end

...
defmodule SEO.JSONLD.MediaReview do
  @moduledoc """
  A `SEO.JSONLD.MediaReview` is a more specialized form of Review dedicated to the evaluation of media content online, typically in the context of fact-checking and misinformation.
  For more general reviews of media in the broader sense, use `SEO.JSONLD.UserReview`, `SEO.JSONLD.CriticReview` or other `SEO.JSONLD.Review` types. This definition is
  a work in progress. While the `MediaManipulationRatingEnumeration` list reflects significant community review amongst fact-checkers and others working
  to combat misinformation, the specific structures for representing media objects, their versions and publication context, are still evolving. Similarly, best practices for the relationship between `SEO.JSONLD.MediaReview` and `SEO.JSONLD.ClaimReview` markup have not yet been finalized.

  Helper for building a Schema.org [MediaReview](https://schema.org/MediaReview) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:media_authenticity_category) =>
              ...
              | :staged_content
              | :transformed_content,
            optional(:original_media_context_description) => String.t(),
            optional(:original_media_link) =>
              SEO.JSONLD.MediaObject.t() | map() | URI.t() | String.t() | SEO.JSONLD.WebPage.t(),
            optional(:associated_claim_review) => SEO.JSONLD.Review.t() | map(),
            optional(:associated_media_review) => SEO.JSONLD.Review.t() | map(),
            optional(:associated_review) => SEO.JSONLD.Review.t() | map(),
            optional(:item_reviewed) => SEO.JSONLD.Thing.t() | map(),
            ...
            optional(:review_body) => String.t(),
            optional(:review_rating) => SEO.JSONLD.Rating.t() | map(),
          ...
          | [
              media_authenticity_category:
                ...
                | :staged_content
                | :transformed_content,
              original_media_context_description: String.t(),
              original_media_link:
                SEO.JSONLD.MediaObject.t() | map() | URI.t() | String.t() | SEO.JSONLD.WebPage.t(),
              associated_claim_review: SEO.JSONLD.Review.t() | map(),
              associated_media_review: SEO.JSONLD.Review.t() | map(),
              associated_review: SEO.JSONLD.Review.t() | map(),
              ...
              review_body: String.t(),
              review_rating: SEO.JSONLD.Rating.t() | map(),
  ...
  `"MediaReview"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MediaReview JSON-LD map.

  ## Fields

  - `:media_authenticity_category` - Indicates a MediaManipulationRatingEnumeration classification of a media object (in the context of how it was published or shared). One of: `:decontextualized_content`, `:edited_or_cropped_content`, `:original_media_content`, `:satire_or_parody_content`, `:staged_content`, `:transformed_content`.
  - `:original_media_context_description` - Describes, in a `SEO.JSONLD.MediaReview` when dealing with `DecontextualizedContent`, background information that can contribute to better interpretation of the `SEO.JSONLD.MediaObject`.
  - `:original_media_link` - Link to the page containing an original version of the content, or directly to an online copy of the original `SEO.JSONLD.MediaObject` content, e.g. video file.

...
defmodule SEO.JSONLD.MedicalClinic do
  @moduledoc """
  A facility, often associated with a hospital or medical school, that is devoted to the specific diagnosis and/or healthcare. Previously limited to outpatients but with evolution it may be open to inpatients as well.

  Helper for building a Schema.org [MedicalClinic](https://schema.org/MedicalClinic) JSON-LD structure.
  """
  ...
  `"MedicalClinic"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalClinic JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalClinic")
  end
end

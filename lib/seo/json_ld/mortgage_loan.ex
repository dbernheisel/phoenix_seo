...
defmodule SEO.JSONLD.MortgageLoan do
  @moduledoc """
  A loan in which property or real estate is used as collateral. (A loan securitized against some real estate.)

  Helper for building a Schema.org [MortgageLoan](https://schema.org/MortgageLoan) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:domiciled_mortgage) => boolean(),
            optional(:loan_mortgage_mandate_amount) => SEO.JSONLD.MonetaryAmount.t() | map(),
          ...
          | [
              ...
              loan_mortgage_mandate_amount: SEO.JSONLD.MonetaryAmount.t() | map(),
  ...
  `"MortgageLoan"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MortgageLoan JSON-LD map.

  ## Fields

  - `:domiciled_mortgage` - Whether borrower is a resident of the jurisdiction where the property is located.
  - `:loan_mortgage_mandate_amount` - Amount of mortgage mandate that can be converted into a proper mortgage at a later stage.

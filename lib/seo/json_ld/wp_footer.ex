...
defmodule SEO.JSONLD.WPFooter do
  @moduledoc """
  The footer section of the page.

  Helper for building a Schema.org [WPFooter](https://schema.org/WPFooter) JSON-LD structure.
  """
  ...
  `"WPFooter"` respectively, plus any camelCased field keys

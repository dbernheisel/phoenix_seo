...
defmodule SEO.JSONLD.HowToStep do
  @moduledoc """
  A step in the instructions for how to achieve a result. It is an ordered list with HowToDirection and/or HowToTip items.

  Helper for building a Schema.org [HowToStep](https://schema.org/HowToStep) JSON-LD structure.
  """
  ...
  `"HowToStep"` respectively, plus any camelCased field keys

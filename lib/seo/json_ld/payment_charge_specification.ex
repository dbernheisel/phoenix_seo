...
defmodule SEO.JSONLD.PaymentChargeSpecification do
  @moduledoc """
  The costs of settling the payment using a particular payment method.

  Helper for building a Schema.org [PaymentChargeSpecification](https://schema.org/PaymentChargeSpecification) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            optional(:applies_to_payment_method) => SEO.JSONLD.PaymentMethod.t() | map(),
          ...
          | [
              ...
              applies_to_payment_method: SEO.JSONLD.PaymentMethod.t() | map(),
  ...
  `"PaymentChargeSpecification"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PaymentChargeSpecification JSON-LD map.
  ...
  - `:applies_to_payment_method` - The payment method(s) to which the payment charge specification applies.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PaymentChargeSpecification")
  end
end

...
defmodule SEO.JSONLD.UserPlays do
  @moduledoc """
  ...
  Helper for building a Schema.org [UserPlays](https://schema.org/UserPlays) JSON-LD structure.
  """
  ...
  `"UserPlays"` respectively, plus any camelCased field keys

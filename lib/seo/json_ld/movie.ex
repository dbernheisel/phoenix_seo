...
defmodule SEO.JSONLD.Movie do
  @moduledoc """
  A movie.

  ![Movie rich-result example](./assets/movie-carousel-example.png)

  Helper for building a Schema.org [Movie](https://schema.org/Movie) JSON-LD structure.
  """
  ...
  `"Movie"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.BlogPosting do
  @moduledoc """
  A blog post.

  Helper for building a Schema.org [BlogPosting](https://schema.org/BlogPosting) JSON-LD structure.
  """
  ...
  `"BlogPosting"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a BlogPosting JSON-LD map.

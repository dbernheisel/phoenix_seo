...
defmodule SEO.JSONLD.AskAction do
  @moduledoc """
  The act of posing a question / favor to someone.

  Related actions:

  * `SEO.JSONLD.ReplyAction`: Appears generally as a response to AskAction.

  Helper for building a Schema.org [AskAction](https://schema.org/AskAction) JSON-LD structure.
  ...
  @type attrs ::
          %{
            optional(:question) => SEO.JSONLD.Question.t() | map(),
          ...
          | [
              question: SEO.JSONLD.Question.t() | map(),
  ...
  `"AskAction"` respectively, plus any camelCased field keys

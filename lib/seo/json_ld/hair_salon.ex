...
defmodule SEO.JSONLD.HairSalon do
  @moduledoc """
  A hair salon.

  Helper for building a Schema.org [HairSalon](https://schema.org/HairSalon) JSON-LD structure.
  """
  ...
  `"HairSalon"` respectively, plus any camelCased field keys

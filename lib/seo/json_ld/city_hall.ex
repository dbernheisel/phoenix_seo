...
defmodule SEO.JSONLD.CityHall do
  @moduledoc """
  A city hall.

  Helper for building a Schema.org [CityHall](https://schema.org/CityHall) JSON-LD structure.
  """
  ...
  `"CityHall"` respectively, plus any camelCased field keys

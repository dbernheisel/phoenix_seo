...
defmodule SEO.JSONLD.LifestyleModification do
  @moduledoc """
  A process of care involving exercise, changes to diet, fitness routines, and other lifestyle changes aimed at improving a health condition.

  Helper for building a Schema.org [LifestyleModification](https://schema.org/LifestyleModification) JSON-LD structure.
  """
  ...
  `"LifestyleModification"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a LifestyleModification JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "LifestyleModification")
  end
end

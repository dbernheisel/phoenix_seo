...
defmodule SEO.JSONLD.Atlas do
  @moduledoc """
  A collection or bound volume of maps, charts, plates or tables, physical or in media form illustrating any subject.

  Helper for building a Schema.org [Atlas](https://schema.org/Atlas) JSON-LD structure.
  """
  ...
  `"Atlas"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.Plumber do
  @moduledoc """
  A plumbing service.

  Helper for building a Schema.org [Plumber](https://schema.org/Plumber) JSON-LD structure.
  """
  ...
  `"Plumber"` respectively, plus any camelCased field keys

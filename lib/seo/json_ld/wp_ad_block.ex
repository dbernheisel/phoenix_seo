...
defmodule SEO.JSONLD.WPAdBlock do
  @moduledoc """
  An advertising section of the page.

  Helper for building a Schema.org [WPAdBlock](https://schema.org/WPAdBlock) JSON-LD structure.
  """
  ...
  `"WPAdBlock"` respectively, plus any camelCased field keys

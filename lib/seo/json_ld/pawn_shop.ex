...
defmodule SEO.JSONLD.PawnShop do
  @moduledoc """
  A shop that will buy, or lend money against the security of, personal possessions.

  Helper for building a Schema.org [PawnShop](https://schema.org/PawnShop) JSON-LD structure.
  """
  ...
  `"PawnShop"` respectively, plus any camelCased field keys

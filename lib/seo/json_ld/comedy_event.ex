...
defmodule SEO.JSONLD.ComedyEvent do
  @moduledoc """
  Event type: Comedy event.

  Helper for building a Schema.org [ComedyEvent](https://schema.org/ComedyEvent) JSON-LD structure.
  """
  ...
  `"ComedyEvent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ComedyEvent JSON-LD map.

...
defmodule SEO.JSONLD.LiquorStore do
  @moduledoc """
  A shop that sells alcoholic drinks such as wine, beer, whisky and other spirits.

  Helper for building a Schema.org [LiquorStore](https://schema.org/LiquorStore) JSON-LD structure.
  """
  ...
  `"LiquorStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a LiquorStore JSON-LD map.

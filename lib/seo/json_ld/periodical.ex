...
defmodule SEO.JSONLD.Periodical do
  @moduledoc """
  ...
  Helper for building a Schema.org [Periodical](https://schema.org/Periodical) JSON-LD structure.
  """
  ...
  `"Periodical"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Periodical JSON-LD map.

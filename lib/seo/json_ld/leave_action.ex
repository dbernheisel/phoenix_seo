...
defmodule SEO.JSONLD.LeaveAction do
  @moduledoc """
  An agent leaves an event / group with participants/friends at a location.

  Related actions:

  * `SEO.JSONLD.JoinAction`: The antonym of LeaveAction.
  * `SEO.JSONLD.UnRegisterAction`: Unlike UnRegisterAction, LeaveAction implies leaving a group/team of people rather than a service.

  Helper for building a Schema.org [LeaveAction](https://schema.org/LeaveAction) JSON-LD structure.
  ...
  `"LeaveAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a LeaveAction JSON-LD map.

...
defmodule SEO.JSONLD.Car do
  @moduledoc """
  A car is a wheeled, self-powered motor vehicle used for transportation.

  Helper for building a Schema.org [Car](https://schema.org/Car) JSON-LD structure.
  """
  ...
  `"Car"` respectively, plus any camelCased field keys

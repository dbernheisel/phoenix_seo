...
defmodule SEO.JSONLD.School do
  @moduledoc """
  A school.

  Helper for building a Schema.org [School](https://schema.org/School) JSON-LD structure.
  """
  ...
  `"School"` respectively, plus any camelCased field keys

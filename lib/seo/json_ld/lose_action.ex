...
defmodule SEO.JSONLD.LoseAction do
  @moduledoc """
  The act of being defeated in a competitive activity.

  Helper for building a Schema.org [LoseAction](https://schema.org/LoseAction) JSON-LD structure.
  ...
  @type attrs ::
          %{
            optional(:winner) => SEO.JSONLD.Person.t() | map(),
          ...
          | [
              winner: SEO.JSONLD.Person.t() | map(),
  ...
  `"LoseAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a LoseAction JSON-LD map.

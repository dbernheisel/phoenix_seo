...
defmodule SEO.JSONLD.AutoPartsStore do
  @moduledoc """
  An auto parts store.

  Helper for building a Schema.org [AutoPartsStore](https://schema.org/AutoPartsStore) JSON-LD structure.
  """
  ...
  `"AutoPartsStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AutoPartsStore JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "AutoPartsStore")
  end
end

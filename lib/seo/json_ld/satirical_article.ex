...
defmodule SEO.JSONLD.SatiricalArticle do
  @moduledoc """
  An `SEO.JSONLD.Article` whose content is primarily `satirical`(https://en.wikipedia.org/wiki/Satire) in nature, i.e. unlikely to be literally true. A satirical article is sometimes but not necessarily also a `SEO.JSONLD.NewsArticle`. `SEO.JSONLD.ScholarlyArticle`s are also sometimes satirized.

  Helper for building a Schema.org [SatiricalArticle](https://schema.org/SatiricalArticle) JSON-LD structure.
  """
  ...
  `"SatiricalArticle"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SatiricalArticle JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SatiricalArticle")
  end
end

...
defmodule SEO.JSONLD.ReportedDoseSchedule do
  @moduledoc """
  A patient-reported or observed dosing schedule for a drug or supplement.

  Helper for building a Schema.org [ReportedDoseSchedule](https://schema.org/ReportedDoseSchedule) JSON-LD structure.
  """
  ...
  `"ReportedDoseSchedule"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ReportedDoseSchedule JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ReportedDoseSchedule")
  end
end

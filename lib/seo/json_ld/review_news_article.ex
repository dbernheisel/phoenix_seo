...
defmodule SEO.JSONLD.ReviewNewsArticle do
  @moduledoc """
  A `SEO.JSONLD.NewsArticle` and `SEO.JSONLD.CriticReview` providing a professional critic's assessment of a service, product, performance, or artistic or literary work.

  Helper for building a Schema.org [ReviewNewsArticle](https://schema.org/ReviewNewsArticle) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:dateline) => String.t(),
            optional(:print_column) => String.t(),
            optional(:print_edition) => String.t(),
            optional(:print_page) => String.t(),
            optional(:print_section) => String.t(),
          ...
          | [
              dateline: String.t(),
              print_column: String.t(),
              print_edition: String.t(),
              print_page: String.t(),
              print_section: String.t(),
  ...
  `"ReviewNewsArticle"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ReviewNewsArticle JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ReviewNewsArticle")
  end
end

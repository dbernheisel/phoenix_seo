...
defmodule SEO.JSONLD.FollowAction do
  @moduledoc """
  The act of forming a personal connection with someone/something (object) unidirectionally/asymmetrically to get updates polled from.

  Related actions:

  * `SEO.JSONLD.BefriendAction`: Unlike BefriendAction, FollowAction implies that the connection is *not* necessarily reciprocal.
  * `SEO.JSONLD.SubscribeAction`: Unlike SubscribeAction, FollowAction implies that the follower acts as an active agent constantly/actively polling for updates.
  * `SEO.JSONLD.RegisterAction`: Unlike RegisterAction, FollowAction implies that the agent is interested in continuing receiving updates from the object.
  * `SEO.JSONLD.JoinAction`: Unlike JoinAction, FollowAction implies that the agent is interested in getting updates from the object.
  * `SEO.JSONLD.TrackAction`: Unlike TrackAction, FollowAction refers to the polling of updates of all aspects of animate objects rather than the location of inanimate objects (e.g. you track a package, but you don't follow it).

  Helper for building a Schema.org [FollowAction](https://schema.org/FollowAction) JSON-LD structure.
  ...
  @type attrs ::
          %{
            optional(:followee) => SEO.JSONLD.Person.t() | map() | SEO.JSONLD.Organization.t(),
          ...
          | [
              followee: SEO.JSONLD.Person.t() | map() | SEO.JSONLD.Organization.t(),
  ...
  `"FollowAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a FollowAction JSON-LD map.

...
defmodule SEO.JSONLD.GovernmentOffice do
  @moduledoc """
  A government office&#x2014;for example, an IRS or DMV office.

  Helper for building a Schema.org [GovernmentOffice](https://schema.org/GovernmentOffice) JSON-LD structure.
  """
  ...
  `"GovernmentOffice"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a GovernmentOffice JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "GovernmentOffice")
  end
end

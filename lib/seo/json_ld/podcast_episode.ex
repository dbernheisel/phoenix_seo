...
defmodule SEO.JSONLD.PodcastEpisode do
  @moduledoc """
  A single episode of a podcast series.

  Helper for building a Schema.org [PodcastEpisode](https://schema.org/PodcastEpisode) JSON-LD structure.
  """
  ...
  `"PodcastEpisode"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PodcastEpisode JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PodcastEpisode")
  end
end

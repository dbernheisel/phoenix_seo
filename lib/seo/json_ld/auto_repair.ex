...
defmodule SEO.JSONLD.AutoRepair do
  @moduledoc """
  Car repair business.

  Helper for building a Schema.org [AutoRepair](https://schema.org/AutoRepair) JSON-LD structure.
  """
  ...
  `"AutoRepair"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AutoRepair JSON-LD map.

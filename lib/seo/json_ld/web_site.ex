...
defmodule SEO.JSONLD.WebSite do
  @moduledoc """
  A WebSite is a set of related web pages and other items typically served from a single web domain and accessible via URLs.

  Helper for building a Schema.org [WebSite](https://schema.org/WebSite) JSON-LD structure.
  """
  ...
  `"WebSite"` respectively, plus any camelCased field keys

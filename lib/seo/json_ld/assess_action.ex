...
defmodule SEO.JSONLD.AssessAction do
  @moduledoc """
  The act of forming one's opinion, reaction or sentiment.

  Helper for building a Schema.org [AssessAction](https://schema.org/AssessAction) JSON-LD structure.
  ...
  `"AssessAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AssessAction JSON-LD map.

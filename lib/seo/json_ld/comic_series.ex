...
defmodule SEO.JSONLD.ComicSeries do
  @moduledoc """
  A sequential publication of comic stories under a
  unifying title, for example "The Amazing Spider-Man" or "Groo the
  Wanderer".

  Helper for building a Schema.org [ComicSeries](https://schema.org/ComicSeries) JSON-LD structure.
  """
  ...
  `"ComicSeries"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ComicSeries JSON-LD map.

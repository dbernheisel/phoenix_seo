...
defmodule SEO.JSONLD.InfectiousDisease do
  @moduledoc """
  An infectious disease is a clinically evident human disease resulting from the presence of pathogenic microbial agents, like pathogenic viruses, pathogenic bacteria, fungi, protozoa, multicellular parasites, and prions. To be considered an infectious disease, such pathogens are known to be able to cause this disease.

  Helper for building a Schema.org [InfectiousDisease](https://schema.org/InfectiousDisease) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:infectious_agent) => String.t(),
            optional(:infectious_agent_class) =>
              :bacteria | :fungus | :multicellular_parasite | :prion | :protozoa | :virus,
            optional(:transmission_method) => String.t(),
          ...
          | [
              infectious_agent: String.t(),
              infectious_agent_class:
                :bacteria | :fungus | :multicellular_parasite | :prion | :protozoa | :virus,
              transmission_method: String.t(),
              associated_anatomy:
                SEO.JSONLD.SuperficialAnatomy.t()
                | map()
                | SEO.JSONLD.AnatomicalStructure.t()
  ...
  `"InfectiousDisease"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a InfectiousDisease JSON-LD map.

  ## Fields

  - `:infectious_agent` - The actual infectious agent, such as a specific bacterium.
  - `:infectious_agent_class` - The class of infectious agent (bacteria, prion, etc.) that causes the disease. One of: `:bacteria`, `:fungus`, `:multicellular_parasite`, `:prion`, `:protozoa`, `:virus`.
  - `:transmission_method` - How the disease spreads, either as a route or vector, for example 'direct contact', 'Aedes aegypti', etc.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "InfectiousDisease")
  end
end

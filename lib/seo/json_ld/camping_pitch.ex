...
defmodule SEO.JSONLD.CampingPitch do
  @moduledoc """
  ...
  Helper for building a Schema.org [CampingPitch](https://schema.org/CampingPitch) JSON-LD structure.
  """
  ...
  `"CampingPitch"` respectively, plus any camelCased field keys

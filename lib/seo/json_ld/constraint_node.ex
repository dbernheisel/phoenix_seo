...
defmodule SEO.JSONLD.ConstraintNode do
  @moduledoc """
  ...
  Helper for building a Schema.org [ConstraintNode](https://schema.org/ConstraintNode) JSON-LD structure.
  """
  ...
  `"ConstraintNode"` respectively, plus any camelCased field keys
  ...
  - `:constraint_property` - Indicates a property used as a constraint. For example, in the definition of a `SEO.JSONLD.StatisticalVariable`. The value is a property, either from within Schema.org or from other compatible (e.g. RDF) systems such as DataCommons.org or Wikidata.org.
  - `:num_constraints` - Indicates the number of constraints property values defined for a particular `SEO.JSONLD.ConstraintNode` such as `SEO.JSONLD.StatisticalVariable`. This helps applications understand if they have access to a sufficiently complete description of a `SEO.JSONLD.StatisticalVariable` or other construct that is defined using properties on template-style nodes.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ConstraintNode")
  end
end

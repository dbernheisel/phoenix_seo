...
defmodule SEO.JSONLD.ScreeningEvent do
  @moduledoc """
  A screening of a movie or other video.

  Helper for building a Schema.org [ScreeningEvent](https://schema.org/ScreeningEvent) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            optional(:work_presented) => SEO.JSONLD.Movie.t() | map(),
          ...
          | [
              ...
              work_presented: SEO.JSONLD.Movie.t() | map(),
  ...
  `"ScreeningEvent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ScreeningEvent JSON-LD map.
  ...
  - `:work_presented` - The movie presented during this event.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ScreeningEvent")
  end
end

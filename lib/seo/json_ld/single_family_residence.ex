...
defmodule SEO.JSONLD.SingleFamilyResidence do
  @moduledoc """
  Residence type: Single-family home.

  Helper for building a Schema.org [SingleFamilyResidence](https://schema.org/SingleFamilyResidence) JSON-LD structure.
  """
  ...
  `"SingleFamilyResidence"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SingleFamilyResidence JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SingleFamilyResidence")
  end
end

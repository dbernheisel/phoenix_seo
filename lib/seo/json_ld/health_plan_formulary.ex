...
defmodule SEO.JSONLD.HealthPlanFormulary do
  @moduledoc """
  For a given health insurance plan, the specification for costs and coverage of prescription drugs.

  Helper for building a Schema.org [HealthPlanFormulary](https://schema.org/HealthPlanFormulary) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            optional(:offers_prescription_by_mail) => boolean(),
          ...
          | [
              ...
              offers_prescription_by_mail: boolean(),
  ...
  `"HealthPlanFormulary"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a HealthPlanFormulary JSON-LD map.
  ...
  - `:offers_prescription_by_mail` - Whether prescriptions can be delivered by mail.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "HealthPlanFormulary")
  end
end

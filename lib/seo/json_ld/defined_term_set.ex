...
defmodule SEO.JSONLD.DefinedTermSet do
  @moduledoc """
  ...
  Helper for building a Schema.org [DefinedTermSet](https://schema.org/DefinedTermSet) JSON-LD structure.
  """
  ...
  `"DefinedTermSet"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DefinedTermSet JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "DefinedTermSet")
  end
end

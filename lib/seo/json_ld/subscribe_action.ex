...
defmodule SEO.JSONLD.SubscribeAction do
  @moduledoc """
  The act of forming a personal connection with someone/something (object) unidirectionally/asymmetrically to get updates pushed to.

  Related actions:

  * `SEO.JSONLD.FollowAction`: Unlike FollowAction, SubscribeAction implies that the subscriber acts as a passive agent being constantly/actively pushed for updates.
  * `SEO.JSONLD.RegisterAction`: Unlike RegisterAction, SubscribeAction implies that the agent is interested in continuing receiving updates from the object.
  * `SEO.JSONLD.JoinAction`: Unlike JoinAction, SubscribeAction implies that the agent is interested in continuing receiving updates from the object.

  Helper for building a Schema.org [SubscribeAction](https://schema.org/SubscribeAction) JSON-LD structure.
  ...
  `"SubscribeAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SubscribeAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SubscribeAction")
  end
end

...
defmodule SEO.JSONLD.ResetPasswordAction do
  @moduledoc """
  The action of resetting the password of a device or application.

  Helper for building a Schema.org [ResetPasswordAction](https://schema.org/ResetPasswordAction) JSON-LD structure.
  ...
  `"ResetPasswordAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ResetPasswordAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ResetPasswordAction")
  end
end

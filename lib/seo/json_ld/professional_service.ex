...
defmodule SEO.JSONLD.ProfessionalService do
  @moduledoc """
  Original definition: "provider of professional services."

  The general `SEO.JSONLD.ProfessionalService` type for local businesses was deprecated due to confusion with `SEO.JSONLD.Service`. For reference, the types that it included were: `SEO.JSONLD.Dentist`,
  `SEO.JSONLD.AccountingService`, `SEO.JSONLD.Attorney`, `SEO.JSONLD.Notary`, as well as types for several kinds of `SEO.JSONLD.HomeAndConstructionBusiness`: `SEO.JSONLD.Electrician`, `SEO.JSONLD.GeneralContractor`,
  `SEO.JSONLD.HousePainter`, `SEO.JSONLD.Locksmith`, `SEO.JSONLD.Plumber`, `SEO.JSONLD.RoofingContractor`. `SEO.JSONLD.LegalService` was introduced as a more inclusive supertype of `SEO.JSONLD.Attorney`.

  Helper for building a Schema.org [ProfessionalService](https://schema.org/ProfessionalService) JSON-LD structure.
  """
  ...
  `"ProfessionalService"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ProfessionalService JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ProfessionalService")
  end
end

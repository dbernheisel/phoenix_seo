...
defmodule SEO.JSONLD.BefriendAction do
  @moduledoc """
  The act of forming a personal connection with someone (object) mutually/bidirectionally/symmetrically.

  Related actions:

  * `SEO.JSONLD.FollowAction`: Unlike FollowAction, BefriendAction implies that the connection is reciprocal.

  Helper for building a Schema.org [BefriendAction](https://schema.org/BefriendAction) JSON-LD structure.
  ...
  `"BefriendAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a BefriendAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "BefriendAction")
  end
end

...
defmodule SEO.JSONLD.NightClub do
  @moduledoc """
  A nightclub or discotheque.

  Helper for building a Schema.org [NightClub](https://schema.org/NightClub) JSON-LD structure.
  """
  ...
  `"NightClub"` respectively, plus any camelCased field keys

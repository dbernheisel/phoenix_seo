...
defmodule SEO.JSONLD.MaximumDoseSchedule do
  @moduledoc """
  The maximum dosing schedule considered safe for a drug or supplement as recommended by an authority or by the drug/supplement's manufacturer. Capture the recommending authority in the recognizingAuthority property of MedicalEntity.

  Helper for building a Schema.org [MaximumDoseSchedule](https://schema.org/MaximumDoseSchedule) JSON-LD structure.
  """
  ...
  `"MaximumDoseSchedule"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MaximumDoseSchedule JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MaximumDoseSchedule")
  end
end

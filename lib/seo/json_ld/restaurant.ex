...
defmodule SEO.JSONLD.Restaurant do
  @moduledoc """
  A restaurant.

  Helper for building a Schema.org [Restaurant](https://schema.org/Restaurant) JSON-LD structure.
  """
  ...
  `"Restaurant"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Restaurant JSON-LD map.

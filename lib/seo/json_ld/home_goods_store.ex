...
defmodule SEO.JSONLD.HomeGoodsStore do
  @moduledoc """
  A home goods store.

  Helper for building a Schema.org [HomeGoodsStore](https://schema.org/HomeGoodsStore) JSON-LD structure.
  """
  ...
  `"HomeGoodsStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a HomeGoodsStore JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "HomeGoodsStore")
  end
end

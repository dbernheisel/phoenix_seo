...
defmodule SEO.JSONLD.OfferForLease do
  @moduledoc """
  An `SEO.JSONLD.OfferForLease` in Schema.org represents an `SEO.JSONLD.Offer` to lease out something, i.e. an `SEO.JSONLD.Offer` whose
  `businessFunction` is [lease out](http://purl.org/goodrelations/v1#LeaseOut.). See [Good Relations](https://en.wikipedia.org/wiki/GoodRelations) for
  background on the underlying concepts.

  Helper for building a Schema.org [OfferForLease](https://schema.org/OfferForLease) JSON-LD structure.
  """
  ...
  `"OfferForLease"` respectively, plus any camelCased field keys
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "OfferForLease")
  end
end

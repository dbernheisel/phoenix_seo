...
defmodule SEO.JSONLD.Series do
  @moduledoc """
  A Series in schema.org is a group of related items, typically but not necessarily of the same kind. See also `SEO.JSONLD.CreativeWorkSeries`, `SEO.JSONLD.EventSeries`.

  Helper for building a Schema.org [Series](https://schema.org/Series) JSON-LD structure.
  """
  ...
  `"Series"` respectively, plus any camelCased field keys

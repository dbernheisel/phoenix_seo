...
defmodule SEO.JSONLD.BusStop do
  @moduledoc """
  A bus stop.

  Helper for building a Schema.org [BusStop](https://schema.org/BusStop) JSON-LD structure.
  """
  ...
  `"BusStop"` respectively, plus any camelCased field keys

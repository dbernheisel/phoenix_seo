...
defmodule SEO.JSONLD.ActivateAction do
  @moduledoc """
  The act of starting or activating a device or application (e.g. starting a timer or turning on a flashlight).

  Helper for building a Schema.org [ActivateAction](https://schema.org/ActivateAction) JSON-LD structure.
  ...
  `"ActivateAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ActivateAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ActivateAction")
  end
end

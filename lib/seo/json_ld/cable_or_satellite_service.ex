...
defmodule SEO.JSONLD.CableOrSatelliteService do
  @moduledoc """
  A service which provides access to media programming like TV or radio. Access may be via cable or satellite.

  Helper for building a Schema.org [CableOrSatelliteService](https://schema.org/CableOrSatelliteService) JSON-LD structure.
  """
  ...
  `"CableOrSatelliteService"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CableOrSatelliteService JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "CableOrSatelliteService")
  end
end

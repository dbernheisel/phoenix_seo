...
defmodule SEO.JSONLD.LymphaticVessel do
  @moduledoc """
  A type of blood vessel that specifically carries lymph fluid unidirectionally toward the heart.

  Helper for building a Schema.org [LymphaticVessel](https://schema.org/LymphaticVessel) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:originates_from) => SEO.JSONLD.Vessel.t() | map(),
            optional(:region_drained) =>
              SEO.JSONLD.AnatomicalSystem.t() | map() | SEO.JSONLD.AnatomicalStructure.t(),
            optional(:runs_to) => SEO.JSONLD.Vessel.t() | map(),
          ...
          | [
              originates_from: SEO.JSONLD.Vessel.t() | map(),
              region_drained:
                SEO.JSONLD.AnatomicalSystem.t() | map() | SEO.JSONLD.AnatomicalStructure.t(),
              runs_to: SEO.JSONLD.Vessel.t() | map(),
  ...
  `"LymphaticVessel"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a LymphaticVessel JSON-LD map.

  ## Fields

  - `:originates_from` - The vasculature the lymphatic structure originates, or afferents, from.
  - `:region_drained` - The anatomical or organ system drained by this vessel; generally refers to a specific part of an organ.
  - `:runs_to` - The vasculature the lymphatic structure runs, or efferents, to.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "LymphaticVessel")
  end
end

...
defmodule SEO.JSONLD.AdvertiserContentArticle do
  @moduledoc """
  An `SEO.JSONLD.Article` that an external entity has paid to place or to produce to its specifications. Includes [advertorials](https://en.wikipedia.org/wiki/Advertorial), sponsored content, native advertising and other paid content.

  Helper for building a Schema.org [AdvertiserContentArticle](https://schema.org/AdvertiserContentArticle) JSON-LD structure.
  """
  ...
  `"AdvertiserContentArticle"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AdvertiserContentArticle JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "AdvertiserContentArticle")
  end
end

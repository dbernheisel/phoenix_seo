...
defmodule SEO.JSONLD.ReplaceAction do
  @moduledoc """
  The act of editing a recipient by replacing an old object with a new object.

  Helper for building a Schema.org [ReplaceAction](https://schema.org/ReplaceAction) JSON-LD structure.
  ...
  @type attrs ::
          %{
            optional(:replacee) => SEO.JSONLD.Thing.t() | map(),
            optional(:replacer) => SEO.JSONLD.Thing.t() | map(),
            optional(:collection) => SEO.JSONLD.Thing.t() | map(),
            optional(:target_collection) => SEO.JSONLD.Thing.t() | map(),
          ...
          | [
              replacee: SEO.JSONLD.Thing.t() | map(),
              replacer: SEO.JSONLD.Thing.t() | map(),
              collection: SEO.JSONLD.Thing.t() | map(),
              target_collection: SEO.JSONLD.Thing.t() | map(),
  ...
  `"ReplaceAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ReplaceAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ReplaceAction")
  end
end

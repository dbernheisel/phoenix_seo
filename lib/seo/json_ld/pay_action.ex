...
defmodule SEO.JSONLD.PayAction do
  @moduledoc """
  An agent pays a price to a participant.

  Helper for building a Schema.org [PayAction](https://schema.org/PayAction) JSON-LD structure.
  ...
  `"PayAction"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.TextObject do
  @moduledoc """
  A text file. The text can be unformatted or contain markup, html, etc.

  Helper for building a Schema.org [TextObject](https://schema.org/TextObject) JSON-LD structure.
  """
  ...
  `"TextObject"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TextObject JSON-LD map.

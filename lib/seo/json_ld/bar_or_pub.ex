...
defmodule SEO.JSONLD.BarOrPub do
  @moduledoc """
  A bar or pub.

  Helper for building a Schema.org [BarOrPub](https://schema.org/BarOrPub) JSON-LD structure.
  """
  ...
  `"BarOrPub"` respectively, plus any camelCased field keys

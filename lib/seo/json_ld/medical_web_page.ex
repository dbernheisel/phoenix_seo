...
defmodule SEO.JSONLD.MedicalWebPage do
  @moduledoc """
  A web page that provides medical information.

  Helper for building a Schema.org [MedicalWebPage](https://schema.org/MedicalWebPage) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:aspect) => String.t(),
            optional(:medical_audience) =>
              SEO.JSONLD.MedicalAudience.t() | map() | :clinician | :medical_researcher,
  ...
  `"MedicalWebPage"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalWebPage JSON-LD map.
  ...
  - `:medical_audience` - Medical audience for page. One of: `:clinician`, `:medical_researcher`.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalWebPage")
  end
end

...
defmodule SEO.JSONLD.AchieveAction do
  @moduledoc """
  The act of accomplishing something via previous efforts. It is an instantaneous action rather than an ongoing process.

  Helper for building a Schema.org [AchieveAction](https://schema.org/AchieveAction) JSON-LD structure.
  ...
  `"AchieveAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AchieveAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "AchieveAction")
  end
end

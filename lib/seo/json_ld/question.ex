...
defmodule SEO.JSONLD.Question do
  @moduledoc """
  A specific question - e.g. from a user seeking answers online, or collected in a Frequently Asked Questions (FAQ) document.

  Helper for building a Schema.org [Question](https://schema.org/Question) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:accepted_answer) => SEO.JSONLD.ItemList.t() | map() | SEO.JSONLD.Answer.t(),
            optional(:answer_count) => integer(),
            optional(:edu_question_type) => String.t(),
            optional(:parent_item) =>
              SEO.JSONLD.CreativeWork.t() | map() | SEO.JSONLD.Comment.t(),
            optional(:suggested_answer) =>
              SEO.JSONLD.ItemList.t() | map() | SEO.JSONLD.Answer.t(),
            optional(:downvote_count) => integer(),
            optional(:shared_content) => SEO.JSONLD.CreativeWork.t() | map(),
            optional(:upvote_count) => integer(),
          ...
          | [
              accepted_answer: SEO.JSONLD.ItemList.t() | map() | SEO.JSONLD.Answer.t(),
              answer_count: integer(),
              edu_question_type: String.t(),
              parent_item: SEO.JSONLD.CreativeWork.t() | map() | SEO.JSONLD.Comment.t(),
              suggested_answer: SEO.JSONLD.ItemList.t() | map() | SEO.JSONLD.Answer.t(),
              downvote_count: integer(),
              shared_content: SEO.JSONLD.CreativeWork.t() | map(),
  ...
  `"Question"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Question JSON-LD map.

  ## Fields

  - `:accepted_answer` - The answer(s) that has been accepted as best, typically on a Question/Answer site. Sites vary in their selection mechanisms, e.g. drawing on community opinion and/or the view of the Question author.
  - `:answer_count` - The number of answers this question has received.
  - `:edu_question_type` - For questions that are part of learning resources (e.g. Quiz), eduQuestionType indicates the format of question being given. Example: "Multiple choice", "Open ended", "Flashcard".
  - `:parent_item` - The parent of a question, answer or item in general. Typically used for Q/A discussion threads e.g. a chain of comments with the first comment being an `SEO.JSONLD.Article` or other `SEO.JSONLD.CreativeWork`. See also `comment` which points from something to a comment about it.
  - `:suggested_answer` - An answer (possibly one of several, possibly incorrect) to a Question, e.g. on a Question/Answer site.

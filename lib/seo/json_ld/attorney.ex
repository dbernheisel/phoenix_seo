...
defmodule SEO.JSONLD.Attorney do
  @moduledoc """
  Professional service: Attorney.

  This type is deprecated - `SEO.JSONLD.LegalService` is more inclusive and less ambiguous.

  Helper for building a Schema.org [Attorney](https://schema.org/Attorney) JSON-LD structure.
  """
  ...
  `"Attorney"` respectively, plus any camelCased field keys

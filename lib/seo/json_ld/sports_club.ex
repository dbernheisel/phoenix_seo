...
defmodule SEO.JSONLD.SportsClub do
  @moduledoc """
  A sports club.

  Helper for building a Schema.org [SportsClub](https://schema.org/SportsClub) JSON-LD structure.
  """
  ...
  `"SportsClub"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SportsClub JSON-LD map.

...
defmodule SEO.JSONLD.Course do
  @moduledoc """
  ...
  ![Course rich-result example](./assets/course-list-example.png)

  Helper for building a Schema.org [Course](https://schema.org/Course) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:available_language) => String.t() | SEO.JSONLD.Language.t() | map(),
            optional(:course_code) => String.t(),
            optional(:course_prerequisites) =>
              String.t() | SEO.JSONLD.Course.t() | map() | SEO.JSONLD.AlignmentObject.t(),
            ...
            optional(:has_course_instance) => SEO.JSONLD.CourseInstance.t() | map(),
            ...
            optional(:syllabus_sections) => SEO.JSONLD.Syllabus.t() | map(),
            optional(:total_historical_enrollment) => integer(),
            optional(:assesses) => String.t() | SEO.JSONLD.DefinedTerm.t() | map(),
            optional(:competency_required) =>
            ...
            required(:provider) => SEO.JSONLD.Organization.t() | map() | SEO.JSONLD.Person.t(),
          ...
          | [
              ...
              has_course_instance: SEO.JSONLD.CourseInstance.t() | map(),
              number_of_credits: integer() | SEO.JSONLD.StructuredValue.t() | map(),
              occupational_credential_awarded:
                SEO.JSONLD.EducationalOccupationalCredential.t() | map() | String.t() | URI.t(),
              syllabus_sections: SEO.JSONLD.Syllabus.t() | map(),
              total_historical_enrollment: integer(),
              assesses: String.t() | SEO.JSONLD.DefinedTerm.t() | map(),
              competency_required: String.t() | URI.t() | SEO.JSONLD.DefinedTerm.t() | map(),
  ...
  `"Course"` respectively, plus any camelCased field keys
  ...
  - `:course_code` - The identifier for the `SEO.JSONLD.Course` used by the course `provider` (e.g. CS101 or 6.001).
  - `:course_prerequisites` - Requirements for taking the Course. May be completion of another `SEO.JSONLD.Course` or a textual description like "permission of instructor". Requirements may be a pre-requisite competency, referenced using `SEO.JSONLD.AlignmentObject`.
  ...
  - `:has_course_instance` - An offering of the course at a specific time and place or through specific media or mode of study or to a specific section of students.
  ...
  - `:syllabus_sections` - Indicates (typically several) Syllabus entities that lay out what each section of the overall course will cover.
  - `:total_historical_enrollment` - The total number of students that have enrolled in the history of the course.

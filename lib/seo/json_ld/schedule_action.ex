...
defmodule SEO.JSONLD.ScheduleAction do
  @moduledoc """
  Scheduling future actions, events, or tasks.

  Related actions:

  * `SEO.JSONLD.ReserveAction`: Unlike ReserveAction, ScheduleAction allocates future actions (e.g. an event, a task, etc) towards a time slot / spatial allocation.

  Helper for building a Schema.org [ScheduleAction](https://schema.org/ScheduleAction) JSON-LD structure.
  ...
  @type attrs ::
          %{
            optional(:scheduled_time) => Date.t() | String.t() | DateTime.t() | NaiveDateTime.t(),
          ...
          | [
              scheduled_time: Date.t() | String.t() | DateTime.t() | NaiveDateTime.t(),
  ...
  `"ScheduleAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ScheduleAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ScheduleAction")
  end
end

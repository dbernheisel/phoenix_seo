...
defmodule SEO.JSONLD.Language do
  @moduledoc """
  Natural languages such as Spanish, Tamil, Hindi, English, etc. Formal language code tags expressed in [BCP 47](https://en.wikipedia.org/wiki/IETF_language_tag) can be used via the `alternateName` property. The Language type previously also covered programming languages such as Scheme and Lisp, which are now best represented using `SEO.JSONLD.ComputerLanguage`.

  Helper for building a Schema.org [Language](https://schema.org/Language) JSON-LD structure.
  """
  ...
  `"Language"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.SportsActivityLocation do
  @moduledoc """
  A sports location, such as a playing field.

  Helper for building a Schema.org [SportsActivityLocation](https://schema.org/SportsActivityLocation) JSON-LD structure.
  """
  ...
  `"SportsActivityLocation"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SportsActivityLocation JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SportsActivityLocation")
  end
end

...
defmodule SEO.JSONLD.Pharmacy do
  @moduledoc """
  A pharmacy or drugstore.

  Helper for building a Schema.org [Pharmacy](https://schema.org/Pharmacy) JSON-LD structure.
  """
  ...
  `"Pharmacy"` respectively, plus any camelCased field keys

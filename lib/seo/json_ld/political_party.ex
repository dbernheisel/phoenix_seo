...
defmodule SEO.JSONLD.PoliticalParty do
  @moduledoc """
  Organization: Political Party.

  Helper for building a Schema.org [PoliticalParty](https://schema.org/PoliticalParty) JSON-LD structure.
  """
  ...
  `"PoliticalParty"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PoliticalParty JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PoliticalParty")
  end
end

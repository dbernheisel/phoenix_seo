...
defmodule SEO.JSONLD.SubwayStation do
  @moduledoc """
  A subway station.

  Helper for building a Schema.org [SubwayStation](https://schema.org/SubwayStation) JSON-LD structure.
  """
  ...
  `"SubwayStation"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SubwayStation JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SubwayStation")
  end
end

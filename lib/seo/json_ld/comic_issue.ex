...
defmodule SEO.JSONLD.ComicIssue do
  @moduledoc """
  ...
  Helper for building a Schema.org [ComicIssue](https://schema.org/ComicIssue) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            optional(:variant_cover) => String.t(),
            optional(:issue_number) => String.t() | integer(),
          ...
          | [
              ...
              variant_cover: String.t(),
              issue_number: String.t() | integer(),
  ...
  `"ComicIssue"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ComicIssue JSON-LD map.
  ...
  - `:variant_cover` - A description of the variant cover

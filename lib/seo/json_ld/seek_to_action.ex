...
defmodule SEO.JSONLD.SeekToAction do
  @moduledoc """
  This is the `SEO.JSONLD.Action` of navigating to a specific `startOffset` timestamp within a `SEO.JSONLD.VideoObject`, typically represented with a URL template structure.

  Helper for building a Schema.org [SeekToAction](https://schema.org/SeekToAction) JSON-LD structure.
  ...
  `"SeekToAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SeekToAction JSON-LD map.

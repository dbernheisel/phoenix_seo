...
defmodule SEO.JSONLD.TieAction do
  @moduledoc """
  The act of reaching a draw in a competitive activity.

  Helper for building a Schema.org [TieAction](https://schema.org/TieAction) JSON-LD structure.
  ...
  `"TieAction"` respectively, plus any camelCased field keys

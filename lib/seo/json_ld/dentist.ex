...
defmodule SEO.JSONLD.Dentist do
  @moduledoc """
  A dentist.

  Helper for building a Schema.org [Dentist](https://schema.org/Dentist) JSON-LD structure.
  """
  ...
  `"Dentist"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.CovidTestingFacility do
  @moduledoc """
  A CovidTestingFacility is a `SEO.JSONLD.MedicalClinic` where testing for the COVID-19 Coronavirus
  disease is available. If the facility is being made available from an established `SEO.JSONLD.Pharmacy`, `SEO.JSONLD.Hotel`, or other
  non-medical organization, multiple types can be listed. This makes it easier to re-use existing schema.org information
  about that place, e.g. contact info, address, opening hours. Note that in an emergency, such information may not always be reliable.

  Helper for building a Schema.org [CovidTestingFacility](https://schema.org/CovidTestingFacility) JSON-LD structure.
  """
  ...
  `"CovidTestingFacility"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CovidTestingFacility JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "CovidTestingFacility")
  end
end

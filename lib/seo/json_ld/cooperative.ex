...
defmodule SEO.JSONLD.Cooperative do
  @moduledoc """
  An organization that is a joint project of multiple organizations or persons.

  Helper for building a Schema.org [Cooperative](https://schema.org/Cooperative) JSON-LD structure.
  """
  ...
  `"Cooperative"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Cooperative JSON-LD map.

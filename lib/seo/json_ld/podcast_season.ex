...
defmodule SEO.JSONLD.PodcastSeason do
  @moduledoc """
  A single season of a podcast. Many podcasts do not break down into separate seasons. In that case, PodcastSeries should be used.

  Helper for building a Schema.org [PodcastSeason](https://schema.org/PodcastSeason) JSON-LD structure.
  """
  ...
  `"PodcastSeason"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PodcastSeason JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PodcastSeason")
  end
end

...
defmodule SEO.JSONLD.Bakery do
  @moduledoc """
  A bakery.

  Helper for building a Schema.org [Bakery](https://schema.org/Bakery) JSON-LD structure.
  """
  ...
  `"Bakery"` respectively, plus any camelCased field keys

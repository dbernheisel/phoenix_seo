...
defmodule SEO.JSONLD.ExerciseGym do
  @moduledoc """
  A gym.

  Helper for building a Schema.org [ExerciseGym](https://schema.org/ExerciseGym) JSON-LD structure.
  """
  ...
  `"ExerciseGym"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ExerciseGym JSON-LD map.

...
defmodule SEO.JSONLD.Embassy do
  @moduledoc """
  An embassy.

  Helper for building a Schema.org [Embassy](https://schema.org/Embassy) JSON-LD structure.
  """
  ...
  `"Embassy"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.AddAction do
  @moduledoc """
  The act of editing by adding an object to a collection.

  Helper for building a Schema.org [AddAction](https://schema.org/AddAction) JSON-LD structure.
  ...
  `"AddAction"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.UserBlocks do
  @moduledoc """
  ...
  Helper for building a Schema.org [UserBlocks](https://schema.org/UserBlocks) JSON-LD structure.
  """
  ...
  `"UserBlocks"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a UserBlocks JSON-LD map.

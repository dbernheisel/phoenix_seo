...
defmodule SEO.JSONLD.TVClip do
  @moduledoc """
  A short TV program or a segment/part of a TV program.

  Helper for building a Schema.org [TVClip](https://schema.org/TVClip) JSON-LD structure.
  """
  ...
  `"TVClip"` respectively, plus any camelCased field keys

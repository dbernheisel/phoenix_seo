...
defmodule SEO.JSONLD.CollegeOrUniversity do
  @moduledoc """
  A college, university, or other third-level educational institution.

  Helper for building a Schema.org [CollegeOrUniversity](https://schema.org/CollegeOrUniversity) JSON-LD structure.
  """
  ...
  `"CollegeOrUniversity"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CollegeOrUniversity JSON-LD map.
  ...
  - `SEO.JSONLD.EducationalOrganization`
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "CollegeOrUniversity")
  end
end

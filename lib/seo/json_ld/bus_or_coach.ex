...
defmodule SEO.JSONLD.BusOrCoach do
  @moduledoc """
  ...
  Helper for building a Schema.org [BusOrCoach](https://schema.org/BusOrCoach) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:acriss_code) => String.t(),
            optional(:roof_load) => SEO.JSONLD.QuantitativeValue.t() | map(),
          ...
          | [
              acriss_code: String.t(),
              roof_load: SEO.JSONLD.QuantitativeValue.t() | map(),
  ...
  `"BusOrCoach"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a BusOrCoach JSON-LD map.

  ## Fields

  - `:acriss_code` - The ACRISS Car Classification Code is a code used by many car rental companies, for classifying vehicles. ACRISS stands for Association of Car Rental Industry Systems and Standards.
  - `:roof_load` - The permitted total weight of cargo and installations (e.g. a roof rack) on top of the vehicle.

...
defmodule SEO.JSONLD.ApplyAction do
  @moduledoc """
  The act of registering to an organization/service without the guarantee to receive it.

  Related actions:

  * `SEO.JSONLD.RegisterAction`: Unlike RegisterAction, ApplyAction has no guarantees that the application will be accepted.

  Helper for building a Schema.org [ApplyAction](https://schema.org/ApplyAction) JSON-LD structure.
  ...
  `"ApplyAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ApplyAction JSON-LD map.

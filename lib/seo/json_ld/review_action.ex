...
defmodule SEO.JSONLD.ReviewAction do
  @moduledoc """
  The act of producing a balanced opinion about the object for an audience. An agent reviews an object with participants resulting in a review.

  Helper for building a Schema.org [ReviewAction](https://schema.org/ReviewAction) JSON-LD structure.
  ...
  @type attrs ::
          %{
            optional(:result_review) => SEO.JSONLD.Review.t() | map(),
          ...
          | [
              result_review: SEO.JSONLD.Review.t() | map(),
  ...
  `"ReviewAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ReviewAction JSON-LD map.

  ## Fields

  - `:result_review` - A sub property of result. The review that resulted in the performing of the action.

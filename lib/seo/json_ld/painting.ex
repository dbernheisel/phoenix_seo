...
defmodule SEO.JSONLD.Painting do
  @moduledoc """
  A painting.

  Helper for building a Schema.org [Painting](https://schema.org/Painting) JSON-LD structure.
  """
  ...
  `"Painting"` respectively, plus any camelCased field keys

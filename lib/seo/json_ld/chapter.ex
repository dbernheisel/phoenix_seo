...
defmodule SEO.JSONLD.Chapter do
  @moduledoc """
  One of the sections into which a book is divided. A chapter usually has a section number or a name.

  Helper for building a Schema.org [Chapter](https://schema.org/Chapter) JSON-LD structure.
  """
  ...
  `"Chapter"` respectively, plus any camelCased field keys

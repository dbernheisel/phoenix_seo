...
defmodule SEO.JSONLD.TextDigitalDocument do
  @moduledoc """
  A file composed primarily of text.

  Helper for building a Schema.org [TextDigitalDocument](https://schema.org/TextDigitalDocument) JSON-LD structure.
  """
  ...
  `"TextDigitalDocument"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TextDigitalDocument JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "TextDigitalDocument")
  end
end

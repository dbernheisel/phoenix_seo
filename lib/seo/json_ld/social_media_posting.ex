...
defmodule SEO.JSONLD.SocialMediaPosting do
  @moduledoc """
  A post to a social media platform, including blog posts, tweets, Facebook posts, etc.

  Helper for building a Schema.org [SocialMediaPosting](https://schema.org/SocialMediaPosting) JSON-LD structure.
  """
  ...
  `"SocialMediaPosting"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SocialMediaPosting JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SocialMediaPosting")
  end
end

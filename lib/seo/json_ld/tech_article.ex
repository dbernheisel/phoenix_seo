...
defmodule SEO.JSONLD.TechArticle do
  @moduledoc """
  A technical article - Example: How-to (task) topics, step-by-step, procedural troubleshooting, specifications, etc.

  Helper for building a Schema.org [TechArticle](https://schema.org/TechArticle) JSON-LD structure.
  """
  ...
  `"TechArticle"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TechArticle JSON-LD map.

  ## Fields

  - `:dependencies` - Prerequisites needed to fulfill steps in article.
  - `:proficiency_level` - Proficiency needed for this content; expected values: 'Beginner', 'Expert'.

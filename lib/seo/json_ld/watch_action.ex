...
defmodule SEO.JSONLD.WatchAction do
  @moduledoc """
  The act of consuming dynamic/moving visual content.

  Helper for building a Schema.org [WatchAction](https://schema.org/WatchAction) JSON-LD structure.
  ...
  `"WatchAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a WatchAction JSON-LD map.

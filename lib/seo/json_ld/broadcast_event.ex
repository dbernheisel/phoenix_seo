...
defmodule SEO.JSONLD.BroadcastEvent do
  @moduledoc """
  An over the air or online broadcast event.

  Helper for building a Schema.org [BroadcastEvent](https://schema.org/BroadcastEvent) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:broadcast_of_event) => SEO.JSONLD.Event.t() | map(),
            optional(:is_live_broadcast) => boolean(),
            optional(:subtitle_language) => String.t() | SEO.JSONLD.Language.t() | map(),
            optional(:video_format) => String.t(),
            optional(:free) => boolean(),
            optional(:published_by) =>
              SEO.JSONLD.Organization.t() | map() | SEO.JSONLD.Person.t(),
            optional(:published_on) => SEO.JSONLD.BroadcastService.t() | map(),
          ...
          | [
              broadcast_of_event: SEO.JSONLD.Event.t() | map(),
              is_live_broadcast: boolean(),
              subtitle_language: String.t() | SEO.JSONLD.Language.t() | map(),
              video_format: String.t(),
              free: boolean(),
              published_by: SEO.JSONLD.Organization.t() | map() | SEO.JSONLD.Person.t(),
              published_on: SEO.JSONLD.BroadcastService.t() | map(),
  ...
  `"BroadcastEvent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a BroadcastEvent JSON-LD map.

  ## Fields

  - `:broadcast_of_event` - The event being broadcast such as a sporting event or awards ceremony.
  - `:is_live_broadcast` - True if the broadcast is of a live event.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "BroadcastEvent")
  end
end

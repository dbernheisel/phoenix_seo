...
defmodule SEO.JSONLD.TrainStation do
  @moduledoc """
  A train station.

  Helper for building a Schema.org [TrainStation](https://schema.org/TrainStation) JSON-LD structure.
  """
  ...
  `"TrainStation"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TrainStation JSON-LD map.

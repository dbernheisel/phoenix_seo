...
defmodule SEO.JSONLD.MovieTheater do
  @moduledoc """
  A movie theater.

  Helper for building a Schema.org [MovieTheater](https://schema.org/MovieTheater) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:screen_count) => number(),
  ...
  `"MovieTheater"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MovieTheater JSON-LD map.

  ## Fields

  - `:screen_count` - The number of screens in the movie theater.

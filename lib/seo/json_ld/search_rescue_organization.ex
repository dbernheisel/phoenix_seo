...
defmodule SEO.JSONLD.SearchRescueOrganization do
  @moduledoc """
  A Search and Rescue organization of some kind.

  Helper for building a Schema.org [SearchRescueOrganization](https://schema.org/SearchRescueOrganization) JSON-LD structure.
  """
  ...
  `"SearchRescueOrganization"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SearchRescueOrganization JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SearchRescueOrganization")
  end
end

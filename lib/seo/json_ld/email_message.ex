...
defmodule SEO.JSONLD.EmailMessage do
  @moduledoc """
  An email message.

  Helper for building a Schema.org [EmailMessage](https://schema.org/EmailMessage) JSON-LD structure.
  """
  ...
  `"EmailMessage"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a EmailMessage JSON-LD map.

...
defmodule SEO.JSONLD.CancelAction do
  @moduledoc """
  The act of asserting that a future event/action is no longer going to happen.

  Related actions:

  * `SEO.JSONLD.ConfirmAction`: The antonym of CancelAction.

  Helper for building a Schema.org [CancelAction](https://schema.org/CancelAction) JSON-LD structure.
  ...
  `"CancelAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CancelAction JSON-LD map.

...
defmodule SEO.JSONLD.Corporation do
  @moduledoc """
  Organization: A business corporation.

  Helper for building a Schema.org [Corporation](https://schema.org/Corporation) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:ticker_symbol) => String.t(),
  ...
  `"Corporation"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Corporation JSON-LD map.

  ## Fields

  - `:ticker_symbol` - The exchange traded instrument associated with a Corporation object. The tickerSymbol is expressed as an exchange and an instrument name separated by a space character. For the exchange component of the tickerSymbol attribute, we recommend using the controlled vocabulary of Market Identifier Codes (MIC) specified in ISO 15022.

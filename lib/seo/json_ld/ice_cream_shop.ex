...
defmodule SEO.JSONLD.IceCreamShop do
  @moduledoc """
  An ice cream shop.

  Helper for building a Schema.org [IceCreamShop](https://schema.org/IceCreamShop) JSON-LD structure.
  """
  ...
  `"IceCreamShop"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a IceCreamShop JSON-LD map.

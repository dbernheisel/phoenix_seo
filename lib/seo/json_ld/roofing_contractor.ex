...
defmodule SEO.JSONLD.RoofingContractor do
  @moduledoc """
  A roofing contractor.

  Helper for building a Schema.org [RoofingContractor](https://schema.org/RoofingContractor) JSON-LD structure.
  """
  ...
  `"RoofingContractor"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a RoofingContractor JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "RoofingContractor")
  end
end

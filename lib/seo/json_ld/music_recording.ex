...
defmodule SEO.JSONLD.MusicRecording do
  @moduledoc """
  A music recording (track), usually a single song.

  Helper for building a Schema.org [MusicRecording](https://schema.org/MusicRecording) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            optional(:in_album) => SEO.JSONLD.MusicAlbum.t() | map(),
            optional(:in_playlist) => SEO.JSONLD.MusicPlaylist.t() | map(),
            optional(:isrc_code) => String.t(),
            optional(:recording_of) => SEO.JSONLD.MusicComposition.t() | map(),
          ...
          | [
              ...
              in_album: SEO.JSONLD.MusicAlbum.t() | map(),
              in_playlist: SEO.JSONLD.MusicPlaylist.t() | map(),
              isrc_code: String.t(),
              recording_of: SEO.JSONLD.MusicComposition.t() | map(),
  ...
  `"MusicRecording"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MusicRecording JSON-LD map.
  ...
  - `:in_album` - The album to which this recording belongs.
  - `:in_playlist` - The playlist to which this recording belongs.
  - `:isrc_code` - The International Standard Recording Code for the recording.
  - `:recording_of` - The composition this track is a recording of.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MusicRecording")
  end
end

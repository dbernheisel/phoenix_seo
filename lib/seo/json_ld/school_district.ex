...
defmodule SEO.JSONLD.SchoolDistrict do
  @moduledoc """
  A School District is an administrative area for the administration of schools.

  Helper for building a Schema.org [SchoolDistrict](https://schema.org/SchoolDistrict) JSON-LD structure.
  """
  ...
  `"SchoolDistrict"` respectively, plus any camelCased field keys
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SchoolDistrict")
  end
end

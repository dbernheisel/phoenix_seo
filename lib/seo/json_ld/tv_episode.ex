...
defmodule SEO.JSONLD.TVEpisode do
  @moduledoc """
  A TV episode which can be part of a series or season.

  Helper for building a Schema.org [TVEpisode](https://schema.org/TVEpisode) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:country_of_origin) => SEO.JSONLD.Country.t() | map(),
            optional(:part_of_tv_series) => SEO.JSONLD.TVSeries.t() | map(),
            optional(:subtitle_language) => String.t() | SEO.JSONLD.Language.t() | map(),
            ...
            optional(:episode_number) => String.t() | integer(),
            optional(:music_by) => SEO.JSONLD.Person.t() | map() | SEO.JSONLD.MusicGroup.t(),
            optional(:part_of_season) => SEO.JSONLD.CreativeWorkSeason.t() | map(),
            optional(:part_of_series) => SEO.JSONLD.CreativeWorkSeries.t() | map(),
          ...
          | [
              ...
              part_of_tv_series: SEO.JSONLD.TVSeries.t() | map(),
              subtitle_language: String.t() | SEO.JSONLD.Language.t() | map(),
              ...
              episode_number: String.t() | integer(),
              music_by: SEO.JSONLD.Person.t() | map() | SEO.JSONLD.MusicGroup.t(),
              part_of_season: SEO.JSONLD.CreativeWorkSeason.t() | map(),
              part_of_series: SEO.JSONLD.CreativeWorkSeries.t() | map(),
  ...
  `"TVEpisode"` respectively, plus any camelCased field keys
  ...
  - `:part_of_tv_series` - The TV series to which this episode or season belongs.
  - `:subtitle_language` - Languages in which subtitles/captions are available, in [IETF BCP 47 standard format](http://tools.ietf.org/html/bcp47).

...
defmodule SEO.JSONLD.RealEstateListing do
  @moduledoc """
  A `SEO.JSONLD.RealEstateListing` is a listing that describes one or more real-estate `SEO.JSONLD.Offer`s (whose `businessFunction` is typically to lease out, or to sell).
  The `SEO.JSONLD.RealEstateListing` type itself represents the overall listing, as manifested in some `SEO.JSONLD.WebPage`.

  Helper for building a Schema.org [RealEstateListing](https://schema.org/RealEstateListing) JSON-LD structure.
  """
  ...
  `"RealEstateListing"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a RealEstateListing JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "RealEstateListing")
  end
end

...
defmodule SEO.JSONLD.PaymentService do
  @moduledoc """
  A Service to transfer funds from a person or organization to a beneficiary person or organization.

  Helper for building a Schema.org [PaymentService](https://schema.org/PaymentService) JSON-LD structure.
  """
  ...
  `"PaymentService"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PaymentService JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PaymentService")
  end
end

...
defmodule SEO.JSONLD.CreativeWorkSeason do
  @moduledoc """
  A media season, e.g. TV, radio, video game etc.

  Helper for building a Schema.org [CreativeWorkSeason](https://schema.org/CreativeWorkSeason) JSON-LD structure.
  """
  ...
  `"CreativeWorkSeason"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CreativeWorkSeason JSON-LD map.
  ...
  - `:season_number` - Position of the season within an ordered group of seasons.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "CreativeWorkSeason")
  end
end

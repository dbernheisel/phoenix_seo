...
defmodule SEO.JSONLD.UserReview do
  @moduledoc """
  A review created by an end-user (e.g. consumer, purchaser, attendee etc.), in contrast with `SEO.JSONLD.CriticReview`.

  Helper for building a Schema.org [UserReview](https://schema.org/UserReview) JSON-LD structure.
  """
  ...
  `"UserReview"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a UserReview JSON-LD map.

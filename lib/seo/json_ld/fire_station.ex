...
defmodule SEO.JSONLD.FireStation do
  @moduledoc """
  A fire station. With firemen.

  Helper for building a Schema.org [FireStation](https://schema.org/FireStation) JSON-LD structure.
  """
  ...
  `"FireStation"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a FireStation JSON-LD map.

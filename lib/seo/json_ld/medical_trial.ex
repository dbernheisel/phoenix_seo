...
defmodule SEO.JSONLD.MedicalTrial do
  @moduledoc """
  ...
  Helper for building a Schema.org [MedicalTrial](https://schema.org/MedicalTrial) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:trial_design) =>
  ...
  `"MedicalTrial"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalTrial JSON-LD map.

  ## Fields

  - `:trial_design` - Specifics about the trial design (enumerated). One of: `:double_blinded_trial`, `:international_trial`, `:multi_center_trial`, `:open_trial`, `:placebo_controlled_trial`, `:randomized_trial`, `:single_blinded_trial`, `:single_center_trial`, `:triple_blinded_trial`.

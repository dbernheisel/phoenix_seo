...
defmodule SEO.JSONLD.UserDownloads do
  @moduledoc """
  ...
  Helper for building a Schema.org [UserDownloads](https://schema.org/UserDownloads) JSON-LD structure.
  """
  ...
  `"UserDownloads"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a UserDownloads JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "UserDownloads")
  end
end

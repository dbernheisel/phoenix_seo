...
defmodule SEO.JSONLD.CreditCard do
  @moduledoc """
  ...
  * http://purl.org/goodrelations/v1#VISA
  ...
  Helper for building a Schema.org [CreditCard](https://schema.org/CreditCard) JSON-LD structure.
  """
  ...
  `"CreditCard"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CreditCard JSON-LD map.
  ...
  - `SEO.JSONLD.PaymentCard`
  - `SEO.JSONLD.LoanOrCredit`

...
defmodule SEO.JSONLD.Episode do
  @moduledoc """
  A media episode (e.g. TV, radio, video game) which can be part of a series or season.

  Helper for building a Schema.org [Episode](https://schema.org/Episode) JSON-LD structure.
  """
  ...
  `"Episode"` respectively, plus any camelCased field keys
  ...
  - `:episode_number` - Position of the episode within an ordered group of episodes.

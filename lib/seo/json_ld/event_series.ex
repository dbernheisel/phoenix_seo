...
defmodule SEO.JSONLD.EventSeries do
  @moduledoc """
  A series of `SEO.JSONLD.Event`s. Included events can relate with the series using the `superEvent` property.

  An EventSeries is a collection of events that share some unifying characteristic. For example, "The Olympic Games" is a series, which
  is repeated regularly. The "2012 London Olympics" can be presented both as an `SEO.JSONLD.Event` in the series "Olympic Games", and as an
  `SEO.JSONLD.EventSeries` that included a number of sporting competitions as Events.

  The nature of the association between the events in an `SEO.JSONLD.EventSeries` can vary, but typical examples could
  ...
  Helper for building a Schema.org [EventSeries](https://schema.org/EventSeries) JSON-LD structure.
  """
  ...
  `"EventSeries"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a EventSeries JSON-LD map.

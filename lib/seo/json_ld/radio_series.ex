...
defmodule SEO.JSONLD.RadioSeries do
  @moduledoc """
  CreativeWorkSeries dedicated to radio broadcast and associated online delivery.

  Helper for building a Schema.org [RadioSeries](https://schema.org/RadioSeries) JSON-LD structure.
  """
  ...
  `"RadioSeries"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a RadioSeries JSON-LD map.

...
defmodule SEO.JSONLD.MedicalConditionStage do
  @moduledoc """
  A stage of a medical condition, such as 'Stage IIIa'.

  Helper for building a Schema.org [MedicalConditionStage](https://schema.org/MedicalConditionStage) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:stage_as_number) => number(),
            optional(:sub_stage_suffix) => String.t(),
  ...
  `"MedicalConditionStage"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalConditionStage JSON-LD map.

  ## Fields

  - `:stage_as_number` - The stage represented as a number, e.g. 3.
  - `:sub_stage_suffix` - The substage, e.g. 'a' for Stage IIIa.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalConditionStage")
  end
end

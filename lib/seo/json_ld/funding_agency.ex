...
defmodule SEO.JSONLD.FundingAgency do
  @moduledoc """
  A FundingAgency is an organization that implements one or more `SEO.JSONLD.FundingScheme`s and manages
  the granting process (via `SEO.JSONLD.Grant`s, typically `SEO.JSONLD.MonetaryGrant`s).
  A funding agency is not always required for grant funding, e.g. philanthropic giving, corporate sponsorship etc.

  Examples of funding agencies include ERC, REA, NIH, Bill and Melinda Gates Foundation, ...

  Helper for building a Schema.org [FundingAgency](https://schema.org/FundingAgency) JSON-LD structure.
  """
  ...
  `"FundingAgency"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a FundingAgency JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "FundingAgency")
  end
end

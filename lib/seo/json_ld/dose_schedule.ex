...
defmodule SEO.JSONLD.DoseSchedule do
  @moduledoc """
  A specific dosing schedule for a drug or supplement.

  Helper for building a Schema.org [DoseSchedule](https://schema.org/DoseSchedule) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:dose_unit) => String.t(),
            optional(:dose_value) =>
              number()
  ...
  `"DoseSchedule"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DoseSchedule JSON-LD map.

  ## Fields

  - `:dose_unit` - The unit of the dose, e.g. 'mg'.
  - `:dose_value` - The value of the dose, e.g. 500. One of: `:all_wheel_drive_configuration`, `:four_wheel_drive_configuration`, `:front_wheel_drive_configuration`, `:left_hand_driving`, `:rear_wheel_drive_configuration`, `:right_hand_driving`.

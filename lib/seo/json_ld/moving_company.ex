...
defmodule SEO.JSONLD.MovingCompany do
  @moduledoc """
  A moving company.

  Helper for building a Schema.org [MovingCompany](https://schema.org/MovingCompany) JSON-LD structure.
  """
  ...
  `"MovingCompany"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MovingCompany JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MovingCompany")
  end
end

...
defmodule SEO.JSONLD.WholesaleStore do
  @moduledoc """
  A wholesale store.

  Helper for building a Schema.org [WholesaleStore](https://schema.org/WholesaleStore) JSON-LD structure.
  """
  ...
  `"WholesaleStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a WholesaleStore JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "WholesaleStore")
  end
end

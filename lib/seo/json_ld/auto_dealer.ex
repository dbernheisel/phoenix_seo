...
defmodule SEO.JSONLD.AutoDealer do
  @moduledoc """
  An car dealership.

  Helper for building a Schema.org [AutoDealer](https://schema.org/AutoDealer) JSON-LD structure.
  """
  ...
  `"AutoDealer"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AutoDealer JSON-LD map.

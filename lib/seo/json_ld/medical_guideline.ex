...
defmodule SEO.JSONLD.MedicalGuideline do
  @moduledoc """
  Any recommendation made by a standard society (e.g. ACC/AHA) or consensus statement that denotes how to diagnose and treat a particular condition. Note: this type should be used to tag the actual guideline recommendation; if the guideline recommendation occurs in a larger scholarly article, use MedicalScholarlyArticle to tag the overall article, not this type. Note also: the organization making the recommendation should be captured in the recognizingAuthority base property of MedicalEntity.

  Helper for building a Schema.org [MedicalGuideline](https://schema.org/MedicalGuideline) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:evidence_level) =>
              :evidence_level_a | :evidence_level_b | :evidence_level_c,
            optional(:evidence_origin) => String.t(),
            optional(:guideline_date) => Date.t() | String.t(),
            optional(:guideline_subject) => SEO.JSONLD.MedicalEntity.t() | map(),
          ...
          | [
              evidence_level: :evidence_level_a | :evidence_level_b | :evidence_level_c,
              evidence_origin: String.t(),
              guideline_date: Date.t() | String.t(),
              guideline_subject: SEO.JSONLD.MedicalEntity.t() | map(),
  ...
  `"MedicalGuideline"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalGuideline JSON-LD map.

  ## Fields

  - `:evidence_level` - Strength of evidence of the data used to formulate the guideline (enumerated). One of: `:evidence_level_a`, `:evidence_level_b`, `:evidence_level_c`.
  - `:evidence_origin` - Source of the data used to formulate the guidance, e.g. RCT, consensus opinion, etc.
  - `:guideline_date` - Date on which this guideline's recommendation was made.
  - `:guideline_subject` - The medical conditions, treatments, etc. that are the subject of the guideline.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalGuideline")
  end
end

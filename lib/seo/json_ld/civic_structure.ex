...
defmodule SEO.JSONLD.CivicStructure do
  @moduledoc """
  A public structure, such as a town hall or concert hall.

  Helper for building a Schema.org [CivicStructure](https://schema.org/CivicStructure) JSON-LD structure.
  """
  ...
  `"CivicStructure"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CivicStructure JSON-LD map.
  ...
  * If a business is open 7 days a week, then it can be specified as &lt;time itemprop=&quot;openingHours&quot; datetime=&quot;Mo-Su&quot;&gt;Monday through Sunday, all day&lt;/time&gt;.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "CivicStructure")
  end
end

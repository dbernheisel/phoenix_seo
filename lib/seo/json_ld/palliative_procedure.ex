...
defmodule SEO.JSONLD.PalliativeProcedure do
  @moduledoc """
  A medical procedure intended primarily for palliative purposes, aimed at relieving the symptoms of an underlying health condition.

  Helper for building a Schema.org [PalliativeProcedure](https://schema.org/PalliativeProcedure) JSON-LD structure.
  """
  ...
  `"PalliativeProcedure"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PalliativeProcedure JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PalliativeProcedure")
  end
end

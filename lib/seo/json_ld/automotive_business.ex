...
defmodule SEO.JSONLD.AutomotiveBusiness do
  @moduledoc """
  Car repair, sales, or parts.

  Helper for building a Schema.org [AutomotiveBusiness](https://schema.org/AutomotiveBusiness) JSON-LD structure.
  """
  ...
  `"AutomotiveBusiness"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AutomotiveBusiness JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "AutomotiveBusiness")
  end
end

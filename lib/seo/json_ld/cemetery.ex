...
defmodule SEO.JSONLD.Cemetery do
  @moduledoc """
  A graveyard.

  Helper for building a Schema.org [Cemetery](https://schema.org/Cemetery) JSON-LD structure.
  """
  ...
  `"Cemetery"` respectively, plus any camelCased field keys

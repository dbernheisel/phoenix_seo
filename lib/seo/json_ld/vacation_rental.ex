...
defmodule SEO.JSONLD.VacationRental do
  @moduledoc """
  A kind of lodging business that focuses on renting single properties for limited time.

  ![VacationRental rich-result example](./assets/vacation-rental-example.png)

  Helper for building a Schema.org [VacationRental](https://schema.org/VacationRental) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            required(:identifier) => String.t() | URI.t() | SEO.JSONLD.PropertyValue.t() | map(),
  ...
  `"VacationRental"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a VacationRental JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "VacationRental")
  end
end

...
defmodule SEO.JSONLD.CorrectionComment do
  @moduledoc """
  A `comment` that corrects `SEO.JSONLD.CreativeWork`.

  Helper for building a Schema.org [CorrectionComment](https://schema.org/CorrectionComment) JSON-LD structure.
  """
  ...
  `"CorrectionComment"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CorrectionComment JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "CorrectionComment")
  end
end

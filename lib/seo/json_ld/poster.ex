...
defmodule SEO.JSONLD.Poster do
  @moduledoc """
  A large, usually printed placard, bill, or announcement, often illustrated, that is posted to advertise or publicize something.

  Helper for building a Schema.org [Poster](https://schema.org/Poster) JSON-LD structure.
  """
  ...
  `"Poster"` respectively, plus any camelCased field keys

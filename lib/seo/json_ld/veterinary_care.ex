...
defmodule SEO.JSONLD.VeterinaryCare do
  @moduledoc """
  A vet's office.

  Helper for building a Schema.org [VeterinaryCare](https://schema.org/VeterinaryCare) JSON-LD structure.
  """
  ...
  `"VeterinaryCare"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a VeterinaryCare JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "VeterinaryCare")
  end
end

...
defmodule SEO.JSONLD.InsertAction do
  @moduledoc """
  The act of adding at a specific location in an ordered collection.

  Helper for building a Schema.org [InsertAction](https://schema.org/InsertAction) JSON-LD structure.
  ...
  `"InsertAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a InsertAction JSON-LD map.

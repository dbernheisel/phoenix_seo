...
defmodule SEO.JSONLD.Table do
  @moduledoc """
  A table on a Web page.

  Helper for building a Schema.org [Table](https://schema.org/Table) JSON-LD structure.
  """
  ...
  `"Table"` respectively, plus any camelCased field keys

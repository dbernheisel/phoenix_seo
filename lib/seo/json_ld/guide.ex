...
defmodule SEO.JSONLD.Guide do
  @moduledoc """
  `SEO.JSONLD.Guide` is a page or article that recommends specific products or services, or aspects of a thing for a user to consider. A `SEO.JSONLD.Guide` may represent a Buying Guide and detail aspects of products or services for a user to consider. A `SEO.JSONLD.Guide` may represent a Product Guide and recommend specific products or services. A `SEO.JSONLD.Guide` may represent a Ranked List and recommend specific products or services with ranking.

  Helper for building a Schema.org [Guide](https://schema.org/Guide) JSON-LD structure.
  """
  ...
  `"Guide"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.Zoo do
  @moduledoc """
  A zoo.

  Helper for building a Schema.org [Zoo](https://schema.org/Zoo) JSON-LD structure.
  """
  ...
  `"Zoo"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.AuthorizeAction do
  @moduledoc """
  The act of granting permission to an object.

  Helper for building a Schema.org [AuthorizeAction](https://schema.org/AuthorizeAction) JSON-LD structure.
  ...
  `"AuthorizeAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AuthorizeAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "AuthorizeAction")
  end
end

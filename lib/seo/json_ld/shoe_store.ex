...
defmodule SEO.JSONLD.ShoeStore do
  @moduledoc """
  A shoe store.

  Helper for building a Schema.org [ShoeStore](https://schema.org/ShoeStore) JSON-LD structure.
  """
  ...
  `"ShoeStore"` respectively, plus any camelCased field keys

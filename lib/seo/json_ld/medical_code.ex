...
defmodule SEO.JSONLD.MedicalCode do
  @moduledoc """
  A code for a medical entity.

  Helper for building a Schema.org [MedicalCode](https://schema.org/MedicalCode) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:code_value) => String.t(),
            optional(:coding_system) => String.t(),
            optional(:in_code_set) =>
              URI.t() | String.t() | SEO.JSONLD.CategoryCodeSet.t() | map(),
          ...
          | [
              code_value: String.t(),
              coding_system: String.t(),
              in_code_set: URI.t() | String.t() | SEO.JSONLD.CategoryCodeSet.t() | map(),
  ...
  `"MedicalCode"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalCode JSON-LD map.

  ## Fields

  - `:code_value` - A short textual code that uniquely identifies the value.
  - `:coding_system` - The coding system, e.g. 'ICD-10'.
  ...
  - `SEO.JSONLD.CategoryCode`
  - `SEO.JSONLD.MedicalEntity`
  - `SEO.JSONLD.DefinedTerm`
  - `SEO.JSONLD.Thing`
  """
  @spec build(attrs()) :: t()
  def build(attrs) do

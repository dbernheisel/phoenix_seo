...
defmodule SEO.JSONLD.VideoObject do
  @moduledoc """
  A video file.

  ![VideoObject rich-result example](./assets/video-example.png)
  ...
  Helper for building a Schema.org [VideoObject](https://schema.org/VideoObject) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            required(:upload_date) => DateTime.t() | NaiveDateTime.t() | String.t() | Date.t(),
            ...
            required(:thumbnail_url) => URI.t() | String.t(),
          ...
          | [
              ...
              caption: String.t() | SEO.JSONLD.MediaObject.t() | map(),
              director: SEO.JSONLD.Person.t() | map(),
              directors: SEO.JSONLD.Person.t() | map(),
              embedded_text_caption: String.t(),
              music_by: SEO.JSONLD.Person.t() | map() | SEO.JSONLD.MusicGroup.t(),
              transcript: String.t(),
              video_frame_size: String.t(),
              video_quality: String.t(),
  ...
  `"VideoObject"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a VideoObject JSON-LD map.
  ...
  - `:embedded_text_caption` - Represents textual captioning from a `SEO.JSONLD.MediaObject`, e.g. text of a 'meme'.
  ...
  - `:video_frame_size` - The frame size of the video.
  - `:video_quality` - The quality of the video.

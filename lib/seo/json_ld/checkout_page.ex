...
defmodule SEO.JSONLD.CheckoutPage do
  @moduledoc """
  Web page type: Checkout page.

  Helper for building a Schema.org [CheckoutPage](https://schema.org/CheckoutPage) JSON-LD structure.
  """
  ...
  `"CheckoutPage"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a CheckoutPage JSON-LD map.

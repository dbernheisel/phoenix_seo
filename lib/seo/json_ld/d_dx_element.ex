...
defmodule SEO.JSONLD.DDxElement do
  @moduledoc """
  An alternative, closely-related condition typically considered later in the differential diagnosis process along with the signs that are used to distinguish it.

  Helper for building a Schema.org [DDxElement](https://schema.org/DDxElement) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:diagnosis) => SEO.JSONLD.MedicalCondition.t() | map(),
            optional(:distinguishing_sign) => SEO.JSONLD.MedicalSignOrSymptom.t() | map(),
          ...
          | [
              ...
              distinguishing_sign: SEO.JSONLD.MedicalSignOrSymptom.t() | map(),
  ...
  `"DDxElement"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DDxElement JSON-LD map.
  ...
  - `:distinguishing_sign` - One of a set of signs and symptoms that can be used to distinguish this diagnosis from others in the differential diagnosis.

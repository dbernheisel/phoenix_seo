...
defmodule SEO.JSONLD.UpdateAction do
  @moduledoc """
  The act of managing by changing/editing the state of the object.

  Helper for building a Schema.org [UpdateAction](https://schema.org/UpdateAction) JSON-LD structure.
  ...
  `"UpdateAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a UpdateAction JSON-LD map.

  ## Fields

  - `:collection` - A sub property of object. The collection target of the action.
  - `:target_collection` - A sub property of object. The collection target of the action.

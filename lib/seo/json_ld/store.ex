...
defmodule SEO.JSONLD.Store do
  @moduledoc """
  A retail good store.

  Helper for building a Schema.org [Store](https://schema.org/Store) JSON-LD structure.
  """
  ...
  `"Store"` respectively, plus any camelCased field keys

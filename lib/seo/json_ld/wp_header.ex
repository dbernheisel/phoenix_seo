...
defmodule SEO.JSONLD.WPHeader do
  @moduledoc """
  The header section of the page.

  Helper for building a Schema.org [WPHeader](https://schema.org/WPHeader) JSON-LD structure.
  """
  ...
  `"WPHeader"` respectively, plus any camelCased field keys

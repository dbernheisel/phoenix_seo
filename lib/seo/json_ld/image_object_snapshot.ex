...
defmodule SEO.JSONLD.ImageObjectSnapshot do
  @moduledoc """
  A specific and exact (byte-for-byte) version of an `SEO.JSONLD.ImageObject`. Two byte-for-byte identical files, for the purposes of this type, considered identical. If they have different embedded metadata (e.g. XMP, EXIF) the files will differ. Different external facts about the files, e.g. creator or dateCreated that aren't represented in their actual content, do not affect this notion of identity.

  Helper for building a Schema.org [ImageObjectSnapshot](https://schema.org/ImageObjectSnapshot) JSON-LD structure.
  """
  ...
  `"ImageObjectSnapshot"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ImageObjectSnapshot JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ImageObjectSnapshot")
  end
end

...
defmodule SEO.JSONLD.AnimalShelter do
  @moduledoc """
  Animal shelter.

  Helper for building a Schema.org [AnimalShelter](https://schema.org/AnimalShelter) JSON-LD structure.
  """
  ...
  `"AnimalShelter"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AnimalShelter JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "AnimalShelter")
  end
end

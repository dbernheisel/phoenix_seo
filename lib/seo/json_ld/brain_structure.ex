...
defmodule SEO.JSONLD.BrainStructure do
  @moduledoc """
  Any anatomical structure which pertains to the soft nervous tissue functioning as the coordinating center of sensation and intellectual and nervous activity.

  Helper for building a Schema.org [BrainStructure](https://schema.org/BrainStructure) JSON-LD structure.
  """
  ...
  `"BrainStructure"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a BrainStructure JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "BrainStructure")
  end
end

...
defmodule SEO.JSONLD.Artery do
  @moduledoc """
  A type of blood vessel that specifically carries blood away from the heart.

  Helper for building a Schema.org [Artery](https://schema.org/Artery) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:arterial_branch) => SEO.JSONLD.AnatomicalStructure.t() | map(),
            optional(:supply_to) => SEO.JSONLD.AnatomicalStructure.t() | map(),
          ...
          | [
              arterial_branch: SEO.JSONLD.AnatomicalStructure.t() | map(),
              supply_to: SEO.JSONLD.AnatomicalStructure.t() | map(),
  ...
  `"Artery"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Artery JSON-LD map.

  ## Fields

  - `:arterial_branch` - The branches that comprise the arterial structure.
  - `:supply_to` - The area to which the artery supplies blood.

...
defmodule SEO.JSONLD.PhysicalActivity do
  @moduledoc """
  Any bodily activity that enhances or maintains physical fitness and overall health and wellness. Includes activity that is part of daily living and routine, structured exercise, and exercise prescribed as part of a medical treatment or recovery plan.

  Helper for building a Schema.org [PhysicalActivity](https://schema.org/PhysicalActivity) JSON-LD structure.
  """
  ...
  `"PhysicalActivity"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PhysicalActivity JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PhysicalActivity")
  end
end

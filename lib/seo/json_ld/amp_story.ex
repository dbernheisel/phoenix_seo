...
defmodule SEO.JSONLD.AmpStory do
  @moduledoc """
  A creative work with a visual storytelling format intended to be viewed online, particularly on mobile devices.

  Helper for building a Schema.org [AmpStory](https://schema.org/AmpStory) JSON-LD structure.
  """
  ...
  `"AmpStory"` respectively, plus any camelCased field keys

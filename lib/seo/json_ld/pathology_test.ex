...
defmodule SEO.JSONLD.PathologyTest do
  @moduledoc """
  A medical test performed by a laboratory that typically involves examination of a tissue sample by a pathologist.

  Helper for building a Schema.org [PathologyTest](https://schema.org/PathologyTest) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:tissue_sample) => String.t(),
  ...
  `"PathologyTest"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PathologyTest JSON-LD map.

  ## Fields

  - `:tissue_sample` - The type of tissue sample required for the test.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PathologyTest")
  end
end

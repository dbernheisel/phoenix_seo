...
defmodule SEO.JSONLD.AutoWash do
  @moduledoc """
  A car wash business.

  Helper for building a Schema.org [AutoWash](https://schema.org/AutoWash) JSON-LD structure.
  """
  ...
  `"AutoWash"` respectively, plus any camelCased field keys

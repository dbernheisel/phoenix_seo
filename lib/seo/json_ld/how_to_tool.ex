...
defmodule SEO.JSONLD.HowToTool do
  @moduledoc """
  A tool used (but not consumed) when performing instructions for how to achieve a result.

  Helper for building a Schema.org [HowToTool](https://schema.org/HowToTool) JSON-LD structure.
  """
  ...
  `"HowToTool"` respectively, plus any camelCased field keys

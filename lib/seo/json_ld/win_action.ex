...
defmodule SEO.JSONLD.WinAction do
  @moduledoc """
  The act of achieving victory in a competitive activity.

  Helper for building a Schema.org [WinAction](https://schema.org/WinAction) JSON-LD structure.
  ...
  @type attrs ::
          %{
            optional(:loser) => SEO.JSONLD.Person.t() | map(),
  ...
  `"WinAction"` respectively, plus any camelCased field keys

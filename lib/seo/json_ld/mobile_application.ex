...
defmodule SEO.JSONLD.MobileApplication do
  @moduledoc """
  A software application designed specifically to work well on a mobile device such as a telephone.

  Helper for building a Schema.org [MobileApplication](https://schema.org/MobileApplication) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:carrier_requirements) => String.t(),
  ...
  `"MobileApplication"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MobileApplication JSON-LD map.

  ## Fields

  - `:carrier_requirements` - Specifies specific carrier(s) requirements for the application (e.g. an application may only work on a specific carrier network).
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MobileApplication")
  end
end

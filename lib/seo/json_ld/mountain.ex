...
defmodule SEO.JSONLD.Mountain do
  @moduledoc """
  A mountain, like Mount Whitney or Mount Everest.

  Helper for building a Schema.org [Mountain](https://schema.org/Mountain) JSON-LD structure.
  """
  ...
  `"Mountain"` respectively, plus any camelCased field keys

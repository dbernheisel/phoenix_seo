...
defmodule SEO.JSONLD.ResearchProject do
  @moduledoc """
  A Research project.

  Helper for building a Schema.org [ResearchProject](https://schema.org/ResearchProject) JSON-LD structure.
  """
  ...
  `"ResearchProject"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ResearchProject JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ResearchProject")
  end
end

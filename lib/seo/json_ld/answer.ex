...
defmodule SEO.JSONLD.Answer do
  @moduledoc """
  An answer offered to a question; perhaps correct, perhaps opinionated or wrong.

  Helper for building a Schema.org [Answer](https://schema.org/Answer) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:answer_explanation) =>
              SEO.JSONLD.Comment.t() | map() | SEO.JSONLD.WebContent.t(),
          ...
          | [
              answer_explanation: SEO.JSONLD.Comment.t() | map() | SEO.JSONLD.WebContent.t(),
  ...
  `"Answer"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Answer JSON-LD map.

  ## Fields

  - `:answer_explanation` - A step-by-step or full explanation about Answer. Can outline how this Answer was achieved or contain more broad clarification or statement about it.

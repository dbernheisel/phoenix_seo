...
defmodule SEO.JSONLD.TradeAction do
  @moduledoc """
  The act of participating in an exchange of goods and services for monetary compensation. An agent trades an object, product or service with a participant in exchange for a one time or periodic payment.

  Helper for building a Schema.org [TradeAction](https://schema.org/TradeAction) JSON-LD structure.
  ...
  `"TradeAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a TradeAction JSON-LD map.

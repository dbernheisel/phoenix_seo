...
defmodule SEO.JSONLD.ConferenceEvent do
  @moduledoc """
  Event type: Conference event.

  Helper for building a Schema.org [ConferenceEvent](https://schema.org/ConferenceEvent) JSON-LD structure.
  """
  ...
  `"ConferenceEvent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ConferenceEvent JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ConferenceEvent")
  end
end

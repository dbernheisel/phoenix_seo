...
defmodule SEO.JSONLD.ArtGallery do
  @moduledoc """
  An art gallery.

  Helper for building a Schema.org [ArtGallery](https://schema.org/ArtGallery) JSON-LD structure.
  """
  ...
  `"ArtGallery"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ArtGallery JSON-LD map.

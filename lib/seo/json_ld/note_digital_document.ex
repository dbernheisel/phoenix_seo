...
defmodule SEO.JSONLD.NoteDigitalDocument do
  @moduledoc """
  A file containing a note, primarily for the author.

  Helper for building a Schema.org [NoteDigitalDocument](https://schema.org/NoteDigitalDocument) JSON-LD structure.
  """
  ...
  `"NoteDigitalDocument"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a NoteDigitalDocument JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "NoteDigitalDocument")
  end
end

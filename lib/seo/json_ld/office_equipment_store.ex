...
defmodule SEO.JSONLD.OfficeEquipmentStore do
  @moduledoc """
  An office equipment store.

  Helper for building a Schema.org [OfficeEquipmentStore](https://schema.org/OfficeEquipmentStore) JSON-LD structure.
  """
  ...
  `"OfficeEquipmentStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a OfficeEquipmentStore JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "OfficeEquipmentStore")
  end
end

...
defmodule SEO.JSONLD.RVPark do
  @moduledoc """
  A place offering space for "Recreational Vehicles", Caravans, mobile homes and the like.

  Helper for building a Schema.org [RVPark](https://schema.org/RVPark) JSON-LD structure.
  """
  ...
  `"RVPark"` respectively, plus any camelCased field keys

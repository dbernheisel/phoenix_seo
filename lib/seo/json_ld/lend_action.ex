...
defmodule SEO.JSONLD.LendAction do
  @moduledoc """
  The act of providing an object under an agreement that it will be returned at a later date. Reciprocal of BorrowAction.

  Related actions:

  * `SEO.JSONLD.BorrowAction`: Reciprocal of LendAction.

  Helper for building a Schema.org [LendAction](https://schema.org/LendAction) JSON-LD structure.
  ...
  @type attrs ::
          %{
            optional(:borrower) => SEO.JSONLD.Person.t() | map(),
          ...
          | [
              borrower: SEO.JSONLD.Person.t() | map(),
  ...
  `"LendAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a LendAction JSON-LD map.

...
defmodule SEO.JSONLD.MusicVideoObject do
  @moduledoc """
  A music video file.

  Helper for building a Schema.org [MusicVideoObject](https://schema.org/MusicVideoObject) JSON-LD structure.
  """
  ...
  `"MusicVideoObject"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MusicVideoObject JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MusicVideoObject")
  end
end

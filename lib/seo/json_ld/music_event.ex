...
defmodule SEO.JSONLD.MusicEvent do
  @moduledoc """
  Event type: Music event.

  Helper for building a Schema.org [MusicEvent](https://schema.org/MusicEvent) JSON-LD structure.
  """
  ...
  `"MusicEvent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MusicEvent JSON-LD map.

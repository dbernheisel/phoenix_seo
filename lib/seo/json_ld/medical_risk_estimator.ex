...
defmodule SEO.JSONLD.MedicalRiskEstimator do
  @moduledoc """
  Any rule set or interactive tool for estimating the risk of developing a complication or condition.

  Helper for building a Schema.org [MedicalRiskEstimator](https://schema.org/MedicalRiskEstimator) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:estimates_risk_of) => SEO.JSONLD.MedicalEntity.t() | map(),
            optional(:included_risk_factor) => SEO.JSONLD.MedicalRiskFactor.t() | map(),
          ...
          | [
              estimates_risk_of: SEO.JSONLD.MedicalEntity.t() | map(),
              included_risk_factor: SEO.JSONLD.MedicalRiskFactor.t() | map(),
  ...
  `"MedicalRiskEstimator"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalRiskEstimator JSON-LD map.

  ## Fields

  - `:estimates_risk_of` - The condition, complication, or symptom whose risk is being estimated.
  - `:included_risk_factor` - A modifiable or non-modifiable risk factor included in the calculation, e.g. age, coexisting condition.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalRiskEstimator")
  end
end

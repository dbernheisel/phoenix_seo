...
defmodule SEO.JSONLD.MusicAlbum do
  @moduledoc """
  A collection of music tracks.

  Helper for building a Schema.org [MusicAlbum](https://schema.org/MusicAlbum) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:album_production_type) =>
              :compilation_album
              | :demo_album
              | :dj_mix_album
              | :live_album
              ...
              | :spoken_word_album
              | :studio_album,
            optional(:album_release) => SEO.JSONLD.MusicRelease.t() | map(),
            optional(:album_release_type) =>
              :album_release | :broadcast_release | :ep_release | :single_release,
            optional(:by_artist) => SEO.JSONLD.Person.t() | map() | SEO.JSONLD.MusicGroup.t(),
            optional(:num_tracks) => integer(),
            optional(:track) => SEO.JSONLD.ItemList.t() | map() | SEO.JSONLD.MusicRecording.t(),
            optional(:tracks) => SEO.JSONLD.MusicRecording.t() | map(),
          ...
          | [
              album_production_type:
                ...
                | :spoken_word_album
                | :studio_album,
              album_release: SEO.JSONLD.MusicRelease.t() | map(),
              album_release_type:
                :album_release | :broadcast_release | :ep_release | :single_release,
              by_artist: SEO.JSONLD.Person.t() | map() | SEO.JSONLD.MusicGroup.t(),
              num_tracks: integer(),
              track: SEO.JSONLD.ItemList.t() | map() | SEO.JSONLD.MusicRecording.t(),
              tracks: SEO.JSONLD.MusicRecording.t() | map(),
  ...
  `"MusicAlbum"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MusicAlbum JSON-LD map.

  ## Fields

  - `:album_production_type` - Classification of the album by its type of content: soundtrack, live album, studio album, etc. One of: `:compilation_album`, `:demo_album`, `:dj_mix_album`, `:live_album`, `:mixtape_album`, `:remix_album`, `:soundtrack_album`, `:spoken_word_album`, `:studio_album`.
  - `:album_release` - A release of this album.
  - `:album_release_type` - The kind of release which this album is: single, EP or album. One of: `:album_release`, `:broadcast_release`, `:ep_release`, `:single_release`.
  - `:by_artist` - The artist that performed this album or recording.

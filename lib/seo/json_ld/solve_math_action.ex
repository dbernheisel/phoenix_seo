...
defmodule SEO.JSONLD.SolveMathAction do
  @moduledoc """
  The action that takes in a math expression and directs users to a page potentially capable of solving/simplifying that expression.

  Helper for building a Schema.org [SolveMathAction](https://schema.org/SolveMathAction) JSON-LD structure.
  ...
  `"SolveMathAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SolveMathAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SolveMathAction")
  end
end

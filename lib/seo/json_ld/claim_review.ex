...
defmodule SEO.JSONLD.ClaimReview do
  @moduledoc """
  A fact-checking review of claims made (or reported) in some creative work (referenced via itemReviewed).

  Helper for building a Schema.org [ClaimReview](https://schema.org/ClaimReview) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:claim_reviewed) => String.t(),
  ...
  `"ClaimReview"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ClaimReview JSON-LD map.

  ## Fields

  - `:claim_reviewed` - A short summary of the specific claims reviewed in a ClaimReview.

...
defmodule SEO.JSONLD.SpeakableSpecification do
  @moduledoc """
  A SpeakableSpecification indicates (typically via `xpath` or `cssSelector`) sections of a document that are highlighted as particularly `speakable`. Instances of this type are expected to be used primarily as values of the `speakable` property.

  Helper for building a Schema.org [SpeakableSpecification](https://schema.org/SpeakableSpecification) JSON-LD structure.
  """
  ...
  `"SpeakableSpecification"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SpeakableSpecification JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "SpeakableSpecification")
  end
end

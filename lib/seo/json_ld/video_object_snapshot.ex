...
defmodule SEO.JSONLD.VideoObjectSnapshot do
  @moduledoc """
  A specific and exact (byte-for-byte) version of a `SEO.JSONLD.VideoObject`. Two byte-for-byte identical files, for the purposes of this type, considered identical. If they have different embedded metadata the files will differ. Different external facts about the files, e.g. creator or dateCreated that aren't represented in their actual content, do not affect this notion of identity.

  Helper for building a Schema.org [VideoObjectSnapshot](https://schema.org/VideoObjectSnapshot) JSON-LD structure.
  """
  ...
  `"VideoObjectSnapshot"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a VideoObjectSnapshot JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "VideoObjectSnapshot")
  end
end

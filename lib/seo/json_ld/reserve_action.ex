...
defmodule SEO.JSONLD.ReserveAction do
  @moduledoc """
  Reserving a concrete object.

  Related actions:

  * `SEO.JSONLD.ScheduleAction`: Unlike ScheduleAction, ReserveAction reserves concrete objects (e.g. a table, a hotel) towards a time slot / spatial allocation.

  Helper for building a Schema.org [ReserveAction](https://schema.org/ReserveAction) JSON-LD structure.
  ...
  `"ReserveAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ReserveAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ReserveAction")
  end
end

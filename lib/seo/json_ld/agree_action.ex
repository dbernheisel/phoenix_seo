...
defmodule SEO.JSONLD.AgreeAction do
  @moduledoc """
  The act of expressing a consistency of opinion with the object. An agent agrees to/about an object (a proposition, topic or theme) with participants.

  Helper for building a Schema.org [AgreeAction](https://schema.org/AgreeAction) JSON-LD structure.
  ...
  `"AgreeAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AgreeAction JSON-LD map.

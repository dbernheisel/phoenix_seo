...
defmodule SEO.JSONLD.Apartment do
  @moduledoc """
  ...
  Helper for building a Schema.org [Apartment](https://schema.org/Apartment) JSON-LD structure.
  """
  ...
  `"Apartment"` respectively, plus any camelCased field keys

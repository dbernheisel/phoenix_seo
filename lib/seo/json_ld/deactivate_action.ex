...
defmodule SEO.JSONLD.DeactivateAction do
  @moduledoc """
  The act of stopping or deactivating a device or application (e.g. stopping a timer or turning off a flashlight).

  Helper for building a Schema.org [DeactivateAction](https://schema.org/DeactivateAction) JSON-LD structure.
  ...
  `"DeactivateAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DeactivateAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "DeactivateAction")
  end
end

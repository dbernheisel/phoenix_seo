...
defmodule SEO.JSONLD.ConfirmAction do
  @moduledoc """
  The act of notifying someone that a future event/action is going to happen as expected.

  Related actions:

  * `SEO.JSONLD.CancelAction`: The antonym of ConfirmAction.

  Helper for building a Schema.org [ConfirmAction](https://schema.org/ConfirmAction) JSON-LD structure.
  ...
  `"ConfirmAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ConfirmAction JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ConfirmAction")
  end
end

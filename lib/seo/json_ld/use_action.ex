...
defmodule SEO.JSONLD.UseAction do
  @moduledoc """
  The act of applying an object to its intended purpose.

  Helper for building a Schema.org [UseAction](https://schema.org/UseAction) JSON-LD structure.
  ...
  `"UseAction"` respectively, plus any camelCased field keys

...
defmodule SEO.JSONLD.Comment do
  @moduledoc """
  A comment on an item - for example, a comment on a blog post. The comment's content is expressed via the `text` property, and its topic via `about`, properties shared with all CreativeWorks.

  Helper for building a Schema.org [Comment](https://schema.org/Comment) JSON-LD structure.
  """
  ...
  `"Comment"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Comment JSON-LD map.

  ## Fields

  - `:downvote_count` - The number of downvotes this question, answer or comment has received from the community.
  ...
  - `:shared_content` - A CreativeWork such as an image, video, or audio clip shared as part of this posting.
  - `:upvote_count` - The number of upvotes this question, answer or comment has received from the community.

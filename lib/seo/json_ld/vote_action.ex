...
defmodule SEO.JSONLD.VoteAction do
  @moduledoc """
  The act of expressing a preference from a fixed/finite/structured set of choices/options.

  Helper for building a Schema.org [VoteAction](https://schema.org/VoteAction) JSON-LD structure.
  ...
  @type attrs ::
          %{
            optional(:candidate) => SEO.JSONLD.Person.t() | map(),
            optional(:action_option) => String.t() | SEO.JSONLD.Thing.t() | map(),
            optional(:option) => String.t() | SEO.JSONLD.Thing.t() | map(),
          ...
          | [
              candidate: SEO.JSONLD.Person.t() | map(),
              action_option: String.t() | SEO.JSONLD.Thing.t() | map(),
              option: String.t() | SEO.JSONLD.Thing.t() | map(),
  ...
  `"VoteAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a VoteAction JSON-LD map.

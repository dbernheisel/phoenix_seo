...
defmodule SEO.JSONLD.VisualArtwork do
  @moduledoc """
  A work of art that is primarily visual in character.

  Helper for building a Schema.org [VisualArtwork](https://schema.org/VisualArtwork) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:art_edition) => String.t() | integer(),
            optional(:art_medium) => URI.t() | String.t(),
            optional(:artform) => String.t() | URI.t(),
            optional(:artist) => SEO.JSONLD.Person.t() | map(),
            optional(:artwork_surface) => String.t() | URI.t(),
            optional(:colorist) => SEO.JSONLD.Person.t() | map(),
            optional(:depth) => SEO.JSONLD.QuantitativeValue.t() | map(),
            optional(:height) => SEO.JSONLD.QuantitativeValue.t() | map(),
            optional(:inker) => SEO.JSONLD.Person.t() | map(),
            optional(:letterer) => SEO.JSONLD.Person.t() | map(),
            optional(:penciler) => SEO.JSONLD.Person.t() | map(),
            optional(:surface) => String.t() | URI.t(),
          ...
          | [
              art_edition: String.t() | integer(),
              art_medium: URI.t() | String.t(),
              artform: String.t() | URI.t(),
              artist: SEO.JSONLD.Person.t() | map(),
              artwork_surface: String.t() | URI.t(),
              colorist: SEO.JSONLD.Person.t() | map(),
              depth: SEO.JSONLD.QuantitativeValue.t() | map(),
              height: SEO.JSONLD.QuantitativeValue.t() | map(),
              inker: SEO.JSONLD.Person.t() | map(),
              letterer: SEO.JSONLD.Person.t() | map(),
              penciler: SEO.JSONLD.Person.t() | map(),
              surface: String.t() | URI.t(),
  ...
  `"VisualArtwork"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a VisualArtwork JSON-LD map.

  ## Fields

  - `:art_edition` - The number of copies when multiple copies of a piece of artwork are produced - e.g. for a limited edition of 20 prints, 'artEdition' refers to the total number of copies (in this example "20").
  - `:art_medium` - The material used. (E.g. Oil, Watercolour, Acrylic, Linoprint, Marble, Cyanotype, Digital, Lithograph, DryPoint, Intaglio, Pastel, Woodcut, Pencil, Mixed Media, etc.)
  ...
  - `:artwork_surface` - The supporting materials for the artwork, e.g. Canvas, Paper, Wood, Board, etc.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "VisualArtwork")
  end
end

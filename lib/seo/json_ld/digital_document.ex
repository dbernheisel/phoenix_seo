...
defmodule SEO.JSONLD.DigitalDocument do
  @moduledoc """
  An electronic file or document.

  Helper for building a Schema.org [DigitalDocument](https://schema.org/DigitalDocument) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:has_digital_document_permission) =>
              SEO.JSONLD.DigitalDocumentPermission.t() | map(),
          ...
          | [
              has_digital_document_permission: SEO.JSONLD.DigitalDocumentPermission.t() | map(),
  ...
  `"DigitalDocument"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a DigitalDocument JSON-LD map.

  ## Fields

  - `:has_digital_document_permission` - A permission related to the access to this document (e.g. permission to read or write an electronic document). For a public document, specify a grantee with an Audience with audienceType equal to "public".
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "DigitalDocument")
  end
end

...
defmodule SEO.JSONLD.Clip do
  @moduledoc """
  A short TV or radio program or a segment/part of a program.

  Helper for building a Schema.org [Clip](https://schema.org/Clip) JSON-LD structure.
  """
  ...
  `"Clip"` respectively, plus any camelCased field keys
  ...
  - `:clip_number` - Position of the clip within an ordered group of clips.
  ...
  - `:end_offset` - The end time of the clip expressed as the number of seconds from the beginning of the work.
  - `:music_by` - The composer of the soundtrack.
  - `:part_of_episode` - The episode to which this clip belongs.
  - `:part_of_season` - The season to which this episode belongs.
  - `:part_of_series` - The series to which this episode or season belongs.
  - `:start_offset` - The start time of the clip expressed as the number of seconds from the beginning of the work.

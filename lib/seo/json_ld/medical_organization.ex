...
defmodule SEO.JSONLD.MedicalOrganization do
  @moduledoc """
  A medical organization (physical or not), such as hospital, institution or clinic.

  Helper for building a Schema.org [MedicalOrganization](https://schema.org/MedicalOrganization) JSON-LD structure.
  """
  ...
  `"MedicalOrganization"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalOrganization JSON-LD map.

  ## Fields

  - `:health_plan_network_id` - Name or unique ID of network. (Networks are often reused across different insurance plans.)
  - `:is_accepting_new_patients` - Whether the provider is accepting new patients.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalOrganization")
  end
end

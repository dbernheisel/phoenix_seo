...
defmodule SEO.JSONLD.PublicationEvent do
  @moduledoc """
  A PublicationEvent corresponds indifferently to the event of publication for a CreativeWork of any type, e.g. a broadcast event, an on-demand event, a book/journal publication via a variety of delivery media.

  Helper for building a Schema.org [PublicationEvent](https://schema.org/PublicationEvent) JSON-LD structure.
  """
  ...
  `"PublicationEvent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PublicationEvent JSON-LD map.

  ## Fields

  - `:free` - A flag to signal that the item, event, or place is accessible for free.
  - `:published_by` - An agent associated with the publication event.
  - `:published_on` - A broadcast service associated with the publication event.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "PublicationEvent")
  end
end

...
defmodule SEO.JSONLD.HomeAndConstructionBusiness do
  @moduledoc """
  A construction business.

  A HomeAndConstructionBusiness is a `SEO.JSONLD.LocalBusiness` that provides services around homes and buildings.

  As a `SEO.JSONLD.LocalBusiness` it can be described as a `provider` of one or more `SEO.JSONLD.Service`\(s).

  Helper for building a Schema.org [HomeAndConstructionBusiness](https://schema.org/HomeAndConstructionBusiness) JSON-LD structure.
  """
  ...
  `"HomeAndConstructionBusiness"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a HomeAndConstructionBusiness JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "HomeAndConstructionBusiness")
  end
end

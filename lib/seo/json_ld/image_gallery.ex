...
defmodule SEO.JSONLD.ImageGallery do
  @moduledoc """
  Web page type: Image gallery page.

  Helper for building a Schema.org [ImageGallery](https://schema.org/ImageGallery) JSON-LD structure.
  """
  ...
  `"ImageGallery"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ImageGallery JSON-LD map.

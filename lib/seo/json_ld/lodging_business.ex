...
defmodule SEO.JSONLD.LodgingBusiness do
  @moduledoc """
  A lodging business, such as a motel, hotel, or inn.

  Helper for building a Schema.org [LodgingBusiness](https://schema.org/LodgingBusiness) JSON-LD structure.
  """
  ...
  @type attrs ::
          %{
            ...
            optional(:star_rating) => SEO.JSONLD.Rating.t() | map(),
          ...
          | [
              ...
              star_rating: SEO.JSONLD.Rating.t() | map(),
  ...
  `"LodgingBusiness"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a LodgingBusiness JSON-LD map.
  ...
  - `:star_rating` - An official rating for a lodging business or food establishment, e.g. from national associations or standards bodies. Use the author property to indicate the rating organization, e.g. as an Organization with name such as (e.g. HOTREC, DEHOGA, WHR, or Hotelstars).
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "LodgingBusiness")
  end
end

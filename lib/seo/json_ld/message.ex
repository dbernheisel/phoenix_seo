...
defmodule SEO.JSONLD.Message do
  @moduledoc """
  A single message from a sender to one or more organizations or people.

  Helper for building a Schema.org [Message](https://schema.org/Message) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:bcc_recipient) =>
              SEO.JSONLD.Organization.t()
              | map()
              | SEO.JSONLD.Person.t()
              | SEO.JSONLD.ContactPoint.t(),
            optional(:cc_recipient) =>
              SEO.JSONLD.Organization.t()
              | map()
              | SEO.JSONLD.Person.t()
              | SEO.JSONLD.ContactPoint.t(),
            optional(:date_read) => DateTime.t() | NaiveDateTime.t() | String.t() | Date.t(),
            optional(:date_received) => DateTime.t() | NaiveDateTime.t() | String.t(),
            optional(:date_sent) => DateTime.t() | NaiveDateTime.t() | String.t(),
            optional(:message_attachment) => SEO.JSONLD.CreativeWork.t() | map(),
            optional(:recipient) =>
              SEO.JSONLD.Organization.t()
              | map()
              | SEO.JSONLD.Person.t()
          ...
          | [
              ...
              cc_recipient:
                ...
                | SEO.JSONLD.Person.t()
                | SEO.JSONLD.ContactPoint.t(),
              date_read: DateTime.t() | NaiveDateTime.t() | String.t() | Date.t(),
              date_received: DateTime.t() | NaiveDateTime.t() | String.t(),
              date_sent: DateTime.t() | NaiveDateTime.t() | String.t(),
              message_attachment: SEO.JSONLD.CreativeWork.t() | map(),
              recipient:
                SEO.JSONLD.Organization.t()
                | map()
                | SEO.JSONLD.Person.t()
  ...
  `"Message"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Message JSON-LD map.

  ## Fields

  - `:bcc_recipient` - A sub property of recipient. The recipient blind copied on a message.
  - `:cc_recipient` - A sub property of recipient. The recipient copied on a message.
  - `:date_read` - The date/time at which the message has been read by the recipient if a single recipient exists.
  - `:date_received` - The date/time the message was received if a single recipient exists.
  - `:date_sent` - The date/time at which the message was sent.
  - `:message_attachment` - A CreativeWork attached to the message.
  ...
  - `:to_recipient` - A sub property of recipient. The recipient who was directly sent the message.

...
defmodule SEO.JSONLD.ConsumeAction do
  @moduledoc """
  The act of ingesting information/resources/food.

  Helper for building a Schema.org [ConsumeAction](https://schema.org/ConsumeAction) JSON-LD structure.
  ...
  `"ConsumeAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ConsumeAction JSON-LD map.

  ## Fields

  - `:action_accessibility_requirement` - A set of requirements that must be fulfilled in order to perform an Action. If more than one value is specified, fulfilling one set of requirements will allow the Action to be performed.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ConsumeAction")
  end
end

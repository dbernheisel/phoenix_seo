...
defmodule SEO.JSONLD.OnDemandEvent do
  @moduledoc """
  A publication event, e.g. catch-up TV or radio podcast, during which a program is available on-demand.

  Helper for building a Schema.org [OnDemandEvent](https://schema.org/OnDemandEvent) JSON-LD structure.
  """
  ...
  `"OnDemandEvent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a OnDemandEvent JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "OnDemandEvent")
  end
end

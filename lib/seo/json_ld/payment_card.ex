...
defmodule SEO.JSONLD.PaymentCard do
  @moduledoc """
  A payment method using a credit, debit, store or other card to associate the payment with an account.

  Helper for building a Schema.org [PaymentCard](https://schema.org/PaymentCard) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:cash_back) => number() | boolean(),
            optional(:contactless_payment) => boolean(),
            optional(:floor_limit) => SEO.JSONLD.MonetaryAmount.t() | map(),
            optional(:monthly_minimum_repayment_amount) =>
              SEO.JSONLD.MonetaryAmount.t() | map() | number(),
          ...
          | [
              cash_back: number() | boolean(),
              contactless_payment: boolean(),
              floor_limit: SEO.JSONLD.MonetaryAmount.t() | map(),
              monthly_minimum_repayment_amount: SEO.JSONLD.MonetaryAmount.t() | map() | number(),
              payment_method_type:
                :by_bank_transfer_in_advance
                | :by_invoice
                | :cash
  ...
  `"PaymentCard"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a PaymentCard JSON-LD map.

  ## Fields

  - `:cash_back` - A cardholder benefit that pays the cardholder a small percentage of their net expenditures.
  - `:contactless_payment` - A secure method for consumers to purchase products or services via debit, credit or smartcards by using RFID or NFC technology.
  - `:floor_limit` - A floor limit is the amount of money above which credit card transactions must be authorized.
  - `:monthly_minimum_repayment_amount` - The minimum payment is the lowest amount of money that one is required to pay on a credit card statement each month.

...
defmodule SEO.JSONLD.Barcode do
  @moduledoc """
  An image of a visual machine-readable code such as a barcode or QR code.

  Helper for building a Schema.org [Barcode](https://schema.org/Barcode) JSON-LD structure.
  """
  ...
  `"Barcode"` respectively, plus any camelCased field keys

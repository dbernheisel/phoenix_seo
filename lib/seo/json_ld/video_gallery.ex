...
defmodule SEO.JSONLD.VideoGallery do
  @moduledoc """
  Web page type: Video gallery page.

  Helper for building a Schema.org [VideoGallery](https://schema.org/VideoGallery) JSON-LD structure.
  """
  ...
  `"VideoGallery"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a VideoGallery JSON-LD map.

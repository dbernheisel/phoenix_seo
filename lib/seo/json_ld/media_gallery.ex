...
defmodule SEO.JSONLD.MediaGallery do
  @moduledoc """
  Web page type: Media gallery page. A mixed-media page that can contain media such as images, videos, and other multimedia.

  Helper for building a Schema.org [MediaGallery](https://schema.org/MediaGallery) JSON-LD structure.
  """
  ...
  `"MediaGallery"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MediaGallery JSON-LD map.

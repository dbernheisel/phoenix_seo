...
defmodule SEO.JSONLD.EducationEvent do
  @moduledoc """
  Event type: Education event.

  Helper for building a Schema.org [EducationEvent](https://schema.org/EducationEvent) JSON-LD structure.
  """
  ...
  `"EducationEvent"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a EducationEvent JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "EducationEvent")
  end
end

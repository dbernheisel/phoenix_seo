...
defmodule SEO.JSONLD.AssignAction do
  @moduledoc """
  The act of allocating an action/event/task to some destination (someone or something).

  Helper for building a Schema.org [AssignAction](https://schema.org/AssignAction) JSON-LD structure.
  ...
  `"AssignAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a AssignAction JSON-LD map.

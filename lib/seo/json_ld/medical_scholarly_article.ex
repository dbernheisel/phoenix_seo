...
defmodule SEO.JSONLD.MedicalScholarlyArticle do
  @moduledoc """
  A scholarly article in the medical domain.

  Helper for building a Schema.org [MedicalScholarlyArticle](https://schema.org/MedicalScholarlyArticle) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:publication_type) => String.t(),
  ...
  `"MedicalScholarlyArticle"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalScholarlyArticle JSON-LD map.

  ## Fields

  - `:publication_type` - The type of the medical article, taken from the US NLM MeSH publication type catalog. See also [MeSH documentation](http://www.nlm.nih.gov/mesh/pubtypes.html).
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalScholarlyArticle")
  end
end

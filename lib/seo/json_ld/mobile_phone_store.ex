...
defmodule SEO.JSONLD.MobilePhoneStore do
  @moduledoc """
  A store that sells mobile phones and related accessories.

  Helper for building a Schema.org [MobilePhoneStore](https://schema.org/MobilePhoneStore) JSON-LD structure.
  """
  ...
  `"MobilePhoneStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MobilePhoneStore JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MobilePhoneStore")
  end
end

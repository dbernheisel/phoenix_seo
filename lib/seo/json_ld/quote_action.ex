...
defmodule SEO.JSONLD.QuoteAction do
  @moduledoc """
  An agent quotes/estimates/appraises an object/product/service with a price at a location/store.

  Helper for building a Schema.org [QuoteAction](https://schema.org/QuoteAction) JSON-LD structure.
  ...
  `"QuoteAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a QuoteAction JSON-LD map.

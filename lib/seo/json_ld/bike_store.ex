...
defmodule SEO.JSONLD.BikeStore do
  @moduledoc """
  A bike store.

  Helper for building a Schema.org [BikeStore](https://schema.org/BikeStore) JSON-LD structure.
  """
  ...
  `"BikeStore"` respectively, plus any camelCased field keys

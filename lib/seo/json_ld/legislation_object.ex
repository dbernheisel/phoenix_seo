...
defmodule SEO.JSONLD.LegislationObject do
  @moduledoc """
  A specific object or file containing a Legislation. Note that the same Legislation can be published in multiple files. For example, a digitally signed PDF, a plain PDF and an HTML version.

  Helper for building a Schema.org [LegislationObject](https://schema.org/LegislationObject) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:legislation_legal_value) =>
            ...
            optional(:associated_article) => SEO.JSONLD.NewsArticle.t() | map(),
            optional(:bitrate) => String.t(),
            optional(:content_size) => String.t(),
            optional(:content_url) => URI.t() | String.t(),
            optional(:duration) =>
              Duration.t() | String.t() | SEO.JSONLD.QuantitativeValue.t() | map(),
            optional(:embed_url) => URI.t() | String.t(),
            optional(:encodes_creative_work) => SEO.JSONLD.CreativeWork.t() | map(),
            ...
            optional(:player_type) => String.t(),
            optional(:production_company) => SEO.JSONLD.Organization.t() | map(),
            optional(:regions_allowed) => SEO.JSONLD.Place.t() | map(),
            ...
            optional(:upload_date) => DateTime.t() | NaiveDateTime.t() | String.t() | Date.t(),
          ...
          | [
              ...
              associated_article: SEO.JSONLD.NewsArticle.t() | map(),
              bitrate: String.t(),
              content_size: String.t(),
              content_url: URI.t() | String.t(),
              duration: Duration.t() | String.t() | SEO.JSONLD.QuantitativeValue.t() | map(),
              embed_url: URI.t() | String.t(),
              encodes_creative_work: SEO.JSONLD.CreativeWork.t() | map(),
              ...
              player_type: String.t(),
              production_company: SEO.JSONLD.Organization.t() | map(),
              regions_allowed: SEO.JSONLD.Place.t() | map(),
              requires_subscription: SEO.JSONLD.MediaSubscription.t() | map() | boolean(),
              sha256: String.t(),
              start_time: DateTime.t() | NaiveDateTime.t() | String.t() | Time.t(),
              upload_date: DateTime.t() | NaiveDateTime.t() | String.t() | Date.t(),
  ...
  `"LegislationObject"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a LegislationObject JSON-LD map.

  ## Fields

  - `:legislation_legal_value` - The legal value of this legislation file. The same legislation can be written in multiple files with different legal values. Typically a digitally signed PDF have a "stronger" legal value than the HTML file of the same act. One of: `:authoritative_legal_value`, `:definitive_legal_value`, `:official_legal_value`, `:unofficial_legal_value`.
  ...
  - `SEO.JSONLD.Legislation`
  - `SEO.JSONLD.MediaObject`
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "LegislationObject")
  end
end

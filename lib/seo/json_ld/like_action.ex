...
defmodule SEO.JSONLD.LikeAction do
  @moduledoc """
  The act of expressing a positive sentiment about the object. An agent likes an object (a proposition, topic or theme) with participants.

  Helper for building a Schema.org [LikeAction](https://schema.org/LikeAction) JSON-LD structure.
  ...
  `"LikeAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a LikeAction JSON-LD map.

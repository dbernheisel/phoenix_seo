...
defmodule SEO.JSONLD.OccupationalExperienceRequirements do
  @moduledoc """
  Indicates employment-related experience requirements, e.g. `monthsOfExperience`.

  Helper for building a Schema.org [OccupationalExperienceRequirements](https://schema.org/OccupationalExperienceRequirements) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:months_of_experience) => number(),
  ...
  `"OccupationalExperienceRequirements"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a OccupationalExperienceRequirements JSON-LD map.

  ## Fields

  - `:months_of_experience` - Indicates the minimal number of months of experience required for a position.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "OccupationalExperienceRequirements")
  end
end

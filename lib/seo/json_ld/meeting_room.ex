...
defmodule SEO.JSONLD.MeetingRoom do
  @moduledoc """
  ...
  Helper for building a Schema.org [MeetingRoom](https://schema.org/MeetingRoom) JSON-LD structure.
  """
  ...
  `"MeetingRoom"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MeetingRoom JSON-LD map.

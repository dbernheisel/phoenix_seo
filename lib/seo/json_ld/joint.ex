...
defmodule SEO.JSONLD.Joint do
  @moduledoc """
  The anatomical location at which two or more bones make contact.

  Helper for building a Schema.org [Joint](https://schema.org/Joint) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:biomechnical_class) => String.t(),
            optional(:functional_class) => SEO.JSONLD.MedicalEntity.t() | map() | String.t(),
            optional(:structural_class) => String.t(),
          ...
          | [
              biomechnical_class: String.t(),
              functional_class: SEO.JSONLD.MedicalEntity.t() | map() | String.t(),
              structural_class: String.t(),
  ...
  `"Joint"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a Joint JSON-LD map.

  ## Fields

  - `:biomechnical_class` - The biomechanical properties of the bone.
  - `:functional_class` - The degree of mobility the joint allows.
  - `:structural_class` - The name given to how bone physically connects to each other.

...
defmodule SEO.JSONLD.VirtualLocation do
  @moduledoc """
  An online or virtual location for attending events. For example, one may attend an online seminar or educational event. While a virtual location may be used as the location of an event, virtual locations should not be confused with physical locations in the real world.

  Helper for building a Schema.org [VirtualLocation](https://schema.org/VirtualLocation) JSON-LD structure.
  """
  ...
  `"VirtualLocation"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a VirtualLocation JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "VirtualLocation")
  end
end

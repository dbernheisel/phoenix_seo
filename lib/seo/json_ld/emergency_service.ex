...
defmodule SEO.JSONLD.EmergencyService do
  @moduledoc """
  An emergency service, such as a fire station or ER.

  Helper for building a Schema.org [EmergencyService](https://schema.org/EmergencyService) JSON-LD structure.
  """
  ...
  `"EmergencyService"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a EmergencyService JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "EmergencyService")
  end
end

...
defmodule SEO.JSONLD.SendAction do
  @moduledoc """
  The act of physically/electronically dispatching an object for transfer from an origin to a destination. Related actions:

  * `SEO.JSONLD.ReceiveAction`: The reciprocal of SendAction.
  * `SEO.JSONLD.GiveAction`: Unlike GiveAction, SendAction does not imply the transfer of ownership (e.g. I can send you my laptop, but I'm not necessarily giving it to you).

  Helper for building a Schema.org [SendAction](https://schema.org/SendAction) JSON-LD structure.
  ...
  `"SendAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SendAction JSON-LD map.

...
defmodule SEO.JSONLD.MedicalIntangible do
  @moduledoc """
  A utility class that serves as the umbrella for a number of 'intangible' things in the medical space.

  Helper for building a Schema.org [MedicalIntangible](https://schema.org/MedicalIntangible) JSON-LD structure.
  """
  ...
  `"MedicalIntangible"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a MedicalIntangible JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "MedicalIntangible")
  end
end

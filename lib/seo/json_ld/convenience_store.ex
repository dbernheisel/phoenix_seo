...
defmodule SEO.JSONLD.ConvenienceStore do
  @moduledoc """
  A convenience store.

  Helper for building a Schema.org [ConvenienceStore](https://schema.org/ConvenienceStore) JSON-LD structure.
  """
  ...
  `"ConvenienceStore"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a ConvenienceStore JSON-LD map.
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "ConvenienceStore")
  end
end

...
defmodule SEO.JSONLD.SearchAction do
  @moduledoc """
  The act of searching for an object.

  Related actions:

  * `SEO.JSONLD.FindAction`: SearchAction generally leads to a FindAction, but not necessarily.

  Helper for building a Schema.org [SearchAction](https://schema.org/SearchAction) JSON-LD structure.
  ...
  `"SearchAction"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a SearchAction JSON-LD map.

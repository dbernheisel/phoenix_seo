...
defmodule SEO.JSONLD.State do
  @moduledoc """
  A state or province of a country.

  Helper for building a Schema.org [State](https://schema.org/State) JSON-LD structure.
  """
  ...
  `"State"` respectively, plus any camelCased field keys

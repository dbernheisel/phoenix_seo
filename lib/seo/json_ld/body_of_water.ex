...
defmodule SEO.JSONLD.BodyOfWater do
  @moduledoc """
  A body of water, such as a sea, ocean, or lake.

  Helper for building a Schema.org [BodyOfWater](https://schema.org/BodyOfWater) JSON-LD structure.
  """
  ...
  `"BodyOfWater"` respectively, plus any camelCased field keys
  ...
  @doc """
  Build a BodyOfWater JSON-LD map.

...
defmodule SEO.JSONLD.HealthTopicContent do
  @moduledoc """
  `SEO.JSONLD.HealthTopicContent` is `SEO.JSONLD.WebContent` that is about some aspect of a health topic, e.g. a condition, its symptoms or treatments. Such content may be comprised of several parts or sections and use different types of media. Multiple instances of `SEO.JSONLD.WebContent` (and hence `SEO.JSONLD.HealthTopicContent`) can be related using `hasPart` / `isPartOf` where there is some kind of content hierarchy, and their content described with `about` and `mentions` e.g. building upon the existing `SEO.JSONLD.MedicalCondition` vocabulary.

  Helper for building a Schema.org [HealthTopicContent](https://schema.org/HealthTopicContent) JSON-LD structure.
  """

  @type attrs ::
          %{
            optional(:has_health_aspect) =>
  ...
  `"HealthTopicContent"` respectively, plus any camelCased field keys
  ...
  def build(attrs) do
    ...
    |> Map.put_new("@type", "HealthTopicContent")
  end
end
